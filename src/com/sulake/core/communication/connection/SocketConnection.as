package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1927:int = 10000;
      ...
      private var var_568:ByteArray;
      
      private var var_1316:IEncryption;
      
      private var var_869:IProtocol;
      
      private var _id:String;
      
      private var var_1317:IMessageClassManager;
      
      private var var_275:ICoreCommunicationManager;
      
      private var var_567:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_275 = param2;
         this.var_568 = new ByteArray();
         this.var_1317 = new MessageClassManager();
         this.var_90 = new Socket();
         this.var_228 = new Timer(const_1927,1);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         ...
         if(this.var_567)
         {
            this.var_567.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_228.start();
         this.var_868 = getTimer();
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1317.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         var _loc6_:ByteArray = this.var_869.encoder.encode(_loc4_,_loc5_,param2);
         if(this.var_567)
         {
            this.var_567.messageSent(String(_loc4_),_loc6_.toString());
         }
         if(this.var_1316 != null)
         {
            _loc3_ = this.var_1316.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1317.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_869.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_869.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1316 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_869.getMessages(this.var_568,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_567)
               {
                  this.var_567.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1317.getMessageEventClasses(id);
               events = new Array();
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_568,offset);
               this.var_568 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_568.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_568.writeByte(this.var_90.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_228.stop();
         this.var_2031 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_868));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_2031 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_868));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_868));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_868));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_868));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_868));
