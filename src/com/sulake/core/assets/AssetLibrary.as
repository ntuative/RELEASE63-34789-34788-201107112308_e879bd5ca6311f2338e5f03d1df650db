package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1242:String = "AssetLibraryReady";
      
      public static const const_933:String = "AssetLibraryLoaded";
      
      public static const const_1794:String = "AssetLibraryUnloaded";
      
      public static const const_1933:String = "AssetLibraryLoadError";
      
      private static const const_728:String = "name";
      
      private static const const_1150:String = "asset";
      
      private static const const_1149:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1148:String = "library";
      
      private static var var_349:Dictionary;
      
      private static var var_2129:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_589:uint = 0;
      
      private static var var_1112:Array = new Array();
      ...
      private var var_491:uint;
      
      private var var_44:LibraryLoader;
      
      private var var_727:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_590 = new Dictionary(false);
         this.var_1110 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_726 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1148);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1150);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_728);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1149);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_726 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1112.splice(var_1112.indexOf(this),1);
            --var_589;
            this.var_590 = null;
            this.var_1110 = null;
            this.var_189 = null;
      ...
      {
         if(this.var_726 == param1.url && this.var_1111)
         {
            if(!this.var_1113 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_727);
            }
            this.var_1113 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1242));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_1110)
         {
            delete this.var_1110[_loc1_];
         }
         if(this.var_44 != null)
         {
            this.var_44.dispose();
         ...
         this.var_1111 = false;
         this.var_726 = null;
         dispatchEvent(new Event(AssetLibrary.const_1794));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1110[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_590[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1399,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1337,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1307,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1287,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_590[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_590[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_491;
                     this.var_492.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_590[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_492.length ? this.getAssetByName(this.var_492[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_189)
         {
            ...
            {
               return this.var_492.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_189[param1] != null || (this.var_727 != null ? this.var_727[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_2129.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_189)
            {
               if(this.var_189[_loc2_] == param1)
               {
                  this.var_492.splice(this.var_492.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_349.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_349[param1.mimeType] = param1;
         }
         else
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_349[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_349)
            {
               _loc3_ = AssetTypeDeclaration(var_349[_loc4_]);
               if(_loc3_ != null)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_349)
            {
               _loc4_ = AssetTypeDeclaration(var_349[_loc5_]);
               if(_loc4_ != null)
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_727 = _loc2_.resource;
         this.var_726 = _loc2_.url;
         if(this.var_1113)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_727);
         }
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1933));
         this.var_44 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1148);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1150);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_728) && _loc3_.attribute(const_728).toString() == param1)
                  {
                     _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_726 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_727[param1]);
                     _loc6_ = _loc3_.child(const_1149);
