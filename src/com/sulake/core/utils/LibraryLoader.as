package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2051:uint = 1;
      
      protected static const const_2053:uint = 2;
      
      protected static const const_2050:uint = 4;
      
      protected static const const_2052:uint = 3;
      ...
      public static const const_1408:Boolean = false;
      
      public static const const_1762:int = 2;
      
      private static var var_1005:Array = new Array();
      
      private static var var_812:Array = new Array();
      ...
      protected var var_727:Class;
      
      protected var var_506:uint = 0;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1408)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_812[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_812.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_812.length < const_1762 && false)
            {
               _loc1_ = var_1005.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1144 ? uint(this.var_1421 - this.var_2262) : uint(getTimer() - this.var_2262);
      }
      ...
      {
         if(this.var_1145 && !_disposed)
         {
            this.var_1145 = false;
            if(!this.var_1144 && this.var_268)
            {
               this.var_1421 = -1;
               this.var_2262 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1144 && !_disposed && this.var_1420 > 0)
         {
            try
            {
               this.var_44.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_268,const_1883 - this.var_1420);
            if(this.var_3055)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_506 = LibraryLoader.name_5;
         ...
         if(this.var_506 == LibraryLoader.const_2052)
         {
         ...
         if(this.var_506 == LibraryLoader.name_5)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_727 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_727.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
