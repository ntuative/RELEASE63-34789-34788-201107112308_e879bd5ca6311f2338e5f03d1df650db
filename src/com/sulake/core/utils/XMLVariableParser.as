package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1967:String = "float";
      
      public static const const_38:String = "Boolean";
      
      public static const const_1892:String = "bool";
      
      public static const const_51:String = "String";
      
      public static const const_288:String = "Point";
      
      public static const const_258:String = "Rectangle";
      
      public static const const_173:String = "Array";
      
      public static const const_280:String = "Map";
      
      private static const const_695:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_696:String = "value";
      
      private static const const_731:String = "true";
      
      private static const const_2075:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_695);
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_695));
         }
         else
         {
            _loc4_ = param1.child(const_695)[0];
         }
         ...
         _loc7_ = param1.attribute(const_696);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_696));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_696)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_280 || _loc5_ == const_173)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1967:
               return Number(param1);
            case const_38:
               return param1 == const_731 || int(param1) > 0;
            case const_1892:
               return param1 == const_731 || int(param1) > 0;
            case const_181:
               return uint(param1);
            case const_173:
               return param1.split(const_1498);
            default:
