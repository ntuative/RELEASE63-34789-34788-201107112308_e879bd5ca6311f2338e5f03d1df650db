package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_720:String = "}";
      
      private static const const_1636:String = "/*";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_99[const_209],var_99[ITALIC],var_99[BOLD]];
            var_99.reset();
            var_99[const_209] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_720);
         if(countSubStrings(param1,const_721) != countSubStrings(param1,const_720))
         {
            throw new Error("Mismatching amount of \"" + const_721 + "\" versus \"" + const_720 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1636) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1637) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_721)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
