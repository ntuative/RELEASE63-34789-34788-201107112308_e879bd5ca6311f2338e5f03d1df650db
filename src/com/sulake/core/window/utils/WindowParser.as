package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1333:String = "_EXCLUDE";
      
      public static const const_2145:String = "_INCLUDE";
      
      public static const const_2251:String = "_TEMP";
      
      private static const const_1700:String = "layout";
      
      private static const const_1162:String = "window";
      
      private static const const_1163:String = "variables";
      
      private static const const_1161:String = "filters";
      
      private static const const_728:String = "name";
      
      private static const const_1706:String = "style";
      
      private static const const_732:String = "params";
      
      private static const const_1711:String = "tags";
      ...
      private static const const_1705:String = "visible";
      
      private static const const_1703:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1322:String = "blend";
      
      private static const const_1702:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1707:String = "treshold";
      
      private static const const_1708:String = "children";
      
      private static const const_1704:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1709:String = "height_min";
      
      private static const const_1713:String = "height_max";
      
      private static const const_731:String = "true";
      
      private static const const_182:String = "0";
      
      private static const const_1712:String = "$";
      
      private static const const_1498:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1710:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      ...
      protected var var_1154:Dictionary;
      
      protected var var_1714:Dictionary;
      
      protected var var_2273:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1429,this.var_1430);
         this.var_1154 = new Dictionary();
         this.var_1714 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1154,this.var_1714);
         this.var_2273 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1701,const_50);
         return param1.replace(const_1710,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1154)
            {
               delete this.var_1154[_loc1_];
            }
            for(_loc1_ in this.var_1714)
            {
               delete this.var_1714[_loc1_];
            }
            this.var_2273.dispose();
            this.var_2273 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1700)
         {
            _loc8_ = param1.child(const_1163);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1161).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1162);
         ...
         if(param1.localName() == const_1162)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         name = unescape(String(this.parseAttribute(xml,const_728,variables,"")));
         style = uint(this.parseAttribute(xml,const_1706,variables,style));
         params = uint(this.parseAttribute(xml,const_732,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1711,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1705,variables,visible.toString()) == const_731;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_732).length() > 0)
         {
            list = xml.child(const_732).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_728,variables,"") as String;
               if(this.var_1154[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_728)) + "\"!");
               }
               params |= this.var_1154[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1703,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1498);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1163)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1704,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1709,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1713,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_731;
         blend = Number(this.parseAttribute(xml,const_1322,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1702,variables,window.clipping.toString()) == const_731;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1707,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1161).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_210)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1430[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1333) == -1)
                  {
