package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_364 = new Array();
            var_364[0] = MouseCursorType.const_384;
            var_364[1] = MouseCursorType.const_30;
            var_364[2] = MouseCursorType.const_384;
            var_364[3] = MouseCursorType.const_384;
            var_364[4] = MouseCursorType.const_384;
            var_364[5] = MouseCursorType.const_30;
            var_364[6] = MouseCursorType.const_384;
         }
         if(var_318 == null)
         {
            var_318 = new Array();
            var_318[0] = WindowState.const_87;
            var_318[1] = WindowState.const_93;
            var_318[2] = WindowState.const_94;
            var_318[3] = WindowState.const_73;
            var_318[4] = WindowState.const_58;
            var_318[5] = WindowState.const_96;
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_305;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_71 = state.var_1411 as WindowController;
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_600))
         {
