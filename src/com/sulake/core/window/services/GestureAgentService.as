   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      public function begin(param1:IWindow, param2:Function, param3:uint, param4:int, param5:int) : IWindow
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            this.var_230 = new Timer(40,0);
            this.var_230.addEventListener(TimerEvent.TIMER,this.operate);
            this.var_230.start();
         }
         return _loc6_;
      }
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1427 *= 0.75;
         this.var_1426 *= 0.75;
         if(Math.abs(this.var_1427) <= 1 && Math.abs(this.var_1426) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_313 != null)
         {
            this.var_313(this.var_1427,this.var_1426);
         }
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_230.stop();
            this.var_230.removeEventListener(TimerEvent.TIMER,this.operate);
            this.var_230 = null;
         }
         if(this._working)
         {
