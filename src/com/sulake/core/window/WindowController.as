package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static const const_1105:Point = new Point();
      ...
      protected var var_756:Function;
      ...
      {
         return this.var_756 != null ? this.var_756 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_507 = param1;
         var_269 = !!var_507 ? uint(var_269 | var_605) : uint(var_269 & 16777215);
      ...
      {
         var_605 = param1 & 4278190080;
         var_269 = !!var_507 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_10,WindowRedrawFlag.const_61);
      }
      ...
      {
         var_605 = param1 << 24;
         var_269 = !!var_507 ? uint(var_605 | var_269) : uint(16777215 & var_269);
         _context.invalidate(this,var_10,WindowRedrawFlag.const_61);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_10,WindowRedrawFlag.const_1322);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_10,WindowRedrawFlag.const_757);
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_400 = this._parent.rectangle.clone();
               var_68.x = var_10.x;
               var_68.y = var_10.y;
               var_68.width = var_10.width;
               var_68.height = var_10.height;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_607,this,this._parent);
            ...
            else
            {
               ...
               this.var_400.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1840,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_883,var_10);
            this.var_21.visible = var_348;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_92,var_20,_context,var_10,null,this.var_756,this.properties,var_935.concat(),_id) as WindowController;
         _loc2_.var_508 = var_508;
         _loc2_.var_192 = this.var_192;
         _loc2_._debug = this._debug;
         _loc2_.var_400 = this.var_400.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2702 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_657)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_20 & 0);
            if(_loc7_ == WindowParam.const_631)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_548)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1257,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_996))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_45:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1358;
                  ...
                  if((var_20 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_329))
                        {
               ...
               case WindowMouseEvent.const_55:
                  ...
                  if(testParamFlag(WindowParam.const_329))
                  {
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_40:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_514,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_226,WindowParam.const_200))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_210,WindowParam.const_188))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc7_ = uint(var_20);
                        var_20 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_602))
                        {
                           this._parent.width += 0 - 0;
                        }
                        if(testParamFlag(WindowParam.const_504))
                        {
               ...
               case WindowEvent.const_438:
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1324);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1769,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
               ...
               case WindowEvent.const_625:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1393,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_337,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_607:
                  if(testParamFlag(WindowParam.const_226,WindowParam.const_200))
                  {
                     this.updateScaleRelativeToParent();
                  }
               ...
               case WindowEvent.const_514:
                  this._parent.getRegionProperties(null,this.var_400);
                  this.updateScaleRelativeToParent();
                  break;
         ...
         if(this.var_192 && var_508 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_10.width && param1.y <= var_10.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1105,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1105,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_179,WindowParam.const_200);
         var _loc2_:* = !testParamFlag(WindowParam.const_178,WindowParam.const_188);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_10.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_400.width;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_461)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_398)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_400.height;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_341)
               {
               ...
               else if(_loc5_ == WindowParam.const_210)
               {
      ...
      {
         if(_state == WindowState.const_676)
         {
            return true;
         }
         _state = WindowState.const_676;
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1836,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_564,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_73,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_2032,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_73,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1765,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_979,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_297,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_867,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_377,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1797,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1294 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_525,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1294 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_525,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_422,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
