package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_716:uint = 0;
      
      private static const const_1120:uint = 1;
      
      private static const const_1119:uint = 2;
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1119) : uint(const_716);
         var _loc6_:Boolean = this.var_204.width > 0 && this.var_204.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_1064))
            {
               _loc5_ = const_1120;
            }
         }
         ...
         if(_loc5_ != const_716)
         {
            this.var_1606 = this.var_1064;
            _loc4_ = param1.fetchDrawBuffer() as BitmapData;
            if(_loc4_ != null)
            {
               _loc4_.lock();
               if(_loc5_ == const_1120)
               {
                  _loc6_ = true;
                  ...
                  if(this.var_695)
                  {
                     ...
                     _loc7_.draw(param1,this.var_137,this.var_137.rect,this.var_1064,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_33))
                  {
                     this.var_1148.tx = param2.x;
                     this.var_1148.ty = param2.y;
                     this.var_866.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_137,this.var_1148,this.var_866,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1606;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_757:
               this.var_1064 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_1064 != this.var_1606)
               {
                  this.var_695 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_1322:
               if(param1.testParamFlag(WindowParam.const_33))
               {
                  this.var_695 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_1381:
               _loc4_ = true;
         }
         if(_loc4_)
         {
