package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1684:String = "skin";
      
      private static const const_1681:String = "bitmap";
      
      private static const const_1685:String = "fill";
      
      private static const const_1680:String = "text";
      
      private static const const_1682:String = "label";
      
      private static const const_1683:String = "shape";
      
      private static const RENDERER_TYPE_UNKNOWN:String = "unknown";
      
      private static const RENDERER_TYPE_NULL:String = "HabboModerationCom_issue_browser_xml";
      ...
      private var var_2939:Dictionary;
      
      private var var_2937:Dictionary;
      
      private var var_2938:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2113 = new Dictionary();
         this.var_2939 = new Dictionary();
         TypeCodeTable.fillTables(this.var_2113,this.var_2939);
         this.var_2937 = new Dictionary();
         this.var_2938 = new Dictionary();
         StateCodeTable.fillTables(this.var_2937,this.var_2938);
         this.var_487 = new Dictionary();
         this.var_487[const_1684] = BitmapSkinRenderer;
         this.var_487[const_1681] = BitmapDataRenderer;
         this.var_487[const_1685] = FillSkinRenderer;
         this.var_487[const_1680] = TextSkinRenderer;
         this.var_487[const_1682] = LabelRenderer;
         this.var_487[const_1683] = ShapeSkinRenderer;
         this.var_487[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_487[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_366 == null)
         {
            var_366 = new Array();
            var_366.push(WindowState.const_73);
            var_366.push(WindowState.const_89);
            var_366.push(WindowState.const_96);
            var_366.push(WindowState.const_58);
            var_366.push(WindowState.const_94);
            var_366.push(WindowState.const_93);
            var_366.push(WindowState.const_87);
            var_366.push(WindowState.const_106);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_2113[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1103[param1] == null)
         {
            this.var_1103[param1] = new Array(const_1143);
         }
         this.var_1103[param1][param2] = param3;
         if(this.var_1102[param1] == null)
         {
            this.var_1102[param1] = new Array(const_1143);
         }
         this.var_1102[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1103[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1102[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_104)
