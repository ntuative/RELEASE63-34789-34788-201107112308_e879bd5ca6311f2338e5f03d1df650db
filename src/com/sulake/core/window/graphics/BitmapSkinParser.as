package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_93:String = "focused";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_358 = SkinLayoutEntity.const_674;
                  break;
               case "move":
                  _loc5_.var_358 = SkinLayoutEntity.const_374;
                  break;
               case "strech":
                  _loc5_.var_358 = SkinLayoutEntity.const_649;
                  break;
               case "tiled":
                  _loc5_.var_358 = SkinLayoutEntity.const_330;
                  break;
               case "center":
                  _loc5_.var_358 = SkinLayoutEntity.const_660;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_359 = SkinLayoutEntity.const_674;
                  break;
               case "move":
                  _loc5_.var_359 = SkinLayoutEntity.const_374;
                  break;
               case "strech":
                  _loc5_.var_359 = SkinLayoutEntity.const_649;
                  break;
               case "tiled":
                  _loc5_.var_359 = SkinLayoutEntity.const_330;
                  break;
               case "center":
                  _loc5_.var_359 = SkinLayoutEntity.const_660;
            }
         }
