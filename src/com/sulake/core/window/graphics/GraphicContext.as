package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1871:uint = 0;
      
      public static const const_883:uint = 1;
      
      public static const const_1208:uint = 2;
      
      public static const const_969:uint = 4;
      
      public static const const_1894:uint = 8;
      
      public static const const_1896:uint = 16;
      
      public static const const_2279:uint = 64;
      
      public static const const_2296:uint = 128;
      
      public static const const_1282:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1208:
               ...
               break;
            case GraphicContext.const_1894:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1896:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_969:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1282:
               break;
            case GraphicContext.const_1871:
               break;
            default:
         ...
         if(this.var_939)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2267,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2267,16777215);
                  }
                  var_365 += bitmap.width * bitmap.height * 4;
               }
