package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1600:String = "_SELECTOR";
      
      private static const const_1601:String = "_CONTENT";
       
      
      protected var var_1149:ITabSelectorWindow;
      
      protected var var_2265:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1149 = findChildByTag(const_1600) as ITabSelectorWindow;
            if(this.var_1149 != null)
            {
               this.var_1149.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2265 = findChildByTag(const_1601) as IWindowContainer;
         }
      ...
      {
         return !!this.var_864 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1149.numSelectables;
      }
