package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1434:String = "_TITLE";
      
      private static const const_1569:String = "_HEADER";
      
      private static const const_1568:String = "_CONTENT";
      
      private static const const_1567:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1562:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1434) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1562 = findChildByTag(const_1569) as IHeaderWindow;
            if(!this.var_1562)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_198 = findChildByTag(const_1568) as IWindowContainer;
            if(!this.var_198)
            {
      ...
      {
         return findChildByTag(const_1567) as IScalerWindow;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_329);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_246);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_310);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_310,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_310,false);
            }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_350,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_313,_loc3_.left,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_302,_loc3_.top,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_308,0 - _loc3_.right,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_273,0 - _loc3_.bottom,PropertyStruct.const_37,_loc2_));
         return _loc1_;
      }
