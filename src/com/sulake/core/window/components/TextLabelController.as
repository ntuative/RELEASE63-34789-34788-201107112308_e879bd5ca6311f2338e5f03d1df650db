package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_415:Object = null;
      ...
      protected function get textField() : TextField
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _loc1_.textColor = uint(this.var_415);
            }
         }
         return _loc1_;
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2856 = _loc2_.textWidth;
         this.var_2857 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_415 != _loc2_.color : this.var_415 != null && this.var_415 != PropertyDefaults.const_878) ? new PropertyStruct(PropertyDefaults.const_401,this.var_415,PropertyStruct.const_181,true) : PropertyDefaults.const_1271);
         if(this.var_43)
         {
            if(this.var_43.left != PropertyDefaults.const_779)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_313,this.var_43.left,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_934);
            }
            if(this.var_43.top != PropertyDefaults.const_1010)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_302,this.var_43.top,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_869);
            }
            if(this.var_43.right != PropertyDefaults.const_743)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_308,this.var_43.right,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_912);
            }
            if(this.var_43.bottom != PropertyDefaults.const_810)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_273,this.var_43.bottom,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_747);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_401:
                  this.var_415 = _loc2_.value as uint;
                  break;
               case PropertyDefaults.const_313:
