package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_982:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1818:StyleSheet = null;
      ...
      {
         this.var_787 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1218 == param2)
         {
            return;
         }
         param1.var_1218 = param2;
         param1.var_1818 = null;
         if(param1.var_1218 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1218);
            param1.var_1818 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_776.indexOf(param1) > -1)
         {
            this.var_787 = param1;
         }
      }
      ...
      {
         return this.var_787 == LinkTarget.const_30 ? defaultLinkTarget : this.var_787;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1818;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1190)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_787 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_751,this.var_787,PropertyStruct.const_51,true,PropertyDefaults.const_776));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1818);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_751)
            {
               this.var_787 = _loc2_.value as String;
               break;
            }
