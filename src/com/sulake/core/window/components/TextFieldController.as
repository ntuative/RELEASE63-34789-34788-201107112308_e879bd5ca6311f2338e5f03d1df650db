package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1708:uint = 500;
      
      protected var var_1419:String = "";
      
      protected var var_1425:Boolean = false;
      
      protected var var_864:Boolean = false;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1208,var_10);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_864 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_459,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_333,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_971,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1814);
         _loc1_.push(this.var_1425 != PropertyDefaults.const_1410 ? new PropertyStruct(PropertyDefaults.const_870,this.var_1425,PropertyStruct.const_38,true) : PropertyDefaults.const_1830);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1299 ? new PropertyStruct(PropertyDefaults.const_781,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1741);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1233 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1795);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_971:
                  ...
                  break;
               case PropertyDefaults.const_1376:
