package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1479:String = "increment";
      
      private static const const_1480:String = "decrement";
      
      private static const const_1068:String = "slider_track";
      
      private static const const_690:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_752:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_192 = false;
         this.var_17 = param12;
         this._horizontal = param2 == WindowType.const_640;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_17 != null && !this.var_17.disposed)
         {
            ...
            this.var_17.removeEventListener(WindowEvent.const_627,this.onScrollableScrolled);
         }
         this.var_17 = param1;
         if(this.var_17 != null && !this.var_17.disposed)
         {
            this.var_17.addEventListener(WindowEvent.const_40,this.onScrollableResized);
            this.var_17.addEventListener(WindowEvent.const_627,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_983 = _loc3_.value as String;
               this.var_17 = null;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1068) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_690) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_690:
         ...
         if(param2.type == WindowEvent.const_607)
         {
            if(this.var_17 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_360)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_752;
                  }
                  else
                  {
                     this.scrollV -= this.var_752;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_987)
         {
            if(param2.name == const_1479)
            {
               if(this.var_17)
               {
                  this.var_1219 = true;
            ...
            else if(param2.name == const_1480)
            {
               if(this.var_17)
               {
                  this.var_1219 = true;
            ...
            else if(param2.name == const_1068)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_690).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_983) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_983) as IScrollableWindow;
               if(_loc1_)
               {
