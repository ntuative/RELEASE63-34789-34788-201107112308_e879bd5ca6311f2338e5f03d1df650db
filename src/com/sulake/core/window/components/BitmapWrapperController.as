package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_610 != PropertyDefaults.const_1231)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_888,this.var_610,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_2000);
         }
         if(this.var_942 != PropertyDefaults.const_1327)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_884,this.var_942,PropertyStruct.const_51,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_2030);
         }
         return _loc1_;
      }
