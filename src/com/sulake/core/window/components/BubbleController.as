package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2071:String = "_POINTER_UP";
      
      private static const const_2070:String = "_POINTER_DOWN";
      
      private static const const_2072:String = "_POINTER_LEFT";
      
      private static const const_2069:String = "_POINTER_RIGHT";
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(param1 != this._direction)
         {
            ...
            this.pointerOffset = this.var_788;
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_989,this._direction,PropertyStruct.const_51,true));
         }
         else
         {
         ...
         if(this.var_788 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_788,this.var_788,PropertyStruct.const_37,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_989:
