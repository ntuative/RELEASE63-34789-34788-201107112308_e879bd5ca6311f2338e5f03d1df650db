package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_506)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_506)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_896,param1.toolTipCaption,PropertyStruct.const_51,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_2005);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1388)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_835,param1.toolTipDelay,PropertyStruct.const_263,true));
         }
         else
         {
