package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1420:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_940:Number;
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_948 ? true : null;
         }
      ...
      {
         this.var_940 = param1;
         this._field.scrollH = this.var_940 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_940 * this.maxScrollH,this.var_607 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_768,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1315));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1181 ? new PropertyStruct(PropertyDefaults.const_864,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1167) : PropertyDefaults.const_1979);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1326 ? new PropertyStruct(PropertyDefaults.const_1288,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1168) : PropertyDefaults.const_2037);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_878) ? new PropertyStruct(PropertyDefaults.const_401,this._field.textColor,PropertyStruct.const_181,true) : PropertyDefaults.const_1271);
         _loc1_.push(this.var_471 != TextStyleManager.const_209 ? new PropertyStruct(PropertyDefaults.const_406,this.var_471,PropertyStruct.const_51,true,PropertyDefaults.const_978) : PropertyDefaults.const_1402);
         _loc1_.push(this.var_43.left != PropertyDefaults.const_779 ? new PropertyStruct(PropertyDefaults.const_313,this.var_43.left,PropertyStruct.const_37,true) : PropertyDefaults.const_934);
         _loc1_.push(this.var_43.top != PropertyDefaults.const_1010 ? new PropertyStruct(PropertyDefaults.const_302,this.var_43.top,PropertyStruct.const_37,true) : PropertyDefaults.const_869);
         _loc1_.push(this.var_43.right != PropertyDefaults.const_743 ? new PropertyStruct(PropertyDefaults.const_308,this.var_43.right,PropertyStruct.const_37,true) : PropertyDefaults.const_912);
         _loc1_.push(this.var_43.bottom != PropertyDefaults.const_810 ? new PropertyStruct(PropertyDefaults.const_273,this.var_43.bottom,PropertyStruct.const_37,true) : PropertyDefaults.const_747);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1268 ? new PropertyStruct(PropertyDefaults.const_749,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1935);
