package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1332:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_477)
         {
            this.var_477.removeEventListener(WindowEvent.const_297,this.scrollBarEventProc);
            this.var_477.removeEventListener(WindowEvent.const_247,this.scrollBarEventProc);
            this.var_477 = null;
         }
         if(this.var_1332)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1332)
         {
            this.var_1332 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_477)
         {
            ...
            if(this.var_477)
            {
               this.var_477.addEventListener(WindowEvent.const_297,this.scrollBarEventProc);
               this.var_477.addEventListener(WindowEvent.const_247,this.scrollBarEventProc);
            }
         }
         return this.var_477;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_247)
         {
            this.hideScrollBar();
         }
      }
