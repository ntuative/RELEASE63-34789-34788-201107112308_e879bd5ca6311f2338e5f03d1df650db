package com.sulake.core.runtime
{
   ...
   class Profiler extends Component implements IProfiler
   {
      ...
      {
         this.var_344 = new Dictionary(true);
         super(param1,0,null);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            {
               IDisposable(this.var_344[_loc1_]).dispose();
      ...
      {
         this.var_3088 = getTimer() - this.var_2146;
      ...
      public function getProfilerAgentsInArray() : Array
      {
         ...
         for(_loc3_ in this.var_344)
         {
            _loc2_ = _loc3_ as IUpdateReceiver;
            if(IDisposable(_loc3_).disposed)
            {
               IDisposable(this.var_344[_loc3_]).dispose();
               delete this.var_344[_loc3_];
            }
            else
            {
               _loc1_.push(this.var_344[_loc3_]);
            }
         }
         return _loc1_;
      }
      ...
      {
         var _loc2_:ProfilerAgent = this.var_344[param1];
