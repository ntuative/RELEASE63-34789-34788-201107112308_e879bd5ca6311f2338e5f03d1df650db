package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1725 || param1.getUpdateID() != this.var_2956)
         {
            this.var_2956 = param1.getUpdateID();
            if(param2.updateId != this.var_1725 || _loc4_.x != this.var_1365.x || _loc4_.y != this.var_1365.y || _loc4_.z != this.var_1365.z)
            {
         ...
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  this.var_421.assign(_loc5_);
                  if(_loc8_ != null)
                  {
                     this.var_421.z = _loc8_.z;
                  }
               }
               else
               {
            ...
            this.var_421.x = Math.round(this.var_421.x);
            this.var_421.y = Math.round(this.var_421.y);
         }
         return this.var_421;
      }
   }
