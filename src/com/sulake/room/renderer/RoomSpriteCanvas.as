package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_688:Point = new Point(0,0);
      
      private static const const_392:int = 50;
      
      private static const const_1638:int = 50;
      
      private static const const_1135:Number = 60;
      
      private static const const_1639:Number = 50;
      ...
      private var var_299:BitmapDataCache;
      
      private var var_717:RoomObjectCache;
      
      private var var_582:Array;
      
      private var var_714:Array;
      
      private var var_1644:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2914:Number = -1.0E7;
      
      private var var_2912:Number = -1.0E7;
      ...
      private var var_2098:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_300 = new Sprite();
         this.var_300.mouseEnabled = false;
         this.var_116 = new Sprite();
         this.var_116.name = "canvas";
         this.var_116.mouseEnabled = false;
         this.var_300.addChild(this.var_116);
         ...
         this.var_299 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
         ...
         this.var_717 = new RoomObjectCache(_loc6_);
         this.var_866 = new ColorTransform();
         this.var_715 = new Matrix();
      ...
      {
         this.var_583.x -= param1 - this.var_718;
         this.var_718 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_583.y -= param1 - this.var_713;
         this.var_713 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_969 = true;
            if(this.var_161 != null && !this.var_300.contains(this.var_161))
            {
               this.var_300.addChild(this.var_161);
               this.var_116.mask = this.var_161;
            }
         }
         else if(!param1 && this.var_969)
         {
            this.var_969 = false;
            if(this.var_161 != null && this.var_300.contains(this.var_161))
            {
               this.var_300.removeChild(this.var_161);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_300.numChildren > 0)
            {
               this.var_300.removeChildAt(0);
            }
            this.var_300 = null;
         }
         this.var_116 = null;
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_714.length)
            {
               this.cleanSprite(this.var_714[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_714 = [];
         }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_161 != null)
         {
            this.var_161.graphics.clear();
         }
         else
         {
            this.var_161 = new Sprite();
            this.var_161.name = "mask";
            if(this.var_969)
            {
               this.var_300.addChild(this.var_161);
               this.var_116.mask = this.var_161;
         ...
         this.var_161.graphics.beginFill(0);
         this.var_161.graphics.drawRect(0,0,param1,param2);
         this.var_584 = param1;
         this.var_581 = param2;
      }
      ...
      {
         this.var_717.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_2099 = !this.var_2099;
         if(this._container == null || this._geometry == null)
         {
            return;
         }
         if(param1 == this.var_1645)
         {
            return;
         }
         this.calculateUpdateInterval(param1);
         this.var_299.compress();
         ...
         if(this.var_584 != this.var_2909 || this.var_581 != this.var_2908)
         {
            _loc8_ = true;
         }
         if(this.var_116.x != this.var_718 || this.var_116.y != this.var_713)
         {
            this.var_116.x = this.var_718;
            this.var_116.y = this.var_713;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2909 = this.var_584;
         this.var_2908 = this.var_581;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1645 > 0)
         {
            _loc2_ = param1 - this.var_1645;
            if(_loc2_ > const_1135 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2910 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_887;
               if(this.var_887 == const_392 + 1)
               {
                  this.var_530 = _loc2_;
                  this.var_2098 = this.var_2911;
               }
               else if(this.var_887 > const_392 + 1)
               {
                  _loc3_ = Number(this.var_887 - const_392);
                  this.var_530 = this.var_530 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_2098 = this.var_2098 * (_loc3_ - 1) / _loc3_ + Number(this.var_2911) / _loc3_;
                  if(this.var_887 > const_392 + const_1638)
                  {
                     this.var_887 = const_392;
                     if(!this.var_1349 && this.var_530 > const_1135)
                     {
                        this.var_1349 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1349 && this.var_530 < const_1639)
                     {
                        this.var_1349 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_717.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_717.method_13(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_2099 && this.var_1349);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_718;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_713;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     _loc17_.x = _loc19_ - this.var_718;
                     _loc17_.y = _loc20_ - this.var_713;
      ...
      {
         if(param1 < this.var_584 && param1 + param3 >= 0 && (param2 < this.var_581 && param2 + param4 >= 0))
         {
            if(!this.var_3092)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_584)
         {
            param3 -= this.var_584 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_581)
         {
            param4 -= this.var_581 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2913)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_1093)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_714.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_1093)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_886 || this.var_886 == 0)
         {
            _loc4_ = this.var_1093 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_299.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_299.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_299.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_715.identity();
            if(flipH)
            {
               this.var_715.scale(-1,1);
               this.var_715.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_715.scale(1,-1);
               this.var_715.translate(0,data.height);
            }
            finalData.draw(data,this.var_715);
            if(name.length > 0)
            {
               this.var_299.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_688);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_866.redMultiplier = tR;
            this.var_866.greenMultiplier = tG;
            this.var_866.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_866);
            if(name.length > 0)
            {
               this.var_299.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1348 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_2096;
         }
         this.var_2096 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1348;
         return this.var_2096;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_584 / 2;
         var _loc12_:Number = param2 - this.var_581 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_2097,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_716.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_716.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2914 || param2 != this.var_2912)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_716.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_716.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_418 != null && param1 != null)
         {
            this.var_418.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_418 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_418.getKey(_loc1_);
            _loc3_ = this.var_418.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1644.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
