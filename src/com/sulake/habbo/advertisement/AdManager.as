package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_379:AdImageRequest;
      
      private var var_1214:BitmapData = null;
      
      private var var_1213:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2407 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2405 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2404 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1804 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1212 == 0)
         {
            this.var_1212 = getTimer();
            return false;
         }
         if(this.var_1804 > 0 && this.var_1805 >= this.var_1804)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1212;
         if(_loc1_ > this.var_2405)
         {
            ++this.var_1805;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(this.var_1474 != "")
         {
            ...
            {
               this.var_250 = new Timer(this.var_2404,1);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_610,param1.bitmapData,this.var_2406));
            this.var_1212 = getTimer();
         }
         else
         {
      ...
      private function method_3() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_567));
         }
      }
      
      public function showRoomAd(param1:int, param2:int) : void
      {
         this.var_379 = new AdImageRequest(param1,param2);
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         if(this.var_379 != null && _loc2_.imageUrl != "" && _loc2_.clickUrl != "")
         {
            ...
            this.var_379 = new AdImageRequest(this.var_379.roomId,this.var_379.roomCategory,_loc2_.imageUrl,_loc2_.clickUrl);
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_) && this.var_379 != null)
         {
            _loc4_ = this.emulateBackgroundTransparency(_loc3_.bitmapData);
            events.dispatchEvent(new AdEvent(AdEvent.const_593,this.var_379.roomId,this.var_379.roomCategory,_loc4_,_loc2_.assetName,this.var_379.clickURL,this.var_1214,this.var_1213));
            this.var_379 = null;
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1214 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1213 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:int, param3:int, param4:int, param5:int, param6:String, param7:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_874,param2,param3,param1,param6,param7,null,null,param4,param5));
         }
      }
