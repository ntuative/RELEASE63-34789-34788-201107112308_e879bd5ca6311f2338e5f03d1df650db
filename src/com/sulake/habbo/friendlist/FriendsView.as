package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2237:String = "bg";
      ...
      public function fillFooter(param1:IWindowContainer) : void
      {
         ...
         this.var_2485 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2486 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = this.var_65.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2485,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2486,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_709.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_709.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
