package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2077:String = "no_reqs_info";
      ...
      private var var_1856:IContainerButtonWindow;
      
      private var var_1857:IContainerButtonWindow;
      ...
      {
         this.var_1856 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1857 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1857.procedure = this.onDismissAllButtonClick;
         this.var_1856.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_456)
         {
            this._friendList.refreshText(_loc2_,"info_text",true,"${friendlist.request.declined}");
         }
         else if(param1.state == FriendRequest.const_1210)
         {
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         this.var_65.addListItem(param1.view);
         this._friendList.friendRequests.refreshShading();
         this.refreshButtons();
      }
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         this.var_65.removeListItem(param1.view);
         this.refreshButtons();
      }
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_442 && _loc2_.state != FriendRequest.const_456)
            {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_456;
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_227,param1));
         }
      }
      ...
      public function declineAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_442 && _loc2_.state != FriendRequest.const_456)
            {
               ...
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_227,_loc2_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1856,_loc1_);
         this.setEnabled(this.var_1857,_loc1_);
      }
