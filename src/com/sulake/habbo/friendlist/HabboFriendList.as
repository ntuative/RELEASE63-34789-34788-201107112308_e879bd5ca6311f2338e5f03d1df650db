package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_833:ISessionDataManager;
      
      private var var_2565:FriendListLookAndFeel;
      
      private var var_435:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1918:OpenedToWebPopup;
      ...
      private var var_1917:AvatarSearchResults;
      ...
      {
         this.var_2565 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_118 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1917 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_668.stop();
            this.var_668.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_668 = null;
         }
         ...
         if(this.var_604)
         {
            this.var_604.release(new IIDAvatarRenderManager());
            this.var_604 = null;
         }
         if(this.var_993)
         {
         ...
         if(this.var_833)
         {
            this.var_833.release(new IIDSessionDataManager());
            this.var_833 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1918 = new OpenedToWebPopup(this);
         }
         this.var_1918.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_437);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_381,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_604.createAvatarImage(param1,AvatarScaleType.const_109,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_126.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_126.getKey(param1,param1,param2);
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_604 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_833 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_1346,this.getText("friendlist.friends")));
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_450,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_118.addFriend(new Friend(_loc4_));
         }
         this.var_435 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_668)
         {
            this.var_668 = new Timer(120000);
            this.var_668.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_668.start();
         }
         ...
         {
            _loc5_ = this.var_118.findCategory(FriendCategory.const_450);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_435.findTab(FriendListTab.const_92).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_435.findTab(FriendListTab.const_92);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1917.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_435.findTab(FriendListTab.const_92);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_435.findTab(FriendListTab.const_92);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_833 || !this.var_123)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_833.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_42))
         {
            _loc2_ = this.var_123.vipLimit;
         }
         else if(this.var_833.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_35))
         {
