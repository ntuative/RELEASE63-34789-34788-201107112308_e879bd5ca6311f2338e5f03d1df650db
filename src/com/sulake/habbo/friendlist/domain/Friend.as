package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2249:int = "F".charCodeAt(0);
      
      public static const const_2203:int = "M".charCodeAt(0);
      ...
      private var var_1300:BitmapData;
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_903 = param1.online;
         this.var_1884 = param1.followingAllowed && param1.online;
         this._figure = param1.figure;
         this.var_1982 = param1.motto;
         this.var_1983 = param1.lastAccess;
         this.var_1445 = param1.categoryId;
         this.var_1981 = param1.realName;
