package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_368:String = "TUI_NAME_VIEW";
      
      public static const const_395:String = "TUI_CLOTHES_VIEW";
      
      public static const const_572:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_416:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_533,this.onTaskDoneEvent);
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_645,this.onTaskDoneEvent);
         ...
         {
            this.var_36.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_353,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1341 && this.var_1342 && this.var_1635;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_36)
         {
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_533,this.onTaskDoneEvent);
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_645,this.onTaskDoneEvent);
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_666,this.onTaskDoneEvent);
            if(this.var_36.sessionDataManager != null)
            {
               this.var_36.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_353,this.onFigureUpdate);
            }
            this.var_36 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_533:
               this.var_1635 = true;
               if(this.var_54 != null && this.var_54.id == const_572)
               {
                  this.showView(const_99);
               }
               break;
            case HabboHelpTutorialEvent.const_645:
               if(this.var_54 != null && this.var_54.id == const_395)
               {
                  this.var_2080 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2784 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_368:
               ...
               if(this.var_416 == null)
               {
                  this.var_416 = new NameChangeView(this);
               }
               this.var_416.showMainView();
               this.prepareForTutorial();
               break;
            case const_395:
         ...
         this._window.height = _loc2_.height + this.var_2783;
         this._window.width = _loc2_.width + this.var_2784;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_54 != null && (this.var_54.id == const_368 || this.var_54.id == const_99))
         {
            this.showView(const_99);
         }
      }
      ...
      {
         this.var_1341 = true;
         if(this.var_54 != null && (this.var_54.id == const_395 || this.var_54.id == const_99))
         {
            this.showView(const_99);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_416.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_503)
         {
            this.var_416.checkedName = _loc2_.name;
         }
         else
         {
            this.var_416.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
