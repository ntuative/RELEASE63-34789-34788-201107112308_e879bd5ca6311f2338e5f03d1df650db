package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1637:uint = 13232628;
      
      private static var var_2083:uint = 11129827;
      ...
      private var var_1343:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_368;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_577 = param1;
         if(this.var_2081 == this.var_577)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_2082 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_883)
         {
            this.var_883 = this.var_26.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_883)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_884)
         {
            this.var_884 = this.var_26.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_884)
            {
               return;
            }
            this._window.content.addChild(this.var_884);
         }
         this._window.caption = this.var_26.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_884.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_577;
         }
         this.showView(this.var_884);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_26.localization.registerParameter("help.tutorial.name.available","name",this.var_577);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1141 || param1 == ChangeUserNameResultMessageEvent.var_1140)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1343 = new NameSuggestionListRenderer(this.var_26);
         var _loc6_:int = this.var_1343.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1637;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_577 = this.var_26.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_577 != _loc5_)
               {
                  this.var_2081 = _loc5_;
            ...
            case "confirm_name_button":
               this.var_26.changeName(this.var_577);
               break;
            ...
            case "header_button_close":
               this.var_26.showView(TutorialUI.const_99);
         }
      }
