package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_883)
         {
            this.var_883 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_883)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_884)
         {
            this.var_884 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_884)
            {
               return;
            }
