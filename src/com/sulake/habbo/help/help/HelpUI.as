package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2025:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201107112301));
         this.var_136 = new Map();
         this.var_136.add(HabboHelpViewEnum.const_1989,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_136.add(HabboHelpViewEnum.const_208,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_136.add(HabboHelpViewEnum.const_516,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_136.add(HabboHelpViewEnum.const_347,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_136.add(HabboHelpViewEnum.const_291,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_136.add(HabboHelpViewEnum.const_400,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_136.add(HabboHelpViewEnum.const_761,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_136.add(HabboHelpViewEnum.const_267,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_136.add(HabboHelpViewEnum.const_1354,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_136.add(HabboHelpViewEnum.const_1180,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_136.add(HabboHelpViewEnum.const_855,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_136.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_136.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_564.length == 0 || param1 != this.var_408)
            {
               this.var_564.push(this.var_408);
            }
         }
         this.var_408 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_408);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_267:
               this.showUI(HabboHelpViewEnum.const_267);
               break;
            case CallForHelpResultEnum.const_1206:
               this.showUI(HabboHelpViewEnum.const_1180);
               break;
            case CallForHelpResultEnum.const_1302:
               this.showUI(HabboHelpViewEnum.const_1354);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_136.getValue(HabboHelpViewEnum.const_208) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_533));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_136.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_136.getValue(this.var_408);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2784 = this._window.width - _loc3_.width;
         this.var_2783 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2783;
         this._window.width = _loc1_.width + this.var_2784;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_564.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_408 == HabboHelpViewEnum.const_208)
         {
            return;
         }
         ...
         var _loc2_:IBitmapWrapperWindow = this.var_407.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_408 == HabboHelpViewEnum.const_208 || this.var_564.length == 0)
         {
            return;
         }
         if(this.var_407 == null)
         {
            ...
            this.var_407 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_407.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_407.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_407 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_407 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_407 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
