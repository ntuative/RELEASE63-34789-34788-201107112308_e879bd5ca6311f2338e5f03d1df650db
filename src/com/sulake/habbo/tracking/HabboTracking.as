package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1156:uint = 11;
      ...
      private var var_1375:IHabboWindowManager;
      ...
      private var var_307:PerformanceTracker = null;
      
      private var var_495:FramerateTracker = null;
      
      private var var_306:LatencyTracker = null;
      
      private var var_731:LagWarningLogger = null;
      
      private var var_494:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_307 = new PerformanceTracker();
         this.var_495 = new FramerateTracker();
         this.var_306 = new LatencyTracker();
         this.var_731 = new LagWarningLogger();
         this.var_494 = new ToolbarClickTracker(this);
         this.var_1669 = new Array(const_1156);
         var _loc4_:int = 0;
         while(_loc4_ < const_1156)
         {
            this.var_1669[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1826,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1796,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1766,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_834,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1359,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1375)
            {
               this.var_1375.release(new IIDHabboWindowManager());
               this.var_1375 = null;
            }
            if(this.var_341)
            {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboNavigatorEvent.const_323,this.onZoomToggle);
               }
            ...
            if(this.var_234)
            {
               if(!this.var_234.disposed)
               {
                  ...
                  Component(this.var_234).events.removeEventListener(HabboFriendListTrackingEvent.const_531,this.onFriendlistTrackingEvent);
               }
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_199,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_385,this.onRoomAction);
               }
            ...
            {
               this.var_351.stop();
               this.var_351.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_351 = null;
            }
      ...
      {
         this.var_1669[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_126 = IHabboConfigurationManager(param2);
         if(this.var_126)
         {
            if(this.var_306 != null)
            {
               this.var_306.configuration = this.var_126;
            }
            if(this.var_307 != null)
            {
               this.var_307.configuration = this.var_126;
            }
            ...
            if(this.var_126)
            {
               ...
               {
                  this.var_731.configure(this.var_126);
               }
               if(this.var_495 != null)
               {
                  this.var_495.configure(this.var_126);
               }
               if(this.var_494 != null)
               {
                  this.var_494.configure(this.var_126);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_927,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_795,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_79,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_641,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_307 != null)
            {
               this.var_307.connection = param1;
            }
            if(this.var_306 != null)
            {
               this.var_306.communication = this._communication;
               this.var_306.connection = param1;
            }
            if(this.var_731 != null)
            {
               this.var_731.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_795)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1868);
         }
         else if(param1.type == HabboHotelViewEvent.const_641)
         {
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_927:
               this.trackLoginStep(HabboLoginTrackingStep.const_1999,String(this._communication.port));
               break;
      ...
      {
         this.var_1375 = IHabboWindowManager(param2);
         if(this.var_1375)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_126)
            {
               if(this.var_126.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_126.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1669)
                  {
                  ...
                  if(this.var_307 != null)
                  {
                     _loc4_["null"] = this.var_307.flashVersion;
                     _loc4_["null"] = this.var_307.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1400);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1400,this.onCoreRunning);
         }
      }
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_323,this.onZoomToggle);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_234).events.addEventListener(HabboFriendListTrackingEvent.const_531,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_531:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1359,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_834,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_199,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_385,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_341 = param2 as IAdManager;
         this.var_341.events.addEventListener(AdEvent.const_593,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_199)
         {
            if(this.var_2142 < 1)
            {
               if(!this.var_351)
               {
                  this.var_351 = new Timer(60000,1);
                  this.var_351.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_351.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_385)
         {
            if(this.var_351)
            {
               this.var_351.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_494)
         {
            this.var_494.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_494)
         {
            this.var_494.track(param1.type);
         }
      }
      ...
      {
         if(this.var_126 != null && !Boolean(this.var_126.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_731.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_591 > -1 && _loc2_ < this.var_591)
         {
            ++this.var_2140;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2140);
         }
         if(this.var_591 > -1 && _loc2_ - this.var_591 > 15000)
         {
            ++this.var_2141;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2141);
         }
         this.var_591 = _loc2_;
         if(this.var_307 != null)
         {
            this.var_307.update(param1,this.var_591);
         }
         if(this.var_306 != null)
         {
            this.var_306.update(param1,this.var_591);
         }
         if(this.var_495 != null)
         {
            this.var_495.trackUpdate(param1,this,this.var_591);
         }
         if(this.var_731 != null)
         {
            this.var_731.update(this.var_591);
         }
      }
   }
}
