package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_3101:Array;
      
      private var var_2201:GroupDetailsView;
      ...
      private var var_2202:UserTagManager;
      
      private var var_1399:BadgeImageManager;
      
      private var var_1400:HabboGroupInfoManager;
      
      private var var_1136:IgnoredUsersManager;
      ...
      private var var_1397:FaceBookSession;
      
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_3101 = [];
         this.var_2202 = new UserTagManager(events);
         this.var_1400 = new HabboGroupInfoManager(this,events);
         this.var_1136 = new IgnoredUsersManager(this);
         this.var_1397 = new FaceBookSession();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_745)
         {
            this.var_745.removeEventListener(ProductDataParser.const_129,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         if(this.var_126 == null || this._localization == null)
         {
            return;
         }
         this.var_1399 = new BadgeImageManager(context.root.assets,events,this.var_126,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_2202.communication = this._communication;
         this.var_1400.communication = this._communication;
         this.var_1397.communication = this._communication;
         this.var_1136.registerMessageEvents();
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_356)
         {
            ...
            this.var_356 = new FurnitureDataParser(this.var_602,this._wallItems,this.var_601,this._localization);
            this.var_356.addEventListener(FurnitureDataParser.const_129,this.onFurnitureReady);
            if(this.var_126.keyExists("furnidata.load.url"))
            {
               _loc3_ = this.var_126.getKey("furnidata.load.url");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2200 = _loc2_.clubLevel;
         this.var_2203 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_1398 = _loc3_.respectLeft;
         this.var_924 = _loc3_.petRespectLeft;
         this._figure = _loc3_.figure;
         this.var_991 = _loc3_.sex;
         this.var_1981 = _loc3_.realName;
         this.var_2865 = _loc3_.identityId;
         this.var_1136.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            ...
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this._figure,this.var_991));
         }
      }
      ...
      {
         return this.var_2203 >= SecurityLevelEnum.const_1200;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_2202.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1399.getBadgeImage(param1);
      }
      
      public function getBadgeImageWithInfo(param1:String) : BadgeInfo
      {
         return this.var_1399.getBadgeImageWithInfo(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_2201 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1400.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_2201.showGroupDetails(param1);
         }
      }
      
      public function getGroupDetails(param1:int) : HabboGroupDetails
      {
         return this.var_1400.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1400.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1399.getBadgeImage(param1,BadgeImageManager.const_1197);
      }
      ...
      {
         return this.var_1136.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_1136.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_1136.unignoreUser(param1);
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || this.var_1398 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to user: " + param1);
         }
         _loc2_.send(new RespectUserMessageComposer(param1));
         this.var_1398 = this.var_1398 - 1;
      }
      
      public function givePetRespect(param1:int) : void
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_924 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_924 = this.var_924 - 1;
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return this.var_602.getValue(param1.toString());
      }
      ...
      public function openHabboHomePage(param1:int) : void
      {
         ...
         {
            urlString = this.var_126.getKey("link.format.userpage");
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(param1 && this.var_1401.indexOf(param1) == -1)
         {
         ...
         {
            _loc2_ = this.var_126.getKey("productdata.load.url");
            this.var_745 = new ProductDataParser(_loc2_,this.var_1160);
            this.var_745.addEventListener(ProductDataParser.const_129,this.onProductsReady);
         }
         return false;
      }
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         var _loc2_:Array = this.var_602.getValues();
