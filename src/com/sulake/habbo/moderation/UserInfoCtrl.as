package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1053:int = 3600;
      
      private static const const_1052:int = 86400;
      
      private static const const_1051:int = 31536000;
      ...
      {
         if(param1 < 2 * const_1050)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1053)
         {
            return Math.round(param1 / const_1050) + " mins ago";
         }
         if(param1 < 2 * const_1052)
         {
            return Math.round(param1 / const_1053) + " hours ago";
         }
         if(param1 < 2 * const_1051)
         {
            return Math.round(param1 / const_1052) + " days ago";
         }
         return Math.round(param1 / const_1051) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1180.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_36.getXmlWindow("user_info"));
            this.var_1180.addChild(_loc1_);
            this.var_36.disableButton(this.var_36.initMsg.chatlogsPermission,_loc1_,"chatlog_but");
            this.var_36.disableButton(this.var_36.initMsg.method_7,_loc1_,"message_but");
            this.var_36.disableButton(this.var_36.initMsg.method_7 || this.var_36.initMsg.kickPermission || this.var_36.initMsg.banPermission,_loc1_,"modaction_but");
         }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_36,WindowTracker.const_1219,this._data.userId),this._callerFrame,this.var_1179,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new RoomVisitsCtrl(this.var_36,this._data.userId),this._callerFrame,this.var_1179,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new SendMsgsCtrl(this.var_36,this._data.userId,this._data.userName,this.var_1661),this._callerFrame,this.var_1179,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ModActionCtrl(this.var_36,this._data.userId,this._data.userName,this.var_1661),this._callerFrame,this.var_1179,false,true);
      }
