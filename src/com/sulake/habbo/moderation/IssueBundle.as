package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_761:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2299 = param2.pickerUserId;
         this.var_2298 = param2.pickerUserName;
         this.var_1683 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1163 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1162;
         }
         if(this.var_761 == null || param1.timeStamp < this.var_761.timeStamp)
         {
            this.var_761 = param1;
         }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_761;
         if(_loc2_ == null)
         {
