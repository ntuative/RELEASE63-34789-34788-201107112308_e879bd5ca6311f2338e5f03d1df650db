package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1068:Array = [];
      
      private static var var_2043:int = 1000;
      
      private static var var_1067:Array = [];
      
      private static var var_2045:int = 200;
      ...
      private var var_1896:IMessageComposer;
      ...
      {
         this.var_871 = IWindowContainer(this.var_36.getXmlWindow("chatlog_roomheader"));
         this.var_872 = IWindowContainer(this.var_36.getXmlWindow("chatlog_chatline"));
         ...
         this.var_36.connection.send(this.var_1896);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1068.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_872.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1068.length < var_2043)
         {
            ...
            param1.width = this.var_872.width;
            param1.height = this.var_872.height;
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1067.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_871.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1067.length < var_2045)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_871.width;
            param1.height = this.var_871.height;
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_2044[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1612.getValue(param2.chatterName))
            {
               this.var_1612.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1612.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1614)
         {
