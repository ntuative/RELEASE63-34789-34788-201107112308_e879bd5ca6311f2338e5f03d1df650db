package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1116:Array = [];
      
      private static var var_2138:int = 200;
      ...
      {
         this.var_909 = IWindowContainer(this.var_36.getXmlWindow("roomvisits_row"));
         ...
         this.var_65 = IItemListWindow(this._frame.findChildByName("visits_list"));
      ...
      {
         return WindowTracker.const_1985;
      }
      ...
      private function populateRoomRow(param1:RoomVisitData, param2:Boolean) : void
      {
         ...
         _loc7_.color = _loc4_;
         this.addRoomRowToList(_loc3_,this.var_65);
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1116.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_909.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1116.length < var_2138)
         {
            ...
            param1.width = this.var_909.width;
            param1.height = this.var_909.height;
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(this.var_65.parent);
         var _loc3_:IWindow = _loc2_.getChildByName("scroller") as IWindow;
         var _loc4_:* = this.var_65.scrollableRegion.height > this.var_65.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
               _loc3_.visible = false;
               this.var_65.width += 17;
            }
         }
         else if(_loc4_)
         {
