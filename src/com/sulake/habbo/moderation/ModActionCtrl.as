package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1369:IDropMenuWindow;
      ...
      private var var_1108:OffenceCategoryData;
      
      private var var_1109:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1370 = IButtonWindow(this.var_36.getXmlWindow("modact_offence"));
         this.var_1371 = IButtonWindow(this.var_36.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1786;
         ...
         this.var_36.disableButton(this.var_36.initMsg.method_7,this._frame,"send_caution_but");
         ...
         this.var_1369 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1369);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1108 != null;
         if(this.var_1109 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1109.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1108 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1108.offences,this.var_1370,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_36.initMsg.offenceCategories,this.var_1371,this.onOffenceCtgButton);
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModAlertMessageComposer(this.var_1660,this.var_588.text,this.var_1661));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1108 = this.var_36.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1109 = this.var_1108.offences[_loc3_];
         this.var_588.text = this.var_1109.msg;
         this.var_685 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModKickMessageComposer(this.var_1660,this.var_588.text,this.var_1661));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1369.selection < 0)
         {
            this.var_36.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_36.connection.send(new ModBanMessageComposer(this.var_1660,this.var_588.text,this.getBanLength(),this.var_1661));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1369.selection;
