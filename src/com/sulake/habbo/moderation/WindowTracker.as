package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_2028:int = 1;
      ...
      public static const const_1219:int = 5;
      
      public static const const_1985:int = 6;
      
      public static const const_1793:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1955:int = 9;
       
      
      private var var_2166:Dictionary;
      
      public function WindowTracker()
      {
         this.var_2166 = new Dictionary();
         super();
      }
      ...
      {
         var _loc2_:Dictionary = this.var_2166[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_2166[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
