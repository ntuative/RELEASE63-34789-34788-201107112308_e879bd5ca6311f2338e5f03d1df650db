package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1199:IDropMenuWindow;
      
      private var var_588:ITextFieldWindow;
      
      private var var_685:Boolean = true;
      
      private var var_1062:ICheckBoxWindow;
      
      private var var_1601:ICheckBoxWindow;
      
      private var var_1602:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_36.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_372));
      ...
      {
         this.var_65 = IItemListWindow(this._frame.findChildByName("list_cont"));
         var _loc1_:IWindow = this._frame.findChildByTag("close");
         _loc1_.procedure = this.onClose;
         this.var_588 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_588.procedure = this.onInputClick;
         this.var_1199 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1199);
         this.var_1199.procedure = this.onSelectTemplate;
         this.var_1062 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1601 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1602 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_65.getListItemByName(param2));
         ...
         if(!param1.exists)
         {
            this.disposeItemFromList(this.var_65,_loc3_);
            this.disposeItemFromList(this.var_65,this.var_65.getListItemByName("event_spacing"));
            return;
         }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_36,WindowTracker.const_879,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_685 || this.var_588.text == "")
         {
         ...
         this.var_36.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1919,_loc2_,this.var_588.text,"",""));
         if(this.var_1601.isSelected || this.var_1602.isSelected || this.var_1062.isSelected)
         {
            this.var_36.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1601.isSelected,this.var_1602.isSelected,this.var_1062.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1931);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1749);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_36.initMsg.roomMessageTemplates[this.var_1199.selection];
         if(_loc3_ != null)
         {
            this.var_685 = false;
            this.var_588.text = _loc3_;
         }
      }
   }
}
