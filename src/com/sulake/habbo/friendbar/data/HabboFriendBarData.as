package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1097:Boolean = false;
      
      private static const const_705:String = "Navigation";
      
      private static const const_704:String = "Friend Bar";
      
      private static const const_1574:String = "go.friendbar";
      
      private static const const_1572:String = "chat_btn_click";
      
      private static const const_1573:String = "find_friends_btn_click";
      
      private static const const_1099:String = "Toolbar";
      
      private static const const_1096:String = "open";
      
      private static const const_1098:String = "close";
      
      private static const const_1571:String = "FRIENDLIST";
      
      private static const const_1575:String = "MESSENGER";
       
      
      private var var_1041:IHabboConfigurationManager;
      
      private var var_95:IHabboCommunicationManager;
      
      private var var_87:IHabboFriendList;
      
      private var var_223:IHabboMessenger;
      
      private var var_675:IHabboEventStream;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_1041)
            {
               this.var_1041.release(new IIDHabboConfigurationManager());
               this.var_1041 = null;
            }
            if(this.var_95)
            {
            ...
            if(this.var_87)
            {
               if(!this.var_87.disposed)
               {
                  this.var_87.events.removeEventListener(FriendRequestEvent.const_59,this.onFriendRequestEvent);
                  this.var_87.events.removeEventListener(FriendRequestEvent.const_227,this.onFriendRequestEvent);
               }
               this.var_87.release(new IIDHabboFriendList());
               this.var_87 = null;
            }
            if(this.var_223)
            {
               this.var_223.release(new IIDHabboMessenger());
               this.var_223 = null;
            }
            if(this.var_675)
            {
               this.var_675.release(new IIDHabboEventStream());
               this.var_675 = null;
            }
            this.var_112 = null;
      ...
      public function acceptFriendRequest(param1:int) : void
      {
         ...
         if(this.var_87)
         {
            if(!this.var_87.disposed)
            {
               this.var_87.acceptFriendRequest(param1);
            }
         }
      }
      ...
      {
         this.var_123 = [];
         this.var_87.acceptAllFriendRequests();
      ...
      public function declineFriendRequest(param1:int) : void
      {
         ...
         if(this.var_87)
         {
            if(!this.var_87.disposed)
            {
               this.var_87.declineFriendRequest(param1);
            }
         }
      }
      ...
      {
         this.var_123 = [];
         this.var_87.declineAllFriendRequests();
         events.dispatchEvent(new FriendRequestUpdateEvent());
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_95)
         {
            ...
            this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_705,const_704,const_1574));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_223)
         {
            this.var_223.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false,param1));
            if(this.var_95)
            {
               this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_705,const_704,const_1572));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_95)
         {
            ...
            this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_705,const_704,const_1573));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_87)
         {
            if(!this.var_87.disposed)
            {
               if(!this.var_87.isOpen())
               {
                  if(this.var_123.length > 0)
                  {
                     this.var_87.openFriendRequests();
                  }
                  else
                  {
                     this.var_87.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_87.mainWindow;
               ...
               if(this.var_95)
               {
                  this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1099,const_1571,!!this.var_87.isOpen() ? const_1096 : const_1098));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_223)
         {
            ...
            {
               this.var_223.toggleMessenger();
               if(this.var_95)
               {
                  this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1099,const_1575,!!this.var_223.isOpen() ? const_1096 : const_1098));
               }
            }
         }
      }
      ...
      public function toggleOfflineStream() : void
      {
         if(this.var_675)
         {
            if(!this.var_675.disposed)
            {
               this.var_675.visible = !this.var_675.visible;
            }
         }
      }
      ...
      {
         this.var_1041 = param2 as IHabboConfigurationManager;
         this.var_2683 = this.var_1041.getBoolean("friendbar.notifications.enabled",false);
         this.var_1956 = this.var_1041.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      {
         this.var_223 = param2 as IHabboMessenger;
      }
      
      private function onOfflineStreamAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_675 = param2 as IHabboEventStream;
      }
      
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_87 = param2 as IHabboFriendList;
         this.var_87.events.addEventListener(FriendRequestEvent.const_59,this.onFriendRequestEvent);
         this.var_87.events.addEventListener(FriendRequestEvent.const_227,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_112 = !!const_320 ? this.sortByNameAndOnlineStatus(this.var_112) : this.sortByName(this.var_112);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         this.var_847 = _loc2_.senderId;
         var _loc3_:Boolean = true;
         if(this.var_223)
         {
            if(this.var_223.isOpen())
            {
               _loc4_ = this.var_223.getActiveConversation();
               if(_loc4_)
               {
                  if(_loc4_.id == this.var_847)
                  {
                     _loc3_ = false;
                  }
               }
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_847));
            this.makeNotification(String(this.var_847),FriendNotification.const_458,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         this.var_847 = _loc2_.senderId;
         if(this.var_223 && !this.var_223.isOpen())
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_847));
            this.makeNotification(String(this.var_847),FriendNotification.const_458,null,true,false);
         }
      }
