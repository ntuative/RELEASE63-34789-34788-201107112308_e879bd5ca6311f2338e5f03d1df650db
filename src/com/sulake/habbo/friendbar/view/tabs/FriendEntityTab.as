package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1462:String = "entity_xml";
      
      private static const const_1463:String = "facebook_piece_xml";
      
      private static const const_1464:String = "controls_piece_xml";
      
      protected static const const_1036:String = "pieces";
      ...
      protected static const const_1076:String = "btn_message";
      ...
      protected static const const_497:String = "notification";
      
      private static const const_78:uint = 10338138;
      
      private static const const_1063:uint = 13891476;
      
      private static const const_1065:String = null;
      
      private static const const_689:String = "icon_tag_notify";
      
      private static const const_1465:String = "icon_tag_message";
      ...
      protected var var_167:IFriendEntity;
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:IItemListWindow = IItemListWindow(param1.getChildByName(const_1036));
         ...
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_497,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            _loc2_ = IItemListWindow(window.getChildByName(const_1036));
            _loc5_ = false;
            if(this.friend.realName != null && this.friend.realName != "")
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1463).content as XML) as IWindowContainer;
               _loc3_.name = const_1416;
               _loc6_ = _loc3_.getChildByName(const_728) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2221.crop(_loc6_);
               }
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1464).content as XML) as IWindowContainer;
               _loc3_.name = const_1415;
               _loc8_ = _loc3_.getChildByName(const_1076);
               if(_loc8_)
               {
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_167)
         {
            _window.id = this.var_167.id;
            _loc1_ = IItemListWindow(_window.getChildByName(const_1036)).getListItemByName(const_465) as IWindowContainer;
            _loc1_.findChildByName(const_728).caption = this.var_167.name;
            var_2221.crop(_loc1_.getChildByName(const_728) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_317));
            _loc2_.bitmap = var_504.getAvatarFaceBitmap(this.var_167.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_471.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1462).content as XML) as IWindowContainer;
      ...
      private function onButtonClick(param1:WindowMouseEvent) : void
      {
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               case const_1076:
               case const_1037:
                  this.removeNotificationToken(FriendNotification.const_458,true);
                  if(var_357 && this.var_167)
                  {
                     var_357.startConversation(this.var_167.id);
                     this.deselect(true);
               ...
               case const_1414:
                  if(var_357 && this.var_167)
                  {
                     var_357.followToRoom(this.var_167.id);
                     this.deselect(true);
                  }
            }
         }
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         switch(param1.typeCode)
         {
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2239);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_689;
               break;
            case FriendNotification.const_1369:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2239);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_689;
               break;
            case FriendNotification.const_458:
      ...
      public function removeNotificationToken(param1:int, param2:Boolean) : void
      {
         ...
         while(_loc3_ > -1)
         {
            ...
            if(_loc4_.typeCode == param1)
            {
               ...
               if(param2)
               {
                  this.var_167.notifications.splice(this.var_167.notifications.indexOf(_loc4_.notification),1);
               }
               _loc4_.dispose();
               return;
            }
      ...
      {
         return getQualifiedClassName(this) + " " + this.var_167.name;
      }
   }
}
