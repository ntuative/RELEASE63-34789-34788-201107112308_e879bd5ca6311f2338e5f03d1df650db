package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      protected static const const_2047:String = "friend_request_tab_xml";
      
      protected static const const_464:String = "bubble";
      
      protected static const const_1076:String = "message";
      
      protected static const const_2045:String = "button_accept";
      
      protected static const const_1417:String = "button_close";
      
      protected static const const_1035:String = "click_region_reject";
      ...
      private static var var_1457:FriendRequestTab;
      ...
      public function FriendRequestTab()
      {
         ...
         if(_window)
         {
            _window.findChildByName(const_464).visible = false;
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1457 ? var_1457 : new FriendRequestTab();
      ...
      private function allocateRequestTabWindow() : IWindowContainer
      {
         ...
         var _loc5_:IBubbleWindow = _loc1_.findChildByName(const_464) as IBubbleWindow;
         _loc1_.x = 0;
         _loc1_.y = 0;
         _loc1_.width = name_2;
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_325,WindowStyle.const_104,WindowParam.const_31,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_462,WindowStyle.const_104,WindowParam.const_33,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case const_2045:
                  var_357.acceptFriendRequest(var_167.id);
                  break;
               case const_1417:
                  if(selected)
                  {
                  ...
                  break;
               case const_1035:
                  var_357.declineFriendRequest(var_167.id);
            }
         }
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1035)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1454;
            }
         }
      }
