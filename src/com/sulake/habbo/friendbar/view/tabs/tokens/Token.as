package com.sulake.habbo.friendbar.view.tabs.tokens
{
   ...
   public class Token implements IDisposable
   {
      ...
      protected static const const_2048:String = "title";
      ...
      protected var var_1417:FriendNotification;
      
      protected var var_1143:DropAnimation;
      ...
      {
         return this.var_1417.typeCode;
      }
      
      public function get viewOnce() : Boolean
      {
         return this.var_1417.viewOnce;
      }
      ...
      protected function prepare(param1:String, param2:String, param3:String, param4:String, param5:String, param6:Boolean) : void
      {
         ...
         this._window.findChildByName(const_2048).caption = param1;
         this._window.findChildByName(const_1076).caption = !!param2 ? param2 : "";
         ...
         this._icon = var_1432.create("ICON_" + this.typeCode,WindowType.const_325,WindowStyle.const_104,WindowParam.const_31,Token.ICON_RECTANGLE) as IRegionWindow;
         this._icon.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = var_1432.create("BITMAP_" + this.typeCode,WindowType.const_462,WindowStyle.const_104,WindowParam.const_186,Token.ICON_RECTANGLE) as IBitmapWrapperWindow;
         ...
         if(param6)
         {
            this.var_1143 = new DropAnimation(this._icon,600,32);
         }
      }
   }
}
