package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2350:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_371 = param5;
         this.var_371.events.addEventListener(BadgeImageReadyEvent.const_222,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_371.events.removeEventListener(BadgeImageReadyEvent.const_222,this.onBadgeImageReady);
            this.var_371 = null;
         }
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_786.length)
         {
            if(this.var_786[_loc2_] == param1)
            {
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1215.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_638.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_371.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_251.unshift(_loc11_);
            }
            else
            {
               this.var_251.push(_loc11_);
            }
            if(param2)
            {
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_371);
         var _loc3_:int = 0;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_251.length)
         {
            _loc3_ = this.var_251[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_543);
         ...
         var _loc3_:Array = this.getBadges(const_371);
      ...
      {
         return this.getItemInIndex(param1,const_371);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_543);
      }
      ...
      {
         if(param1 == InventoryCategory.const_234 && this.var_26.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_638.indexOf(_loc2_) == -1)
            {
               this.var_638.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_638 && this.var_638.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1203));
            this.var_638 = [];
