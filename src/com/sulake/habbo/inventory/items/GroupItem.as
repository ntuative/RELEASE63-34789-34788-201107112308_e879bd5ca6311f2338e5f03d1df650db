package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1487:int = 13421772;
      
      private static const const_1486:int = 10275685;
      ...
      private var var_1517:IWindow;
      
      private var var_2445:IWindow;
      ...
      protected var var_2390:int;
      
      protected var var_1706:Boolean;
      
      protected var var_2260:Boolean;
      
      protected var var_3051:BitmapData;
      
      private var var_1489:Boolean;
      
      private const const_2074:Number = 1;
      
      private const const_2073:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this._type = param1;
         this._window = param4;
         this.var_1517 = this._window.findChildByTag("BG_COLOR");
         this.var_2445 = this._window.findChildByName("outline");
         this._roomEngine = param5;
         this.var_3051 = param6;
         this.var_2260 = param7;
         this._items = new Map();
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2261 == FurniModelCategory.const_39)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1670));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2259);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_908)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2073;
               _loc1_.blend = this.const_2073;
            }
            else
            {
               this._window.blend = this.const_2074;
               _loc1_.blend = this.const_2074;
            }
         }
         this.var_1517.color = !!this.var_1489 ? uint(const_1486) : uint(const_1487);
         this.var_2445.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2260 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3051;
               _loc5_.visible = true;
            }
            else
            {
