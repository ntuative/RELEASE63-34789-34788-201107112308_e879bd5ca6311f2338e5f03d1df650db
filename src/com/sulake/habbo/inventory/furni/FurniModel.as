package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1545:int = 100;
      ...
      private var var_1544:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_457 = [];
         this.var_458 = [];
         this.var_666 = new Timer(const_1545,1);
         ...
         this.var_2554 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_154,this.onObjectPlaced);
               }
            ...
            {
               this.var_221.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_221.stop();
               this.var_221 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_39)
            {
               ...
               {
                  this.var_1544 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1544;
            }
            else
            {
         ...
         this.var_26.setInventoryCategoryInit(InventoryCategory.const_70);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_344)
         {
         ...
         else if(param3 == FurniCategory.const_359)
         {
         ...
         if(this.var_831 == null)
         {
            this.var_831 = this._windowManager.buildFromXML(this.var_2554) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_831.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_831.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_221 = new Timer(param1,1);
            this.var_221.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_221.start();
         }
         else
         {
      ...
      {
         if(param1 == InventoryCategory.const_70 && this.var_26.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_46:
                  ...
                  break;
               case const_312:
                  this.var_26.toggleInventoryPage(InventoryCategory.const_122);
            }
         }
      }
      ...
      {
         this.var_2556 = getTimer();
         this.switchCategory(const_312);
      }
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_667.add(const_39,new Array());
         this.var_667.add(const_46,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_39;
            _loc5_ = this.var_457.indexOf(param1.ref) > -1;
         }
         else
         {
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_218)
                  {
                     _loc7_ = _loc9_;
                  }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_312)
            {
      ...
      {
         return getTimer() < this.var_2556 + const_1544;
      }
      ...
      {
         return this.var_26.getSubCategoryViewId() == InventorySubCategory.const_365;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_359 || _loc3_.category == FurniCategory.const_344 || _loc3_.category == FurniCategory.const_326)
         {
            if(param1)
            {
               return false;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_365:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               ...
               if(_loc4_.category == FurniCategory.const_908)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_457.indexOf(_loc2_) == -1)
            {
               this.var_457.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_455:
               return this.var_457.length;
            case UnseenItemCategoryEnum.const_420:
               return this.var_458.length;
            default:
               return this.var_457.length + this.var_458.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         switch(param1)
         {
            case const_46:
               ...
               break;
            case const_39:
               if(this.var_457 && this.var_457.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_455));
                  this.var_457 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
