package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private static const const_474:int = 3;
      ...
      private var var_2173:IWindowContainer;
      
      private var var_920:String;
      
      private var var_3022:IWindowContainer;
      ...
      private const const_2065:Point = new Point(120,150);
      ...
      {
         return !!this.var_16 ? Boolean(this.var_16.getStateFlag(WindowState.const_87)) : false;
      }
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_26.inventoryViewOpened(this.var_920);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_425 != null && this.var_425 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_425 || !this.var_26.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_920);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            case InventoryCategory.const_70:
               ...
               break;
            case InventoryCategory.const_122:
               this.var_26.petsModel.resetUnseenItems();
               break;
            case InventoryCategory.const_234:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_425);
         }
         ...
         _loc2_.container.removeChild(this.var_2173);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_425 == InventoryCategory.const_122)
            {
               this.toggleCategoryView(InventoryCategory.const_122);
            }
            else if(this.var_425 == InventoryCategory.const_70)
            {
               this.toggleCategoryView(InventoryCategory.const_70);
            }
            else if(this.var_26 != null)
            {
               this.var_26.toggleInventoryPage(InventoryCategory.const_70);
            }
         }
      }
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_2174)
         {
            this.var_2174 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_26.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_2174,_loc1_);
      ...
      private function createCounter(param1:String) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_.x = _loc4_.width - _loc3_.width - const_474;
            _loc3_.y = const_474;
         }
         return _loc3_;
      }
