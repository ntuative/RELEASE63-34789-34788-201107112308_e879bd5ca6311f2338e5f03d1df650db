package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1525:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_1007 = param6;
         this.var_253 = Math.floor(this.var_1243 / this._thumbWidth);
         this.var_28 = new BitmapData(this.var_1243,this.var_1007);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_28 = new BitmapData(Math.max(this.var_253 * this._thumbWidth,this.var_1243),Math.max(this.var_654 * this.var_105,this.var_1007),true,16777215);
            ...
            while(_loc4_ < this.var_253)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     this.var_28.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * this._thumbWidth,_loc3_ * this.var_105),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_253 && this.var_28.height < _loc3_.y * this.var_105)
         {
            _loc2_ = new BitmapData(this.var_28.width,this.var_28.height + this.var_105);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_253 - 1),this.var_105);
         _loc2_.copyPixels(this.var_28,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_253 - 1),0,this._thumbWidth,this.var_28.height);
         _loc2_.copyPixels(this.var_28,_loc4_,new Point(0,this.var_105),null,null,true);
         _loc4_ = new Rectangle(0,this.var_105,this._thumbWidth * (this.var_253 - 1),this.var_28.height - this.var_105);
         _loc2_.copyPixels(this.var_28,_loc4_,new Point(this._thumbWidth,this.var_105),null,null,true);
         this.var_28 = _loc2_;
      }
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1525.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_253));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_253 + _loc2_.x);
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_253);
         var _loc3_:int = param1 % this.var_253;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = this.var_253 - param1.x - 1;
         ...
         if(param1.y < this.var_654 - 1)
         {
            ...
            _loc8_ = this.var_28.height - (param1.y + 1) * this.var_105;
            ...
            this.var_28.fillRect(new Rectangle(0,this.var_28.height - this.var_105,this.var_28.width,this.var_105),4294967295);
            _loc3_ = new Point(this.var_28.width - this._thumbWidth,_loc2_.y - this.var_105);
         ...
         if(_loc6_ > 0)
         {
            ...
            if(param1.x == this.var_253 - 1)
            {
               _loc11_ = new BitmapData(this.var_28.width,this.var_28.height - this.var_105);
               _loc2_ = new Rectangle(0,0,this.var_28.width,this.var_28.height - this.var_105);
               _loc11_.copyPixels(this.var_28,_loc2_,new Point(0,0),null,null,true);
               this.var_28 = _loc11_;
               --this.var_654;
            }
         }
         if(this.var_28.height < this.var_1007)
         {
            _loc12_ = new BitmapData(this.var_28.width,this.var_1007);
