package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_45:
               this.var_1518.setSelectedGridItem(this);
               this.var_1516 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1516 = false;
                  this.var_1518.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1517)
         {
            return;
         }
         this.var_1517.color = !!this.var_1685 ? uint(const_1486) : uint(const_1487);
         this.var_2445.visible = param1;
      }
