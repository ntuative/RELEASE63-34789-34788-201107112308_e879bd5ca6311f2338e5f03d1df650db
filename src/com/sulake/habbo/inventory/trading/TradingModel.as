package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1791:uint = 9;
      
      public static const const_216:uint = 0;
      
      public static const const_228:uint = 1;
      
      public static const const_460:uint = 2;
      
      public static const const_370:uint = 3;
      
      public static const const_555:uint = 4;
      
      public static const const_303:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_917 = false;
         this.var_3008 = param3;
         this.var_1690 = param4;
         this.var_3009 = param5;
         ...
         this.var_61.updateItemList(this.var_916);
         this.var_61.updateItemList(this.var_1690);
      ...
      public function close() : void
      {
         if(this.var_821)
         {
            if(this._state != const_216 && this._state != const_303)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_917 + " OTHER: " + this.var_1386);
         ...
         {
            case const_216:
               if(param1 == const_228 || param1 == const_303)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         if(this.var_310 == null || this.var_310.disposed)
         {
            return _loc1_;
         }
         var _loc4_:int = 0;
         ...
         {
            _loc2_ = this.var_310.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_61.alertPopup(TradingView.const_1260);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_916)
            {
               this.var_917 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_916)
            {
               this.var_61.alertPopup(TradingView.const_1320);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_310.length < const_1791)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_218)
            {
               _loc6_ = String(param2) + "poster" + param5;
            }
            if(this.var_310.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
