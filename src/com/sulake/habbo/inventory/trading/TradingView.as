package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1128:uint = 4284532064;
      
      private static const const_1127:uint = 2577770;
      ...
      private var var_709:ItemPopupCtrl;
      ...
      private var var_1089:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_709 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_230)
            {
               this.var_230.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_230.stop();
               this.var_230 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(this.var_2086 == null)
         {
            this.var_2086 = this.createMinimizedWindow();
         }
         if(!this.var_1156)
         {
            return this.var_81;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_81)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.ownUserAccepts ? uint(const_1128) : uint(const_1127);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.otherUserAccepts ? uint(const_1128) : uint(const_1127);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_230 = new Timer(1000,3);
            this.var_230.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_230.reset();
         this.var_230.repeatCount = 3;
         this.var_230.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_230.currentCount));
         if(this.var_230.currentCount == 3)
         {
      ...
      public function removeSelection() : void
      {
         if(this.var_1089)
         {
            this.var_1089.isSelected = false;
            this.var_1089 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1991)
            {
            ...
            this.var_709.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_544);
            this.var_709.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_709.hideDelayed();
         }
      }
         ...
         if(this.var_205.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_19.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_19.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_709.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_544);
               }
            }
            else
            {
