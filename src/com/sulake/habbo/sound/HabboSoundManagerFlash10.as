package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1492:int = 60;
      
      private static const const_1493:int = 25165823;
      
      private static const const_1494:int = 16777215;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1026,this.onTraxLoadComplete);
         ...
         if(_loc2_ == null)
         {
            ...
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1232:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1917:
                  _loc3_ = "sound_guide_received_invitation";
                  break;
               case HabboSoundTypesEnum.const_1274:
               ...
               case HabboSoundTypesEnum.const_1304:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1865:
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_126.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_126.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_645.add(_loc4_,param1);
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_277,events);
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_277.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_126.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2450 = true;
            }
         }
      ...
      {
         if(this.var_126 == null || this._connection == null || this._roomEngine == null || this.var_263 != null)
         {
            return;
         }
         this.var_263 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_263.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1756,this.var_797));
         this.var_797 = -1;
         this.var_796 = null;
      }
      ...
      {
         this.var_992 = param1;
         this.var_263.updateVolume(this.var_992);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         {
            _loc2_ = this.var_645.remove(param1);
            if(this.var_277.getValue(_loc2_) == null)
            {
               this.var_1492.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1492,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1492,_loc2_,TraxSample.const_1822,TraxSample.const_1778);
               this.var_277.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         if(this.var_1225.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1492 && this.var_1225.length > 0)
            {
               _loc3_ = this.var_1225.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_645.length == 0 && this.var_797 != -1)
            {
               this.var_796.ready = true;
               _loc4_ = this.var_797;
               this.var_797 = -1;
               this.var_796 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1026,_loc4_));
               if(this.var_2450)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_796 == null && this.var_1224.length > 0)
         {
            ...
            if(_loc2_ != null && !_loc2_.disposed)
            {
               ...
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1026,_loc1_));
               }
               else
               {
                  this.var_796 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:* = [];
         var _loc3_:Array = this.var_263.samplesIdsInUse;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_277.length)
         {
            _loc5_ = this.var_277.getKey(_loc4_);
            _loc6_ = this.var_277.getWithIndex(_loc4_);
         ...
         if(_loc1_ > const_1493)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1494 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               for each(_loc11_ in _loc7_)
               {
                  ...
                  _loc12_ = this.var_277.getValue(_loc11_) as TraxSample;
                  _loc12_.dispose();
                  this.var_277.remove(_loc11_);
               }
               this.var_263.samplesUnloaded(_loc7_);
            }
         }
      }
