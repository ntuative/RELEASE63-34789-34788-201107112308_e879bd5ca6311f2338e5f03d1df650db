package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_263:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_263 = param2;
         this.var_844 = [];
         this.var_844.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_844.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_844)
         {
         ...
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_959,this.onSoundMachinePlayEvent);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_784,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_94)
            {
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_959,this.onSoundMachinePlayEvent);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_784,this.onSoundMachineStopEvent);
               this.var_94 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_498);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_263.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_498 = -1;
         this.var_734 = false;
         this.var_263.stop(HabboMusicPrioritiesEnum.const_124);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_263.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_263.playSong(param1,HabboMusicPrioritiesEnum.const_124,_loc3_,0,0,0))
         {
