package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1461:Point = new Point(3,3);
      
      private static const const_1471:uint = 7433577;
      
      private static const const_1476:uint = 5723213;
      
      private static const const_475:String = "_hover";
      
      private static const const_473:String = "_normal";
      
      private static const const_474:int = 5;
      
      private static const const_1472:int = 600;
      
      private static const const_1475:int = 80;
      
      private static const const_1477:int = 74;
      
      private static const ICON_SPACING_NORMAL:int = 10;
      
      private static const const_1473:int = -2;
      
      private static const const_1474:int = 5;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1461;
         this._window.addEventListener(WindowEvent.const_514,this.onParentResized);
         ...
         {
            this.method_4(_loc11_,const_473);
         }
         ...
         this.var_217 = param2.buildFromXML(_loc12_.content as XML,2) as IWindowContainer;
         ...
         _loc13_.addChild(this.var_217);
         var _loc14_:ITextWindow = this.var_217.findChildByName("new_textfield") as ITextWindow;
         ...
         this.var_217.x = _loc13_.width - this.var_217.width - const_474;
         this.var_217.y = const_474;
         this.var_2417 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1472;
         if(!param1 && _loc2_ == this.var_1478)
         {
            return;
         }
         this.var_1478 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1477) : int(const_1475);
         var _loc4_:int = !!_loc2_ ? int(const_1473) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1474 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1470;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_217 != null && this.var_2417)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_824:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_759:
               _loc3_ = true;
         }
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.method_4(_loc4_,const_475);
               this.setIconBgHoverState(_loc3_,const_475);
               break;
            case WindowMouseEvent.const_25:
               this.method_4(_loc4_,const_473);
      ...
      private function method_4(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_475 ? this.var_1480 : this.var_1479;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_475)
         {
            param1.color = const_1471;
         }
         else
         {
            param1.color = const_1476;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1478 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1478 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1479 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1480)
         {
            this.var_1480.dispose();
         }
         this.var_1480 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_979.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_474;
            _loc2_.y = const_474;
            this.var_979.add(param1,_loc2_);
         }
         return _loc2_;
      }
