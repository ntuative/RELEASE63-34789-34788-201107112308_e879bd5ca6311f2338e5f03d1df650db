package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1566:String = "purse";
      
      private static const const_1565:String = "extra_tools";
      ...
      private var var_669:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1279:PurseExtension;
      
      private var var_1559:ClubDiscountPromoExtension;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_12:IHabboInventory;
      
      private var var_670:ExtensionView;
      ...
      {
         if(this.var_275 && this._windowManager && this._config && this._localization && this.var_12 && this._catalog)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_670 = new ExtensionView(this._windowManager,this._assetLibrary,this);
            if(this.var_670)
            {
               this.var_1279 = new PurseExtension(this._windowManager,this._assetLibrary,this._config,this._catalog,this.var_12,this._localization);
               this.var_669 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
               if(this._config.getBoolean("club.membership.extend.promotion.enabled",false))
               {
                  this.var_1559 = new ClubDiscountPromoExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               this.var_670.attachExtension(const_1566,this.var_1279.window,ExtensionFixedSlotsEnum.const_1788);
               this.var_670.attachExtension(const_1565,this.var_669.window,ExtensionFixedSlotsEnum.const_1857);
            }
         }
         if(this._view == null)
         {
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_669.showRoomInfo();
         }
         else
         {
            this.var_669.hideRoomInfo();
         }
      }
