package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class ClubDaysIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_1457:uint = 4286084205;
      
      private static const const_1456:uint = 4283781966;
      ...
      public function ClubDaysIndicator(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboCatalog, param4:IHabboInventory, param5:ICoreLocalizationManager)
      {
         ...
         this.var_12 = param4;
         this.bgColorLight = const_1457;
         this.bgColorDark = const_1456;
      ...
      override public function method_1(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(HabboInventoryHabboClubEvent.const_382,this.onClubChanged);
      }
