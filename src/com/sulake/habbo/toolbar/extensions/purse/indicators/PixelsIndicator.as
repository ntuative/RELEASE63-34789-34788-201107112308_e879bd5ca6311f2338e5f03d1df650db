package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class PixelsIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_1457:uint = 4285767869;
      
      private static const const_1456:uint = 4283664040;
      ...
      override public function method_1(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(PurseEvent.const_336,this.onPixelBalance);
      }
      
      override protected function onContainerClick(param1:WindowMouseEvent) : void
      {
         this._catalog.openCatalogPage(CatalogPageName.const_1775);
      }
      ...
      private function onPixelBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_2126 != 0)
         {
            if(this.var_2126 > param1.balance)
            {
