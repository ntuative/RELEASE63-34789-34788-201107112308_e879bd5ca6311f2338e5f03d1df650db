package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ClubDiscountPromoExtension
   {
      ...
      private static const const_697:String = "club_promo";
      
      private static const const_1458:int = 13;
      
      private static const const_1064:int = 14;
      
      private static const const_1517:uint = 16777215;
      ...
      private var var_670:IExtensionView;
      ...
      private var var_1238:IRegionWindow;
      ...
      public function ClubDiscountPromoExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager, param6:ICoreLocalizationManager, param7:IHabboInventory, param8:IHabboCatalog, param9:IConnection)
      {
         ...
         this.var_670 = param1.extensionView;
         if(this.var_12)
         {
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_382,this.onClubChanged);
         }
      }
         ...
         if(_loc4_)
         {
            ...
            if(_loc3_)
            {
               ...
               if(this.var_86)
               {
                  ...
                  if(_loc5_)
                  {
                     this.var_813 = _loc5_.content as BitmapData;
                     if(this.var_813)
                     {
                        this.var_86.bitmap = this.var_813.clone();
                     }
                  }
                  this.var_86.visible = false;
               }
               this.var_1238 = _loc3_.findChildByName("text_region") as IRegionWindow;
               if(this.var_1238)
               {
                  this.var_1238.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onTextRegionClicked);
                  this.var_1238.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onTextRegionMouseOver);
                  this.var_1238.addEventListener(WindowMouseEvent.const_25,this.onTextRegionMouseOut);
               }
               this.assignState();
            }
         }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_670)
            {
               this.var_670.detachExtension(const_697);
               this.var_670 = null;
            }
            this.animate(false);
            this.clearAnimation();
            ...
            if(this.var_12)
            {
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_382,this.onClubChanged);
               this.var_12 = null;
            }
            this._catalog = null;
      ...
      private function onClubChanged(param1:HabboInventoryHabboClubEvent) : void
      {
         if(this.var_12.clubIsExpiring)
         {
            if(!this._view)
            {
               ...
               this.assignState();
               this.var_670.attachExtension(const_697,this._view,ExtensionFixedSlotsEnum.const_1877);
            }
         }
         else
         {
      ...
      private function animate(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            this.var_651 = new Timer(15000);
            this.var_651.addEventListener(TimerEvent.TIMER,this.onTriggerTimer);
            this.var_651.start();
         }
         else
         {
      ...
      private function resetAnimationVariables() : void
      {
         ...
         this.var_1864 = this._view.width - 7 - this.var_86.bitmap.width;
         this.var_1519 = 0;
      }
      
      private function startAnimationTimer() : void
      {
         this.var_699 = new Timer(25,26);
      ...
      private function onAnimationTimer(param1:TimerEvent) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         this.var_86.x = 3 + this.var_1519 / 20 * this.var_1864;
         if(this.var_86.x > this.var_1864)
         {
            _loc2_ = this._view.width - 4 - this.var_86.x;
            _loc3_ = new BitmapData(_loc2_,this.var_813.height);
            _loc3_.copyPixels(this.var_813,new Rectangle(0,0,_loc2_,this.var_813.height),new Point(0,0));
