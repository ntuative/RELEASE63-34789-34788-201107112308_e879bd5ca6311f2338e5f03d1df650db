package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1519:String = "HELP";
      ...
      public function ExtraToolsExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_414 = this._window.findChildByName("roominfo_region");
         this.var_65 = this._window.findChildByName("list") as IItemListWindow;
         var _loc7_:* = [];
         this.var_65.groupListItemsWithTag("REGION",_loc7_);
      ...
      {
         this.var_65.removeListItem(this.var_414);
      }
      
      public function showRoomInfo() : void
      {
         this.var_65.addListItemAt(this.var_414,0);
      }
      ...
      private function showConfirmation() : void
      {
         ...
         if(!this.var_331)
         {
            this.var_331 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
            _loc1_ = new Point();
            this._window.getGlobalPosition(_loc1_);
            this.var_331.x = _loc1_.x + this._window.width - this.var_331.width;
            this.var_331.y = _loc1_.y + this._window.height - this.var_331.height;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1519);
               break;
