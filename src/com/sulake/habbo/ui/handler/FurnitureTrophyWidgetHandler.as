package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureTrophyWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_953];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_953:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     _loc10_ = new RoomWidgetTrophyDataUpdateEvent(RoomWidgetTrophyDataUpdateEvent.const_932,_loc5_,_loc7_,_loc8_,_loc9_);
