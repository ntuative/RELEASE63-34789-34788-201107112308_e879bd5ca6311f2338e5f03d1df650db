package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_981);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_895);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_1016);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_981:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_895:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_1016:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_143);
         _loc1_.push(FriendRequestEvent.const_59);
         _loc1_.push(FriendRequestEvent.const_227);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_143:
            ...
            case FriendRequestEvent.const_227:
