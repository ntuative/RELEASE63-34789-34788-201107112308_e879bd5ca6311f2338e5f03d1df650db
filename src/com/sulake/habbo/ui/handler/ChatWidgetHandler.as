package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_1802:Map = null;
      
      private var var_1209:Array;
      
      private var _connection:IConnection = null;
      
      private var var_1210:Number = 0.0;
      
      private var var_785:Point = null;
      
      private var var_525:Vector3d;
      ...
      {
         return [RoomWidgetChatMessage.const_794,RoomWidgetChatSelectAvatarMessage.const_892];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_794:
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_35) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1278))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_35) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1278))
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_583);
                                 this._container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
                     ...
                     switch(_loc3_.chatType)
                     {
                        ...
                        case RoomWidgetChatMessage.const_139:
                           ...
                           break;
                        case RoomWidgetChatMessage.const_159:
                           this._container.roomSession.sendWhisperMessage(_loc3_.recipientName,_loc3_.text);
                     }
                  }
               }
               break;
            case RoomWidgetChatSelectAvatarMessage.const_892:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_233)
                           {
                           ...
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_233:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1210 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1210);
            }
            if(this.var_785 == null)
            {
               ...
               this.var_525.y = 0;
               this.var_525.z = 0;
               this.var_785 = _loc4_.getScreenPoint(this.var_525);
               this.var_1210 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_525.x = 0;
            this.var_525.y = 0;
            this.var_525.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_525);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_785.x || _loc8_.y != this.var_785.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_785,_loc5_));
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1802.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1802.remove(param1);
         if(_loc3_ != null)
         {
