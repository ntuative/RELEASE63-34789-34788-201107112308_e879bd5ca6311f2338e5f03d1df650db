package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_263.events.addEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
            this.var_263.events.addEventListener(SongInfoReceivedEvent.const_98,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_222,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_222,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_728.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_728.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_263 != null)
         {
            this.var_263.events.removeEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
            this.var_263.events.removeEventListener(SongInfoReceivedEvent.const_98,this.onSongInfoReceivedEvent);
            this.var_263 = null;
         }
         this.var_1153 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_495);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_930);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_570);
         _loc1_.push(RoomWidgetUserActionMessage.const_399);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_961);
         _loc1_.push(RoomWidgetFurniActionMessage.const_286);
         _loc1_.push(RoomWidgetFurniActionMessage.const_804);
         _loc1_.push(RoomWidgetFurniActionMessage.const_909);
         _loc1_.push(RoomWidgetFurniActionMessage.const_922);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1263);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_842);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_831);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_785);
         _loc1_.push(RoomWidgetUserActionMessage.const_524);
         _loc1_.push(RoomWidgetUserActionMessage.const_547);
         _loc1_.push(RoomWidgetUserActionMessage.const_509);
         _loc1_.push(RoomWidgetUserActionMessage.const_1910);
         _loc1_.push(RoomWidgetPetCommandMessage.const_639);
         _loc1_.push(RoomWidgetPetCommandMessage.const_982);
         _loc1_.push(RoomWidgetUserActionMessage.const_527);
         _loc1_.push(RoomWidgetUserActionMessage.const_290);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_836);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_290 || param1.type == RoomWidgetUserActionMessage.const_527 || param1.type == RoomWidgetUserActionMessage.const_509)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_495:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_930:
               return this.method_10(param1 as RoomWidgetRoomObjectMessage);
            ...
            case RoomWidgetUserActionMessage.const_670:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1293,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_619:
               ...
               break;
            case RoomWidgetUserActionMessage.const_570:
               this._container.sessionDataManager.unignoreUser(_loc3_.name);
               break;
            case RoomWidgetUserActionMessage.const_399:
            ...
            case RoomWidgetUserActionMessage.const_626:
               ...
               break;
            case RoomWidgetUserActionMessage.const_961:
               this._container.sessionDataManager.openHabboHomePage(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_509:
               this._container.roomSession.pickUpPet(_loc2_);
               break;
            case RoomWidgetFurniActionMessage.const_804:
            ...
            case RoomWidgetFurniActionMessage.const_286:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_909:
            ...
            case RoomWidgetFurniActionMessage.const_922:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1263:
               ...
               break;
            case RoomWidgetUserActionMessage.const_290:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_842:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_831:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_785:
            ...
            case RoomWidgetUserActionMessage.const_547:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_982:
            ...
            case RoomWidgetPetCommandMessage.const_639:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_836:
      ...
      private function method_10(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc5_:int = 0;
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_444) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_444);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_1001) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1170;
               }
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1202);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1345);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_629)
                  {
                     _loc30_ = this.var_263.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_396.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_263.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_233)
               {
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_646)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_332);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_114)
               {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_172)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_910);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_814;
                  }
                  if(!_loc35_)
                  {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1782);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_167];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_167:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_728.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_728.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_910);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_263 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_263.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_408,_loc2_,_loc3_,_loc4_));
         }
      }
