package com.sulake.habbo.ui.handler
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_802);
         _loc1_.push(RoomWidgetRoomQueueMessage.const_983);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               ...
               break;
            case RoomWidgetRoomQueueMessage.const_802:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1351);
               break;
            case RoomWidgetRoomQueueMessage.const_983:
      ...
      {
         return [RoomSessionQueueEvent.const_586];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_586:
               ...
               {
                  case RoomSessionQueueEvent.const_1351:
                     _loc3_ = "null";
                     break;
               ...
               if(_loc5_.length > 1)
               {
                  ...
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1832) + 1;
                  }
               }
               else
               {
