package com.sulake.habbo.ui.handler
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_530;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(InterstitialEvent.const_610);
         _loc1_.push(InterstitialEvent.const_567);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_117);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_342);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case InterstitialEvent.const_610:
               ...
               break;
            case InterstitialEvent.const_567:
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_117:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_342:
               this._container.events.dispatchEvent(param1);
         }
      }
