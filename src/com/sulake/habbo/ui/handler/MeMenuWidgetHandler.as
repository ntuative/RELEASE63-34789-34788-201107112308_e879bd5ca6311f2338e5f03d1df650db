   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_353,this.onFigureUpdate);
            }
            if(this.var_12 && !this.var_12.disposed && this.var_12.events)
            {
               this.var_12.events.removeEventListener(HabboInventoryEffectsEvent.const_275,this.onAvatarEffectsChanged);
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_382,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_774,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_353,this.onFigureUpdate);
         }
         this.var_12 = this._container.inventory;
         if(this.var_12 != null)
         {
            this.var_12.events.addEventListener(HabboInventoryEffectsEvent.const_275,this.onAvatarEffectsChanged);
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_382,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_774,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1663)
            {
               ...
               this.var_1663 = _loc3_;
               this.var_2130 = _loc1_;
               this.var_2131 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_2130;
               _loc2_ = this.var_2131;
            }
         }
         if(this._toolbar != null)
         {
            ...
            {
               if(_loc1_.height > const_488)
               {
                  _loc7_ = new BitmapData(_loc1_.width,const_488,true,0);
                  _loc8_ = _loc7_.rect.clone();
                  if(_loc2_.height > const_488 - const_1151)
                  {
                     _loc8_.offset(0,_loc2_.height - const_488 + const_1151);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_904);
         _loc1_.push(RoomWidgetDanceMessage.const_1027);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_947);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1412);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1380);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1371);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_809);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_746);
         _loc1_.push(RoomWidgetStopEffectMessage.const_839);
         ...
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1852);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1205);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_891);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_998);
         _loc1_.push(RoomWidgetMeMenuMessage.const_893);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_755);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1911);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_886);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_862);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1237);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_998:
               ...
               break;
            case RoomWidgetWaveMessage.const_904:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_1027:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_947:
               if(this.var_12 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_1412:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1380:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_746:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1338)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_176,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_809:
               ...
               if(this.var_12 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1957:
                        this._catalog.openCatalogPage(CatalogPageName.const_1253,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1195:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_234);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_2006:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_70);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1752:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1371:
            case RoomWidgetStopEffectMessage.const_839:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1238:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_891:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_893:
            ...
            case RoomWidgetAvatarEditorMessage.const_594:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_755:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_431,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_886:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_431,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_862:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_431,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_1237:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_125:
               ...
               break;
            case HabboHelpTutorialEvent.const_774:
