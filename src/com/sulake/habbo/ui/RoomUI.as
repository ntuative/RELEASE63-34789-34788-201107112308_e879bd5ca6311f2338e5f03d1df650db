package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends ComponentContext implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1197:IRoomWidgetFactory;
      ...
      private var var_1308:IHabboHelp;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1308.release(new IIDHabboHelp());
            this.var_1308 = null;
         }
         ...
         {
            this.var_1054.release(new IIDHabboModeration());
            this.var_1054 = null;
         }
         ...
         if(this.var_1307)
         {
            this.var_1307.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1307 = null;
         }
         this.var_1615 = null;
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1615 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_341.events.addEventListener(InterstitialEvent.const_567,this.interstitialCompleteEventHandler);
            this.var_341.events.addEventListener(InterstitialEvent.const_610,this.adEventHandler);
            this.var_341.events.addEventListener(AdEvent.const_593,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1308 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1054 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_1054);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_211,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_659,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_651,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_591,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_532,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_966,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_914,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_586,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPollEvent.const_169,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPollEvent.const_79,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPollEvent.const_150,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_658,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionFriendRequestEvent.const_143,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserNotificationEvent.const_126,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserDataUpdateEvent.const_140,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDanceEvent.const_144,this.roomSessionEventHandler);
         }
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_77:
               this._toolbar.setToolbarState(HabboToolbarEnum.const_759);
               break;
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_300:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_966:
      ...
      private function interstitialCompleteEventHandler(param1:InterstitialEvent) : void
      {
         ...
         var _loc2_:String = this.getRoomIdentifier(this._interstitialRoomId,this.var_2753);
      ...
      private function onUserDefinedRoomEventsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1307 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_199,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_385,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_633,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_599,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_67,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_900,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_926,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineSoundMachineEvent.const_261,this.roomObjectEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_599 || param1.type == RoomEngineEvent.const_633)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_199:
               _loc5_ = false;
               ...
               _loc3_.disposeWidget(RoomWidgetEnum.const_534);
               ...
               if(!_loc3_.session.isSpectatorMode)
               {
                  ...
                  _loc3_.createWidget(RoomWidgetEnum.const_143);
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_887);
               _loc3_.createWidget(RoomWidgetEnum.const_126);
               _loc3_.createWidget(RoomWidgetEnum.const_630);
               _loc3_.createWidget(RoomWidgetEnum.const_171);
               if(!_loc5_)
               {
                  _loc3_.createWidget(RoomWidgetEnum.const_520);
               }
               _loc3_.createWidget(RoomWidgetEnum.const_349);
               if(this.var_1591 != RoomDesktop.const_518)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_349,this.var_1591);
               }
               if(this.var_341 != null)
               {
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_669);
               break;
            case RoomEngineEvent.const_385:
               this.disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_900:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         if(_loc3_.showInterstitial())
         {
            ...
            this.var_2753 = param1.roomCategory;
         }
         else
         {
            this.var_1592 = false;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_349);
            if(_loc3_ != RoomDesktop.const_518)
            {
