package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1665:int = 250;
      
      private static const const_1666:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1664:String = "${widgets.chatinput.say}";
      ...
      private var var_2107:IWindow;
      
      private var _button:IWindow;
      
      private var var_2108:IWindow;
      
      private var var_1652:IWindow;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1354 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2928 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2927 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_420 = new Timer(1000,1);
         this.var_420.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_484 = new Timer(10000,1);
         this.var_484.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_420.reset();
            this.var_420.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_420 = null;
         }
         if(this.var_484 != null)
         {
            this.var_484.reset();
            this.var_484.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_484 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2107 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_2108 = this._window.findChildByName("send_button_text");
         this.var_1652 = this._window.findChildByName("block_text");
         this.var_2108.caption = const_1664;
         this.var_27.setParamFlag(HabboWindowParam.const_44,true);
         this.var_27.addEventListener(WindowMouseEvent.const_45,this.windowMouseEventProcessor);
         this.var_27.addEventListener(WindowKeyboardEvent.const_192,this.windowKeyEventProcessor);
         this.var_27.addEventListener(WindowKeyboardEvent.const_333,this.keyUpHandler);
         this.var_27.addEventListener(WindowEvent.const_116,this.onInputChanged);
         ...
         this._window.addEventListener(WindowEvent.const_607,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_2107.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1665 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1666);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_27 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1354 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_27.text = "";
                  this.var_720 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_720.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_721);
      ...
      private function sendChatFromInputField(param1:Boolean = false) : void
      {
         ...
         var _loc2_:int = !!param1 ? 0 : int(RoomWidgetChatMessage.const_134);
