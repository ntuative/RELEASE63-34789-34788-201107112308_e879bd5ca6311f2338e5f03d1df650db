package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_408)
         {
            this.var_1481 = param1.songId;
         }
         if(param1.songId == this.var_1481)
         {
            this._songName = param1.songName;
            this.var_2685 = param1.songAuthor;
            this.updateNowPlaying(this.var_1481 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2685;
         }
         else
         {
