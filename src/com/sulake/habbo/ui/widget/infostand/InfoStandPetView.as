package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1654:int = 162;
      
      private static const const_1652:int = 16;
      
      private static const const_723:int = 4;
      
      private static const const_1649:uint = 14342874;
      
      private static const const_1646:uint = 3815994;
      
      private static const const_1651:uint = 2085362;
      
      private static const const_1643:uint = 39616;
      
      private static const const_1655:uint = 10513106;
      
      private static const const_1644:uint = 8734654;
      
      private static const const_1648:uint = 9094430;
      
      private static const const_1653:uint = 6200576;
      
      private static const const_1650:String = "happiness";
      
      private static const const_1645:String = "experience";
      
      private static const const_1647:String = "energy";
      
      private static const const_1642:int = 250;
      
      private static const const_1138:int = 25;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1650,param1.nutrition,param1.nutritionMax,const_1643,const_1651);
         this.updateStateElement(const_1645,param1.experience,param1.experienceMax,const_1644,const_1655);
         this.updateStateElement(const_1647,param1.energy,param1.energyMax,const_1653,const_1648);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1654,const_1652,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1649);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1646);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_549) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_233 && this.var_233.getPetId() == this.var_549)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1768,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_399,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1138 + const_1139;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1139;
            }
         }
         this.var_109.height = _loc4_ + const_1138;
         this.updateWindow();
      }
   }
}
