package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_1855 = param1.id;
         this._type = param1.petType;
         this.var_2342 = param1.petRace;
         this.var_48 = param1.image;
         this.var_2842 = param1.isOwnPet;
         this.var_2695 = param1.ownerId;
         this._ownerName = param1.ownerName;
         this._canOwnerBeKicked = param1.canOwnerBeKicked;
         this.var_1347 = param1.level;
         this.var_2838 = param1.levelMax;
         this.var_2716 = param1.experience;
         this.var_2839 = param1.experienceMax;
         this._energy = param1.energy;
         this.var_2841 = param1.energyMax;
         this._nutrition = param1.nutrition;
         this.var_2843 = param1.nutritionMax;
         this._petRespect = param1.petRespect;
         this.var_2471 = param1.roomIndex;
         this.var_558 = param1.age;
      }
   }
}
