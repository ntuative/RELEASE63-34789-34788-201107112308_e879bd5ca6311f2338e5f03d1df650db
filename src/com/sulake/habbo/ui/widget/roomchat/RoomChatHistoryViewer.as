package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1570:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_200.state = RoomChatHistoryPulldown.const_270;
         ...
         this.var_53 = param2.createWindow("chatscroller","",HabboWindowType.const_1198,HabboWindowStyle.const_47,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_200.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_270);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_200.state == RoomChatHistoryPulldown.const_436 || this.var_200.state == RoomChatHistoryPulldown.const_668;
      }
      ...
      {
         if(!this.var_461 && !this.var_1944)
         {
            this.var_461 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_200.state = RoomChatHistoryPulldown.const_436;
            if(this._widget != null)
            {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_460 > 0 && param2)
         {
            if(this.var_1946)
            {
               if(Math.abs(param1 - this.var_460) <= const_1179)
               {
                  return;
               }
               this.var_1946 = false;
            ...
            if(this.var_461)
            {
               ...
               _loc5_ = (param1 - this.var_460) / this.var_53.height;
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_53.scrollV < 1 - const_1570 / this.var_53.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1947)
               {
