package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1092:String = "use_minimized_own_avatar_menu";
      ...
      private var var_256:AvatarInfoData;
      ...
      private var var_3079:Boolean;
      
      private var var_840:AvatarInfoView;
      
      private var var_841:OwnAvatarMenuView;
      
      private var var_842:AvatarMenuView;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_22 = param6;
         this.var_126 = param4;
         this.var_256 = new AvatarInfoData();
         this.var_2595 = Boolean(this.var_126.getBoolean("menu.avatar.enabled",false));
         this.var_1930 = this.var_126.getBoolean("menu.own_avatar.enabled",false);
         ...
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_447,this.onRoomObjectRemoved);
         this.handler.container.inventory.events.addEventListener(HabboInventoryEffectsEvent.const_275,this.onEffectsChanged);
      ...
      private function onRoomObjectRemoved(param1:RoomEngineObjectEvent) : void
      {
         ...
         if(param1.category == RoomObjectCategoryEnum.const_29)
         {
            for each(_loc2_ in this.var_395)
            {
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_1015,0,0));
      }
      ...
      override public function dispose() : void
      {
         ...
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_447,this.onRoomObjectRemoved);
         this.handler.container.inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_275,this.onEffectsChanged);
         this._view = null;
         this.var_126 = null;
         super.dispose();
      }
      ...
      override public function method_1(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_172,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_321,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomObjectNameEvent.const_616,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_863,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_172,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_321,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomObjectNameEvent.const_616,this.updateEventHandler);
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_137:
               ...
               if(this.var_1930 && _loc2_.allowNameChange)
               {
               ...
               break;
            case RoomWidgetRoomObjectNameEvent.const_616:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_321:
               this.var_1931 = true;
               break;
            ...
            case RoomWidgetFurniInfoUpdateEvent.const_379:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_863:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  this.var_1929 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_930,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_410:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_1929)
                  {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_172:
               ...
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_133,false,!!_loc3_.isSpectatorMode ? null : this.var_256);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_646,false,null);
               break;
            case RoomWidgetPetInfoUpdateEvent.const_111:
               if(this.var_1931)
               {
                  _loc6_ = param1 as RoomWidgetPetInfoUpdateEvent;
                  this.updateView(_loc6_.id,_loc6_.name,_loc6_.roomIndex,RoomObjectTypeEnum.const_233,false,null);
               }
               break;
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_198:
               ...
               for each(_loc7_ in this.var_395)
               {
      ...
      {
         this.var_256.amIAnyRoomController = param1.amIAnyRoomController;
         this.var_256.amIController = param1.amIController;
         this.var_256.amIOwner = param1.amIOwner;
         this.var_256.canBeAskedAsFriend = param1.canBeAskedAsFriend;
         this.var_256.canBeKicked = param1.canBeKicked;
         this.var_256.canTrade = param1.canTrade;
         this.var_256.canTradeReason = param1.canTradeReason;
         this.var_256.hasFlatControl = param1.hasFlatControl;
         this.var_256.isIgnored = param1.isIgnored;
         this.var_256.respectLeft = param1.respectLeft;
         this.var_256.isOwnUser = param1.type == RoomWidgetUserInfoUpdateEvent.const_114;
         this.var_256.allowNameChange = param1.allowNameChange;
      }
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_1930) : Boolean(this.var_2595);
         }
            ...
            if(!this.var_1928)
            {
               if(_loc7_)
               {
                  if(param6.isOwnUser)
                  {
                     if(!this.var_841)
                     {
                        this.var_841 = new OwnAvatarMenuView(this);
                     }
                     this._view = this.var_841;
                  ...
                  else
                  {
                     if(!this.var_842)
                     {
                        this.var_842 = new AvatarMenuView(this);
                     }
                     this._view = this.var_842;
                     AvatarMenuView.setup(this._view as AvatarMenuView,param1,param2,param3,param4,param6);
                     for each(_loc8_ in this.var_395)
                     {
               ...
               else
               {
                  if(!this.var_840)
                  {
                     this.var_840 = new AvatarInfoView(this);
                  }
                  this._view = this.var_840;
      ...
      public function removeView(param1:AvatarInfoView, param2:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_395.remove(param1.userName);
               param1.dispose();
               this.checkUpdateNeed();
            }
         }
      ...
      public function checkUpdateNeed() : void
      {
         ...
         if(this._view || this.var_395.length > 0)
         {
      ...
      {
         return this.handler.container.config.getBoolean(const_1092,true);
      }
      
      public function set useMinimizedOwnAvatarMenu(param1:Boolean) : void
      {
         this.handler.container.config.setKey(const_1092,!!param1 ? "1" : "0");
      }
   }
}
