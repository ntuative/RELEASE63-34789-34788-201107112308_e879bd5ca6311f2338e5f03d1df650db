package com.sulake.habbo.ui.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1478:int = 50;
      ...
      override public function method_1(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_830,this.onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_149,this.onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_830,this.onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_149,this.onDoorbellHandled);
      ...
      public function addUser(param1:String) : void
      {
         ...
         if(this._users.length >= const_1478)
         {
            this.deny(param1);
            return;
         }
