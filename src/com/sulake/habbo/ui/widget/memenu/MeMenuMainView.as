package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         this.var_175["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_175["dance_icon"] = ["dance_white","dance_color"];
         this.var_175["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_175["effects_icon"] = ["effects_white","effects_color"];
         this.var_175["badges_icon"] = ["badges_white","badges_color"];
         this.var_175["wave_icon"] = ["wave_white","wave_color"];
         this.var_175["hc_icon"] = ["_white","_color"];
         this.var_175["settings_icon"] = ["settings_white","settings_color"];
         this.var_175["credits_icon"] = ["credits_white","credits_color"];
         this.var_175["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      {
         if(this.var_175[param1] == null)
         {
            return;
         }
         if(param3 != null)
         {
            this.var_175[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_175[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc4_ in this.var_175)
         {
            _loc7_ = this.var_175[_loc4_];
            if(!(_loc7_ == null || _loc7_.length == 0))
            {
               ...
               switch(_loc4_)
               {
                  ...
                  case "hc_icon":
                     ...
                     {
                        if(this._widget.habboClubLevel == HabboClubLevelEnum.const_42)
                        {
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1209);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1313));
            ...
            case "effects":
               ...
               this._widget.messageListener.processWidgetMessage(new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_463));
               this._widget.hide();
               break;
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1195));
               this._widget.hide();
               break;
            case "clothes":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_594));
               this._widget.hide();
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1338));
               this._widget.hide();
               break;
            case "settings":
               this._widget.changeView(MeMenuWidget.const_901);
               break;
            case "news":
