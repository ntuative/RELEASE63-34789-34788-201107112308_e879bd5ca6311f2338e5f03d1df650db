package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1088:MeMenuSoundSettingsSlider;
      
      private var var_1085:BitmapData;
      ...
      public function updateSettings(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_1088 != null)
         {
            this.var_1088.setValue(this.var_992);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1085 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1087 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1084 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1086 = (_loc5_.content as BitmapData).clone();
         }
         this.var_1088 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_755));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_992 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1086);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1085);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1084);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1087);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_886);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_862);
         }
