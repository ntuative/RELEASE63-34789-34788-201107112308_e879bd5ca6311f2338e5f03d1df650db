package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1374;
         if(this.var_1374 < this.var_1115.length)
         {
            _loc1_ = this.var_1115[this.var_1374] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(this._window != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",this.var_1115.length);
                  _loc2_.text = _loc6_;
               }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_1115[this.var_1374] as Dictionary;
