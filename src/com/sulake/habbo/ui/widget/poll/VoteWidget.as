package com.sulake.habbo.ui.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1673:int = 30000;
      ...
      public function VoteWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1673 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            this.var_65.addListItem(_loc6_);
            _loc7_++;
         }
         var _loc8_:int = Math.max(this.var_65.scrollableRegion.height - this.var_65.height,0);
      ...
      private function createWindow() : Boolean
      {
         ...
         this.var_65 = this._window.findChildByName("choices") as IItemListWindow;
         if(this.var_65 == null)
         {
            return false;
         }
      ...
      private function vote(param1:int = -1) : void
      {
         ...
         if(this._window == null || this.var_65 == null)
         {
            return;
         }
         var _loc4_:int = 0;
         ...
         {
            _loc2_ = this.var_65.getListItemAt(_loc4_) as IBorderWindow;
            if(_loc2_ == null)
            {
               return;
            }
            if(_loc4_ != this.var_2147)
            {
               _loc2_.blend = 0.5;
            }
      ...
      private function updateTimerView() : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1673 - _loc1_) / 1000,0);
      ...
      {
         var _loc2_:int = getTimer() - this.var_2146;
         if(_loc2_ > this.var_1673)
         {
            this.vote();
            return;
         }
      ...
      private function showVoteResult(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         if(this.var_65.numListItems != param1.votes.length)
         {
            return;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this.var_65.numListItems)
         {
            _loc4_ = this.var_65.getListItemAt(_loc3_) as IWindowContainer;
            if(_loc4_ != null)
            {
