package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1828:String = "POLL_OFFER_STATE_OK";
      
      public static const const_911:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_118:String = "POLL_OFFER_STATE_UNKNOWN";
      ...
      {
         if(this._state != const_118)
         {
            return;
         }
         this._state = const_1828;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_877,this._id));
      }
      ...
      private function onCancel(param1:WindowEvent) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_584,this._id));
