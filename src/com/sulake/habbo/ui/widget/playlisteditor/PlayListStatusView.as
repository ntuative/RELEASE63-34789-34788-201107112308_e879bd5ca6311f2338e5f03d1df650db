package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_780:String = "PLSV_ADD_SONGS";
      
      public static const const_1196:String = "PLSV_START_PLAYBACK";
      
      public static const const_563:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_54 != const_563)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_493[this.var_54];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_493[const_780];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_493.add(const_563,_loc1_);
