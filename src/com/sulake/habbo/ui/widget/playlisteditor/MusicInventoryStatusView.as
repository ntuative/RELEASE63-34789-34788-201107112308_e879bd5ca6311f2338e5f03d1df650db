package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_1014:String = "MISV_BUY_MORE";
      
      public static const const_770:String = "MISV_PREVIEW_PLAYING";
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_493.getValues())
         {
            _loc1_.destroy();
         }
         this.var_493 = null;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_493[param1] as IWindowContainer,0);
         this.var_54 = param1;
      }
      ...
      {
         this.blitBackgroundImage(const_770,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_1014,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_493.add(const_770,_loc1_);
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_502));
         ...
         if(_loc1_ != null)
         {
            this.var_493.add(const_1014,_loc1_);
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_493[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
