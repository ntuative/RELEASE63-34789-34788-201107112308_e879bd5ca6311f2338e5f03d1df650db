package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_733:String = "welcome_gift_email_unverified";
      
      private const const_1165:String = "welcome_gift_email_verified";
      
      private const const_1724:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1403)
         {
            this.setViewState(this.const_1165);
         }
         else
         {
            this.setViewState(this.const_733);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_733:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1138;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_1138);
               break;
            case this.const_1165:
            ...
            case this.const_1724:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1138);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1701;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1724);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_972,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1403 ? this.const_1165 : this.const_733);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1700 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1700));
      }
      ...
      override public function method_1(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_973,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_973,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_500:
               this.var_1701 = param1.email;
               this.var_1403 = param1.isVerified;
               this.var_1138 = param1.allowEmailChange;
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1700);
