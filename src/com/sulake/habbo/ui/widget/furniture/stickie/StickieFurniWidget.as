package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1430:int = 14;
      
      private static const const_1431:int = 500;
      
      private static const const_1484:Number = 100;
      
      private static const const_1485:Number = 100;
      ...
      protected var var_2263:String = "stickieui_container";
      ...
      override public function method_1(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetStickieDataUpdateEvent.const_791,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetStickieDataUpdateEvent.const_791,this.onObjectUpdate);
      }
      ...
      protected function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow(this.var_2263,"",HabboWindowType.const_71,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1484,const_1485,2,2),null,0) as IWindowContainer;
         ...
         this.setColorButtons(this.var_26 && this.var_1422 == "post_it");
      }
      ...
      protected function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_643,this.var_237,this._text,this.var_361);
      ...
      protected function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_643,this.var_237,this._text,this.var_361);
      ...
      protected function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_920,this.var_237);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1431;
         if(_loc2_.numLines < const_1430)
         {
            return;
         }
