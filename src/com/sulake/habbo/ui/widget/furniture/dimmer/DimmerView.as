package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1672:XML;
      
      private var _widget:DimmerFurniWidget;
      
      private var var_732:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_71,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1484,const_1485,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_732 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1671 = _loc2_.light;
         if(this.var_496 != null)
         {
            this.var_496.setValue(this.var_1671);
         }
         this.var_531 = this.colors.indexOf(_loc2_.color);
         if(this.var_732 != null)
         {
            this.var_732.setSelectedColorIndex(this.var_531);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1672 = XML(_loc1_.content);
         return this.var_1672;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_732 != null)
         {
            this.var_732.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
