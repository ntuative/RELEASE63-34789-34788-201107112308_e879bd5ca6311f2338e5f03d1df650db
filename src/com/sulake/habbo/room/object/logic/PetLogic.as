package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_156,RoomObjectMoveEvent.const_453];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2823)
         {
            ...
            if(param1 is RoomObjectAvatarUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_225,_loc4_.dirHead);
               return;
            }
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1617 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_287,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_416,Number(_loc9_.gainedExperience));
            return;
         }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_225,_loc3_ + this.var_1070);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_2051;
            _loc2_.setNumber(RoomObjectVariableEnum.const_294,this.var_2051);
            _loc2_.setNumber(RoomObjectVariableEnum.const_168,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_2052;
            _loc2_.setNumber(RoomObjectVariableEnum.const_168,this.var_2052);
         }
         else
         {
            this.var_1070 += 45;
