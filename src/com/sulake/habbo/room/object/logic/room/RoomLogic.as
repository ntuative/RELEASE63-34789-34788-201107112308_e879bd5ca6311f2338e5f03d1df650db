package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1932:int = 255;
      
      private var var_1554:uint = 16777215;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_661,RoomObjectMouseEvent.const_156];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_838,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_832,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_913,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1003,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_990,1);
         }
      }
         ...
         if(this.var_1553)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_838,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1187,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1272)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1932;
            if(_loc2_ - this.var_1272 >= this.var_1935)
            {
               _loc3_ = this.var_1271;
               _loc4_ = this.var_1933;
               this.var_1272 = 0;
            }
            else
            {
               _loc7_ = this.var_1554 >> 16 & 255;
               _loc8_ = this.var_1554 >> 8 & 255;
               _loc9_ = this.var_1554 & 255;
               _loc10_ = this.var_1271 >> 16 & 255;
               _loc11_ = this.var_1271 >> 8 & 255;
               _loc12_ = this.var_1271 & 255;
               _loc13_ = (_loc2_ - this.var_1272) / this.var_1935;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1934 + (this.var_1933 - this.var_1934) * _loc13_;
               this._color = _loc3_;
               this.var_1932 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_832,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_875:
               param2.setString(RoomObjectVariableEnum.const_230,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_897:
               param2.setString(RoomObjectVariableEnum.const_215,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_764:
               param2.setString(RoomObjectVariableEnum.const_235,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_628:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_309)
               {
                  _loc5_ = "null";
               }
               this.var_518.addMask(param1.maskId,param1.method_14,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_964:
               _loc4_ = this.var_518.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_518.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1370,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1235:
               param2.setNumber(RoomObjectVariableEnum.const_913,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1247:
               param2.setNumber(RoomObjectVariableEnum.const_1003,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_990,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_717:
               param2.setNumber(RoomObjectVariableEnum.const_1172,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1382:
               param2.setNumber(RoomObjectVariableEnum.const_1182,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_177:
               ...
               this.var_1553 = true;
               break;
            case RoomObjectRoomFloorHoleUpdateMessage.const_175:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1348,int(param1.bgOnly));
         this.var_1554 = this._color;
         this.var_1934 = this.var_1932;
         this.var_1271 = _loc3_;
         this.var_1933 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_603,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_2004,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1732,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1997,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_603,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_266 || _loc12_ == RoomPlaneData.const_421)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
