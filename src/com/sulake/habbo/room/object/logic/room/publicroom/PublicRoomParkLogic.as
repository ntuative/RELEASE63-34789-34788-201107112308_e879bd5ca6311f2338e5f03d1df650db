package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1632:String = "goawaybus";
      
      private static const const_1631:String = "bus";
      
      private static const const_1633:String = "bus_oviopen_hidden";
      ...
      {
         var _loc1_:Array = [RoomObjectRoomActionEvent.const_587,RoomObjectRoomActionEvent.const_503];
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               switch(_loc3_.spriteTag)
               {
                  ...
                  case const_1631:
                  case const_1633:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_503,0,_loc4_,_loc5_);
               }
         }
