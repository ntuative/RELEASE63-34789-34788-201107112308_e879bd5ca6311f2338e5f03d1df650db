package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_810 != _loc2_)
         {
            _loc3_ = this.var_810 - _loc2_;
            if(_loc3_ < 0)
            {
               _loc3_ = -_loc3_;
            }
            if(_loc3_ * const_477 > const_1077)
            {
               this.var_1018 = const_1077 / _loc3_;
            }
            else
            {
               this.var_1018 = const_477;
            }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_810 && param1 >= this.var_1512 + this.var_1018)
            {
               ...
               if(_loc4_ > _loc5_ * (this.var_810 - _loc2_))
               {
                  _loc4_ = _loc5_ * (this.var_810 - _loc2_);
               }
               object.setState(_loc2_ + _loc5_ * _loc4_,0);
               this.var_1512 = param1 - (_loc3_ - _loc4_ * this.var_1018);
            }
         }
      }
   }
