package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureRoomBrandingLogic extends FurnitureLogic
   {
      ...
      public static const const_1974:String = "state";
      
      public static const const_1377:String = "imageUrl";
      
      public static const const_1224:String = "clickUrl";
      
      public static const const_1314:String = "offsetX";
      
      public static const const_1349:String = "offsetY";
      
      public static const const_1176:String = "offsetZ";
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(this.var_3063)
         {
            object.getModelController().setNumber(RoomObjectVariableEnum.const_1336,1);
         }
      }
      
      override public function getEventTypes() : Array
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_597];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1 is RoomObjectRoomAdUpdateMessage)
         {
            ...
            switch(_loc2_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1317:
                  object.getModelController().setNumber(RoomObjectVariableEnum.const_561,1,false);
                  break;
               case RoomObjectRoomAdUpdateMessage.const_1389:
                  object.getModelController().setNumber(RoomObjectVariableEnum.const_561,-1);
      ...
      private function setupImageFromFurnitureData() : Boolean
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != null)
            {
                     ...
                     switch(_loc12_)
                     {
                        ...
                        case const_1377:
                           ...
                           if(_loc15_ == null || _loc15_ != _loc13_)
                           {
                              ...
                              object.getModelController().setNumber(RoomObjectVariableEnum.const_561,0,false);
                              _loc1_ = true;
                           }
                           break;
                        case const_1224:
                           ...
                           break;
                        case const_1314:
                           _loc1_ = this.updateOffset(RoomObjectVariableEnum.const_656,object.getModelController().getNumber(RoomObjectVariableEnum.const_656),parseInt(_loc13_));
                           break;
                        case const_1349:
               ...
               _loc6_ = object.getModelController().getNumber(RoomObjectVariableEnum.const_656);
               _loc7_ = object.getModelController().getNumber(RoomObjectVariableEnum.const_673);
               _loc8_ = object.getModelController().getNumber(RoomObjectVariableEnum.const_507);
               if(_loc4_ != null)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_597,object.getId(),object.getType(),_loc4_,_loc5_));
               }
               _loc9_ = const_1377 + "=" + (_loc4_ != null ? _loc4_ : "") + "\t";
               if(this.var_1713)
               {
                  _loc9_ += const_1224 + "=" + (_loc5_ != null ? _loc5_ : "") + "\t";
               }
               _loc9_ += const_1314 + "=" + _loc6_ + "\t";
               _loc9_ += const_1349 + "=" + _loc7_ + "\t";
               _loc9_ += const_1176 + "=" + _loc8_ + "\t";
               object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_444,RoomWidgetInfostandExtraParamEnum.const_1192 + _loc9_);
            }
         }
         return _loc1_;
      }
