package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_675,RoomObjectFurnitureActionEvent.const_677,RoomObjectFurnitureActionEvent.const_558,RoomObjectFurnitureActionEvent.const_522];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != this.var_1211)
         {
            this.var_1211 = _loc3_;
            if(_loc3_ == 1)
            {
      ...
      private function requestStopPlaying() : void
      {
         ...
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_677,object.getId(),object.getType());
         eventDispatcher.dispatchEvent(_loc1_);
      }
