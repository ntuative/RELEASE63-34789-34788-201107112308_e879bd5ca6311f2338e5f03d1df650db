package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_632,RoomObjectFurnitureActionEvent.const_546,RoomObjectFurnitureActionEvent.const_589,RoomObjectFurnitureActionEvent.const_635,RoomObjectWidgetRequestEvent.const_170];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_890) == 1)
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_444,RoomWidgetInfostandExtraParamEnum.const_629);
      ...
      private function requestInit() : void
      {
         ...
         this.var_1862 = true;
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_635,object.getId(),object.getType());
