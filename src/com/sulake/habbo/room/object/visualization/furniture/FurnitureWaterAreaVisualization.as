package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1538:String = "shore";
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1258)
            {
      ...
      {
         if(this.var_2545 == param1 && this.var_2546 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1538)
            {
               this.var_1905 = _loc2_;
               this.var_2545 = param1;
               this.var_2546 = direction;
               return this.var_1905;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1258.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1904 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_456.length)
         {
            if(this.var_456[_loc5_] == true)
            {
               this.var_1904 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_660[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_660[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_540 == 0 || this.var_661 == 0)
         {
            ...
            this.var_540 = _loc2_.getNumber(RoomObjectVariableEnum.const_277);
            this.var_661 = _loc2_.getNumber(RoomObjectVariableEnum.const_334);
         }
         this.var_456 = [];
         this.var_660 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_540 * 2 + this.var_661 * 2)
         {
            this.var_456.push(false);
            this.var_660.push(ShoreMaskCreatorUtility.const_86);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_79,getSize(param3),this.var_456,this.var_660,assetCollection);
      }
