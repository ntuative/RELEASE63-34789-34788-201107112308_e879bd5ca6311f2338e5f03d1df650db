package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1924:String = "cone";
      
      public static const const_1895:String = "plane";
      
      public static const const_1906:String = "sphere";
      ...
      private var var_1025:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_1026 = 0;
         this.var_1123 = false;
         this.init(0,0,0,this._direction,this.var_2562,this.var_1025,this.var_2558,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1262.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_1123 = true;
         if(this.var_1026 < this.var_1546)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2557)
         {
            switch(this.var_2560)
            {
               case const_1924:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_1025,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_391.push(_loc4_);
            ++this.var_1026;
            _loc10_++;
         }
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1026 < this.var_1546)
         {
            if(this.age % this.var_2559 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1026 < this.var_1546)
         {
            ...
            this.y = (2 - this.var_285) * this.y - (1 - this.var_285) * this.lastY + this.var_1916 * this.var_1025 * this.var_1025;
         ...
         for each(_loc2_ in this.var_391)
         {
            ...
            _loc2_.y = (2 - this.var_285) * _loc2_.y - (1 - this.var_285) * _loc2_.lastY + this.var_1916 * this.var_1025 * this.var_1025;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_391.splice(this.var_391.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
