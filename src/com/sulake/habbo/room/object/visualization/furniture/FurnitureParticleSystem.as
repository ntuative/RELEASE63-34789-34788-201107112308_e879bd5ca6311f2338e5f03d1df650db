package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_308:IRoomObjectSprite;
      ...
      private var var_1679:ColorTransform;
      
      private var var_2155:Matrix;
      ...
      {
         super();
         this.var_1382 = new Dictionary();
         this._visualization = param1;
         this.var_912 = new ColorTransform();
         this.var_912.alphaMultiplier = 1;
         this.var_1679 = new ColorTransform();
         this.var_2155 = new Matrix();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_117 = this.var_1382[param1];
         this.var_1123 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_2156 >= 0)
         {
            this.var_308 = this._visualization.getSprite(this.var_2156);
            if(this.var_308 && this.var_308.asset)
            {
               if(this.var_308.width <= 1 || this.var_308.height <= 1)
               {
                  return;
               }
               if(this.var_101 == null)
               {
                  this.var_101 = this.var_308.asset.clone();
                  if(this.var_912.alphaMultiplier != 1)
                  {
                     this.var_736 = new BitmapData(this.var_101.width,this.var_101.height,true,4278190080);
                  }
               }
               this.var_2300 = -this.var_308.offsetX;
               this.var_2301 = -this.var_308.offsetY;
               this.var_308.asset = this.var_101;
            }
            if(this.var_101)
            {
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_117.y * this.var_1381;
         }
         return 0;
      }
      ...
      {
         if(!this.var_117 || !this.var_308)
         {
            return;
         }
         if(this.var_101 && this.var_308.asset != this.var_101)
         {
            this.var_308.asset = this.var_101;
         }
         if(this.var_1123)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_1123 && this.var_117.hasIgnited)
         {
            this.var_1123 = true;
         }
         _loc8_ = this.var_1239 * this.var_1381;
         this.var_117.update();
         if(this.var_1123)
         {
            if(this.var_117.roomObjectSpriteId >= 0)
            ...
            {
               this.var_101.draw(this.var_736,this.var_2155,this.var_912,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_117.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2300 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1381;
               _loc4_ = this.var_2301 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1381;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1679.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_101.draw(_loc7_,this._translationMatrix,this.var_1679,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function parseData(param1:XML) : void
      {
         ...
         this.var_2156 = !!param1.hasOwnProperty("@canvas_id") ? int(parseInt(param1.@canvas_id)) : -1;
         this.var_1239 = !!param1.hasOwnProperty("@offset_y") ? int(parseInt(param1.@offset_y)) : 10;
         this.var_1381 = this.var_2991 / 64;
         this._blend = !!param1.hasOwnProperty("@blend") ? Number(Number(param1.@blend)) : Number(1);
         this._blend = Math.min(this._blend,1);
         this.var_912.alphaMultiplier = this._blend;
