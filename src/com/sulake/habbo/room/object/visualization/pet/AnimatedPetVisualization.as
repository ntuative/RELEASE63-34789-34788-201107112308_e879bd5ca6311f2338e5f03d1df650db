package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1658:String = "head";
      
      private static const const_724:int = 1;
      
      private static const const_1140:int = 1000;
      
      private static const const_1657:String = "pet_experience_bubble_png";
      
      private static const const_1659:int = 0;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1657) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_419 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_147)
         {
            ...
            this.var_1909 = _loc3_.getNumber(RoomObjectVariableEnum.const_287) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_225);
            if(!isNaN(_loc8_))
            {
               this.var_2102 = _loc8_;
            }
            else
            {
               this.var_2102 = direction;
            }
            this.var_1581 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2716 = _loc3_.getNumber(RoomObjectVariableEnum.const_416);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_899);
            if(_loc9_ != this.var_2103)
            {
               this.var_2103 = _loc9_;
               this.var_2925 = this.var_2103.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_419 != null)
         {
            ...
            if(this.var_1581 > 0)
            {
               _loc2_ = param1 - this.var_1581;
               if(_loc2_ < const_1140)
               {
                  this.var_419.alpha = int(Math.sin(_loc2_ / const_1140 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_419.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_419.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_724;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_724)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_724))
            {
               if(param2 >= FurnitureVisualizationData.const_647.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_647[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2102);
         }
         return direction;
      }
      ...
      {
         if(this.var_1097[param1] == null)
         {
            if(this._animationData.getTag(var_103,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1658)
            {
               this.var_1097[param1] = true;
            }
            else
            {
               this.var_1097[param1] = false;
            }
         }
