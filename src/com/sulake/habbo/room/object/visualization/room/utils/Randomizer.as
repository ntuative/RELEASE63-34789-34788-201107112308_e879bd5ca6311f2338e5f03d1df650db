package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2315:int = 1;
      
      public static const const_2171:int = 16777216;
      ...
      private var var_1964:int = 16777216;
      
      private var var_3083:int = 69069;
      
      private var var_3084:int = 5;
      ...
      {
         var _loc1_:int = this.var_3083 * this.var_1963 + this.var_3084;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1964;
         this.var_1963 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1964 * param2);
      }
   }
}
