package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1784:int = 16777215;
      
      public static const const_1754:int = 13421772;
      
      private static const const_1045:int = 16777215;
      
      private static const const_1047:int = 13421772;
      
      private static const const_1044:int = 10066329;
      
      private static const const_1046:int = 10066329;
      
      public static const const_1891:int = 16777215;
      
      public static const const_1771:int = 13421772;
      
      public static const const_1970:int = 10066329;
      ...
      private var var_760:Rectangle = null;
      
      private var var_518:RoomPlaneBitmapMaskParser = null;
      
      private var var_1531:String = null;
      
      private var _floorType:String = null;
      
      private var var_1532:String = null;
      
      private var var_1075:Number = NaN;
      
      private var var_1437:Number = NaN;
      
      private var var_2290:Number = NaN;
      
      private var var_1726:String = null;
      
      private var var_1158:uint = 16777215;
      
      private var var_2288:int = 255;
      
      private var var_2289:int = 255;
      
      private var var_2286:int = 255;
      
      private var var_1723:Boolean = true;
      
      private var var_1159:int = 0;
      
      private var _lastUpdateTime:int = -1000;
      
      private const const_2342:int = 250;
      
      private var var_1725:int = -1;
      
      private var var_1510:Number = 0.0;
      
      private var var_2285:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_518 = new RoomPlaneBitmapMaskParser();
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_760 = super.boundingRectangle;
         }
         return new Rectangle(this.var_760.x,this.var_760.y,this.var_760.width,this.var_760.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1075))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1075;
         }
         if(!isNaN(this.var_1437))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1437;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_838);
         ...
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_421)
            {
               ...
               {
                  _loc13_.color = const_1771;
               }
               else
               {
                  _loc13_.color = const_1970;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_2039)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_76,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2342 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_369.length)
            {
               _loc11_ = this.var_615[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_369[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1723)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2286 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2289 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2288 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1725)
         {
            this.var_1725 = param1.updateId;
            this.var_760 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1510 || _loc3_.y != this.var_2285 || _loc3_.z != this.var_2287 || param1.scale != this.var_1724))
            {
               this.var_1510 = _loc3_.x;
               this.var_2285 = _loc3_.y;
               this.var_2287 = _loc3_.z;
               this.var_1724 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1370);
            if(_loc3_ != this.var_1726)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1726 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_832));
            if(_loc4_ != this.var_1158)
            {
               this.var_1158 = _loc4_;
               this.var_2286 = this.var_1158 & 255;
               this.var_2289 = this.var_1158 >> 8 & 255;
               this.var_2288 = this.var_1158 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1348));
            if(_loc5_ != this.var_1723)
            {
               this.var_1723 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            ...
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_235);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_913));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1003));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_990));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1172);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1182);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1075 || _loc3_ != this.var_1437))
            {
               this.var_1075 = _loc2_;
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1187);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2290)
            {
               this.var_2290 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_369;
         if(this.var_369.length == 0)
         {
            _loc6_ = this.var_151;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_369.length > 0;
         var _loc9_:int = 0;
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1159;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_518.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_518.maskCount)
         {
            _loc10_ = this.var_518.getMaskType(_loc8_);
            _loc11_ = this.var_518.getMaskLocation(_loc8_);
            _loc12_ = this.var_518.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_76 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_309)
                              {
