package com.sulake.habbo.room.object.visualization.room.publicroom
{
   ...
   public class PublicRoomVisualization extends RoomVisualization
   {
      ...
      {
         createSprites(this.var_1431 + param1);
      }
      ...
      private function initializeLayout(param1:IRoomGeometry) : void
      {
         ...
         if(this.data != null)
         {
            this.var_1431 = spriteCount;
            _loc2_ = object.getModel();
            _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_1199);
            ...
            {
               this.data.layoutRasterizer.setElementToSprite(_loc4_,getSprite(_loc4_ + this.var_1431));
               _loc4_++;
            }
            this.data.layoutRasterizer.initializeAds(this.var_1431,this);
         }
         this.var_3034 = true;
      }
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc7_:String = _loc6_.getString(RoomObjectVariableEnum.const_404);
         var _loc8_:* = !Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_642));
