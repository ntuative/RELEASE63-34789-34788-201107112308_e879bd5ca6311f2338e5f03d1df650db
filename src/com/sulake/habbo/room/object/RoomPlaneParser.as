package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_717:Number = 0.25;
      
      private static const const_1382:Number = 0.25;
      ...
      private var var_1624:Number = 0.0;
      
      private var var_1437:Number = 1.0;
      
      private var var_1075:Number = 1.0;
      
      private var var_947:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            this.var_573.push(_loc6_);
            _loc3_++;
         }
         this.var_229 = param1;
         this._height = param2;
         this._minX = this.var_229;
         this.var_480 = -1;
         this.var_479 = this._height;
         this.var_478 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         var _loc8_:int = 0;
         if(param1 >= 0 && param1 < this.var_229 && param2 >= 0 && param2 < this._height)
         {
            ...
            if(param3 >= 0)
            {
               ...
               if(param1 > this.var_480)
               {
                  this.var_480 = param1;
               }
               if(param2 < this.var_479)
               {
                  this.var_479 = param2;
               }
            ...
            {
               if(param1 == this._minX || param1 == this.var_480)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_479;
                  while(_loc6_ < this.var_478)
                  {
               ...
               if(param2 == this.var_479 || param2 == this.var_478)
               {
                  _loc7_ = false;
                  _loc8_ = this._minX;
                  while(_loc8_ < this.var_480)
                  {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         while(_loc3_ < this._height)
         {
            ...
            while(_loc2_ < this.var_229)
            {
               if(this.var_573[_loc3_][_loc2_])
               {
                  this.var_124[_loc3_][_loc2_] = const_113;
               }
               _loc2_++;
            }
            _loc3_++;
      ...
      private function initialize(param1:Point, param2:Boolean) : Boolean
      {
         ...
         this.var_947 = getFloorHeight(this.var_124);
         if(!param2)
         {
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         var _loc8_:Number = const_1382 * this.var_1437;
         var _loc9_:Number = const_717 * this.var_1075;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number, param12:Boolean, param13:Boolean) : void
      {
         ...
         if(_loc14_)
         {
            _loc18_ = const_717 * this.var_1075;
            _loc19_ = _loc18_;
            if(this.var_1075 > 1)
            {
               _loc19_ = const_717;
      ...
      public function getXML() : XML
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_229}" height="{this._height}" wallHeight="{this.var_1624}"/>;
         var _loc2_:int = 0;
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_346.length)
         {
            _loc12_ = this.var_346.getWithIndex(_loc4_);
            if(_loc12_ != null)
            {
               _loc13_ = this.var_346.getKey(_loc4_);
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1212;
         }
         var _loc2_:RoomPlaneData = this.var_151[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function addFloorHole(param1:int, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         this.var_346.add(param1,_loc6_);
      }
      
      public function removeFloorHole(param1:int) : void
      {
         this.var_346.remove(param1);
      }
      ...
      private function initializeHoleMap() : void
      {
         ...
         while(_loc4_ < this.var_346.length)
         {
            _loc5_ = this.var_346.getWithIndex(_loc4_);
            if(_loc5_ != null)
            {
               _loc6_ = _loc5_.x;
               ...
               _loc7_ = _loc7_ >= this.var_229 ? int(this.var_229 - 1) : int(_loc7_);
