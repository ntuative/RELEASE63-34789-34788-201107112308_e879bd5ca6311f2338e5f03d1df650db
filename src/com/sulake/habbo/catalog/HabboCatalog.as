package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private var var_1119:IAvatarRenderManager;
      ...
      private var var_241:ICatalogNavigator;
      
      private var var_110:Purse;
      
      private var var_104:RecyclerLogic;
      
      private var var_152:IMarketPlace;
      ...
      private var var_946:int = -1;
      
      private var var_1740:int = -1;
      
      private var var_2312:Boolean = true;
      
      private var var_2310:Boolean = true;
      
      private var var_1739:Boolean = false;
      
      private var var_2311:GiftWrappingConfiguration;
      
      private var var_1167:ClubGiftController;
      
      private var var_520:ClubBuyController;
      
      private var var_616:ClubExtendController;
      
      private var var_765:Map;
      
      private var var_1168:Boolean = false;
      
      private var var_764:IPurchasableOffer;
      
      private var var_1443:IDragAndDropDoneReceiver;
      ...
      private var var_617:RoomPreviewer;
      
      private const const_2065:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1119)
         {
            this.var_1119.release(new IIDAvatarRenderManager());
            this.var_1119 = null;
         }
         if(this.var_126)
         {
            this.var_126.release(new IIDHabboConfigurationManager());
            this.var_126 = null;
         }
         if(this._friendList)
         {
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1870);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_371.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      {
         this.var_126 = param2 as IHabboConfigurationManager;
         this.var_2313 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_371.loadProductData(this);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1119 = param2 as IAvatarRenderManager;
      }
      
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this._roomEngine = param2 as IRoomEngine;
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_154,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      {
         if(this._roomEngine != null && this.var_126 != null && this.var_126.getKey("catalog.furniture.animation","false") == "true")
         {
            if(this.var_617 == null)
            {
               this.var_617 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      {
         return this.var_126.getBoolean("toolbar.new_additions.notification.enabled",false);
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_864 || !this.var_241 || !this.var_241.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_946 = -1;
            this.var_763 = param1;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_241.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_126.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_126.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_371.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_371.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_65)
         {
            _loc3_ = this.var_371.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_765.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_241 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         if(this.var_126.getBoolean("catalog.show.purse",false))
         {
         ...
         this._mainContainer.position = this.const_2065;
         this.hideMainWindow();
         ...
         _loc4_.setParamFlag(WindowParam.const_262,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_77:
               this.var_1739 = param1.session.isPrivateRoom;
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_152 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1167 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_616 == null)
         {
            this.var_616 = new ClubExtendController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1442 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_241.buildCatalogIndex(_loc2_);
         if(this.var_763 && this.var_763 != "")
         {
            this.var_241.openPage(this.var_763);
            this.var_763 = "";
            this.var_946 = -1;
         }
         else if(this.var_946 > -1)
         {
            this.var_241.openPageById(this.var_946,this.var_1740);
            this.var_946 = -1;
            this.var_1740 = -1;
            this.var_763 = "";
         }
         else if(this.var_1442 && this.var_2313)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_241.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1837));
         }
         else
         {
            this.var_241.loadFrontPage();
         }
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2312 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1304);
         }
         this.var_2312 = false;
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_123,this.var_110.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2310 && this._soundManager != null)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_336,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_940)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_362,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_336,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_362,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_110.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1261 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1167.setInfo(_loc2_.method_5,_loc2_.method_2,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_152 != null)
         {
            this.var_152.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_152 != null)
         {
            this.var_152.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_152 != null)
         {
            this.var_152.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2311 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_152.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      {
         if(this.var_616 != null && this.var_126.getBoolean("club.membership.extend.promotion.enabled",false))
         {
            this.var_616.onOffer(param1);
         }
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_765.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_765.add(_loc2_.productCode,_loc3_.slice());
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_126.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_126.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_148)
         {
            _loc3_ = this.var_126.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_126.keyExists("catalog.drag_and_drop") || this.var_126.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         ...
         switch(_loc2_.productType)
         {
            case ProductTypeEnum.const_196:
               _loc3_ = false;
               break;
            case ProductTypeEnum.const_331:
               _loc3_ = false;
         }
         return _loc3_;
      }
      ...
      private function updateRoom(param1:String, param2:String) : void
      {
         ...
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_230);
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_235);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1168 && param1.type == RoomEngineObjectEvent.const_154)
         {
            this.resetPlacedOfferData(true);
            if(this.var_764 == null || this.var_764.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_764.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_62 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_764);
            _loc5_ = this.var_1443;
            if(_loc5_ != null)
            {
            ...
            if(this.var_62.roomCategory == this._roomEngine.activeRoomCategory && this.var_62.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  case FurniCategory.const_359:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_230);
                     ...
                     break;
                  case FurniCategory.const_344:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_215);
                  ...
                  case FurniCategory.const_326:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_235);
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_126.getKey("image.library.catalogue.url");
      ...
      public function update(param1:uint) : void
      {
         if(this.var_617 != null)
         {
            this.var_617.updatePreviewRoomView();
         }
      }
   }
}
