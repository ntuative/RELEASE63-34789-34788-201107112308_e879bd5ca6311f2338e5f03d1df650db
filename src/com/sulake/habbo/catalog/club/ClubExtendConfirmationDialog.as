package com.sulake.habbo.catalog.club
{
   ...
   public class ClubExtendConfirmationDialog
   {
      ...
      private static const const_1590:String = "your_price_icon";
      
      private static const const_1593:String = "http://images.habbo.com/c_images/catalogue/vip_extend_tsr.png";
      
      private static const const_1591:String = "image/png";
      
      private static const const_1592:int = 2000;
      
      private static const const_1589:int = 75;
      ...
      private var var_678:IRegionWindow;
      
      private var var_677:ITextWindow;
      
      private var var_401:IBitmapWrapperWindow;
      
      private var var_680:Vector.<BitmapData>;
      
      private var var_852:Timer;
      ...
      public function ClubExtendConfirmationDialog(param1:ClubExtendController, param2:ClubOfferExtendData)
      {
         ...
         this.var_26 = param1;
         this.var_107 = param2;
         this.var_680 = new Vector.<BitmapData>(const_390);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_678)
         {
            this.var_678.removeEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
            this.var_678.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
            this.var_678 = null;
         }
         if(this.var_677)
         {
         ...
         if(this.var_680)
         {
            ...
            {
               this.var_680[_loc1_].dispose();
               this.var_680[_loc1_] = null;
               _loc1_++;
            }
            this.var_680 = null;
         }
      ...
      public function showConfirmation() : void
      {
         ...
         this.var_678 = this._view.findChildByName("maybe_later_region") as IRegionWindow;
         this.var_677 = this._view.findChildByName("maybe_later_link") as ITextWindow;
         if(!this.var_678 || !this.var_677)
         {
            return;
         }
         this.var_678.addEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
         this.var_678.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
         ...
         _loc4_.height = 144;
         _loc4_.width = 133;
         this.loadAssetFromUrl("club_teaser","club_teaser",const_1593,const_1591,this.onTeaserLoaded);
         ...
         this.var_401 = this._view.findChildByName(const_1590) as IBitmapWrapperWindow;
         ...
         while(_loc8_ < const_390)
         {
            ...
            this.var_680[_loc8_] = _loc10_.clone();
            _loc8_++;
         }
         this.startAnimation();
      }
      ...
      private function onMouseOutLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_677)
         {
            this.var_677.textColor = const_2057;
         }
      }
      ...
      private function onMouseOverLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_677)
         {
            this.var_677.textColor = LINK_COLOR_HOVER;
         }
      }
      ...
      private function startAnimation() : void
      {
         ...
         this.var_852 = new Timer(const_1592);
         this.var_852.addEventListener(TimerEvent.TIMER,this.onAnimationTrigger);
         this.var_852.start();
      }
      ...
      private function setAnimationFrame() : void
      {
         ...
         if(this.var_679 < const_390)
         {
            this.var_401.bitmap = new BitmapData(this.var_401.width,this.var_401.height,true,0);
            this.var_401.bitmap.copyPixels(this.var_680[this.var_679],this.var_680[this.var_679].rect,new Point(0,0));
         }
         else
         {
            Logger.log("Animation frame " + this.var_679);
         }
      }
      
      private function startAnimationFrame() : void
      {
         this.var_465 = new Timer(const_1589,const_390 - 1);
         this.var_465.addEventListener(TimerEvent.TIMER,this.onAnimationFrame);
         this.var_465.addEventListener(TimerEvent.TIMER_COMPLETE,this.onAnimationFrameComplete);
         this.var_465.start();
      }
