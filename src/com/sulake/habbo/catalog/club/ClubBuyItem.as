package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyItem
   {
      ...
      public function ClubBuyItem(param1:ClubBuyOfferData, param2:ICatalogPage)
      {
         ...
         this._window = this.var_261.viewer.catalog.windowManager.buildFromXML(_loc3_) as IWindowContainer;
      ...
      {
         var _loc2_:ClubBuyController = (this.var_261.viewer.catalog as HabboCatalog).getClubBuyController();
         (this.var_261.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_107,this.var_261.pageId);
      }
      
      private function getAssetXML(param1:String) : XML
      {
         if(!this.var_261 || !this.var_261.viewer || !this.var_261.viewer.catalog || !this.var_261.viewer.catalog.assets)
         {
            return null;
         }
         var _loc2_:XmlAsset = this.var_261.viewer.catalog.assets.getAssetByName(param1) as XmlAsset;
         if(_loc2_ == null)
         {
            return null;
         }
