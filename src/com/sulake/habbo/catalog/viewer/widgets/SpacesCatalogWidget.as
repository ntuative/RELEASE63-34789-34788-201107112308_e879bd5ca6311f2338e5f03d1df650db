package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1531:String = "default";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1010 = this.parseElements(_loc2_.floors.pattern);
         this.var_1247 = this.parseElements(_loc2_.walls.pattern);
         this.var_1248 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_1010)
                  {
                     _loc11_ = this.var_1010[_loc10_];
                     if(this.var_657.indexOf(_loc10_) == -1)
                     {
                        this.var_657.push(_loc10_);
                        this.var_1246.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
                  if(this.var_1247[_loc8_] != null)
                  {
                  ...
                  break;
               case "landscape":
                  if(this.var_1248[_loc8_] != null)
                  {
                     this.var_818.push(_loc8_);
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1531,this.var_1532,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1249[this.var_450];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1531);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1246[this.var_447];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this._landscapeOffers[this.var_452];
               if(_loc3_ != null)
               {
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_657[this.var_447];
         var _loc3_:Array = this.var_1010[_loc2_];
         ...
         var _loc4_:Offer = this.var_1246[this.var_447];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_817[this.var_450];
         var _loc6_:Array = this.var_1247[_loc5_];
         if(_loc6_ != null && this.var_448 >= 0)
         {
            _loc13_ = _loc6_[this.var_448];
            if(_loc13_ != null)
            {
               this.var_1531 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1249[this.var_450];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_818[this.var_452];
         var _loc9_:Array = this.var_1248[_loc8_];
         if(_loc9_ != null && this.var_451 >= 0)
         {
            _loc15_ = _loc9_[this.var_451];
            if(_loc15_ != null)
            {
               this.var_1532 = _loc15_;
            }
         }
         var _loc10_:Offer = this._landscapeOffers[this.var_452];
         if(_loc10_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_108:
               ...
               if(this.var_447 < 0)
               {
                  this.var_447 = this.var_657.length - 1;
               }
               if(this.var_447 >= this.var_657.length)
               {
                  this.var_447 = 0;
               }
               this.var_449 = 0;
               this.var_1012 = 0;
               _loc5_ = this.var_657[this.var_447];
               _loc6_ = this.var_1010[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_1012 = _loc6_.length;
               }
            ...
            case const_244:
               ...
               if(this.var_450 < 0)
               {
                  this.var_450 = this.var_817.length - 1;
               }
               if(this.var_450 == this.var_817.length)
               {
                  this.var_450 = 0;
               }
               this.var_448 = 0;
               this.var_1013 = 0;
               _loc7_ = this.var_817[this.var_450];
               _loc8_ = this.var_1247[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_1013 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_452 < 0)
               {
                  this.var_452 = this.var_818.length - 1;
               }
               if(this.var_452 >= this.var_818.length)
               {
                  this.var_452 = 0;
               }
               this.var_451 = 0;
               this.var_1011 = 0;
               _loc9_ = this.var_818[this.var_452];
               _loc10_ = this.var_1248[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_1011 = _loc10_.length;
               }
