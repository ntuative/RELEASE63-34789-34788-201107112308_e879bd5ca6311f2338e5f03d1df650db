package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2066:int = 1;
      
      private const const_2067:int = 2;
      
      private const const_2347:int = 40;
      
      private const const_2346:int = 10;
      
      private var var_772:Array;
      
      private var var_1452:MarketPlaceOfferData;
      
      private var _itemList:IItemListWindow;
      
      private var var_620:IWindowContainer;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_522)
         {
            this.var_522.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_522 = null;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_620)
         {
            ...
            this.var_620 = _loc5_.buildFromXML(_loc4_) as IWindowContainer;
         }
         if(!this.var_620)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_2067,_loc3_.length,_loc2_);
         if(!this.var_522)
         {
            this.var_522 = new Timer(25);
            this.var_522.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1190 = 0;
         this.populateList();
         this.var_522.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1190 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1190));
            ++this.var_1190;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_620 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_620.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_2066);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1452.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_48)
