package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function updateInfo() : void
      {
         ...
         if(this.var_26.method_2 > 0)
         {
            _loc2_ = "catalog.club_gift.available";
            this.var_26.localization.registerParameter(_loc2_,"amount",this.var_26.method_2.toString());
         }
         else if(this.var_26.method_5 > 0)
         {
            _loc2_ = "catalog.club_gift.days_until_next";
            this.var_26.localization.registerParameter(_loc2_,"days",this.var_26.method_5.toString());
         }
         ...
         if(_loc6_)
         {
            _loc2_ = this.var_26.purse.pastVipDays >= this.const_243 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = this.var_26.purse.pastVipDays % this.const_243;
            _loc4_ = this.var_26.purse.pastVipDays / this.const_243;
            this.var_26.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this.var_26.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         else if(this.var_26.method_2 > 0)
         {
         ...
         if(_loc9_)
         {
            if(param2.isSelectable && this.var_26.method_2 > 0)
            {
               _loc9_.enable();
            }
            else
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_242)
         {
            this.var_242 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_242)
         {
            return;
         }
         var _loc4_:IBitmapWrapperWindow = this.var_242.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc4_)
         {
            return;
         }
         ...
         this.var_242.setGlobalPosition(_loc6_.subtract(new Point(this.var_242.width / 2,this.var_242.height / 2)));
         this.var_242.visible = true;
         this.var_242.activate();
      }
