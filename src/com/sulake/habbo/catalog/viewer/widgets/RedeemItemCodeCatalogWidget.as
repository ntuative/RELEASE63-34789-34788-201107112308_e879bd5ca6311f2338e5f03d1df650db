package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_975:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_976.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_976 = null;
         }
         if(this.var_975 != null)
         {
            this.var_975.removeEventListener(WindowKeyboardEvent.const_192,this.windowKeyEventProcessor);
            this.var_975 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_976 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_976 != null)
         {
            this.var_976.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_975 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_975 != null)
         {
            this.var_975.addEventListener(WindowKeyboardEvent.const_192,this.windowKeyEventProcessor);
         }
         return true;
      }
