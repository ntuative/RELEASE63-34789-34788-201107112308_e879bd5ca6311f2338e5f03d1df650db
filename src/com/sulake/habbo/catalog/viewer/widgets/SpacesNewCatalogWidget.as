package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_435:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         super(param1,param2);
         this.var_435 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_435)
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_435.numSelectables)
            {
               _loc4_ = this.var_435.getSelectableAt(_loc3_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_118[this.var_533]);
      ...
      {
         var _loc2_:int = this.var_662[this.var_533];
         var _loc3_:Offer = this.var_219[this.var_533][_loc2_];
      ...
      public function selectIndex(param1:int) : void
      {
         ...
         {
            _loc2_ = this.var_219[this.var_533][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_662[this.var_533] = (this.var_219[this.var_533] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_662[0];
         var _loc2_:int = this.var_662[1];
         var _loc3_:int = this.var_662[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_441 || _loc1_.pricingModel == Offer.const_415))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_65 || _loc2_.productType == ProductTypeEnum.const_72))
            {
               continue;
            }
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_435.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_435.setSelected(this.var_435.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_219[this.var_533],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_662[this.var_533];
