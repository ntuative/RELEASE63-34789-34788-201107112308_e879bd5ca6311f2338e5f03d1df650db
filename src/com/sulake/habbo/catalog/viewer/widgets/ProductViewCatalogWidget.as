package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_516:IDisplayObjectWrapper;
      
      private var var_1720:Point;
      
      private var var_517:IItemGridWindow;
      
      private var var_1436:IScrollbarWindow;
      
      protected var var_1795:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_943 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1157 = _window.findChildByName("ctlg_description") as ITextWindow;
         ...
         if(this.var_194 != null)
         {
            ...
            this.var_516 = this.var_194.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_516 != null && _loc3_ != null)
            {
               this.var_194.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_516.width,this.var_516.height);
               if(_loc4_ != null)
               {
                  this.var_516.setDisplayObject(_loc4_);
               }
            }
            else
            {
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_943.text = _loc4_;
         this.var_1157.text = _loc5_;
         this.var_943.height = this.var_943.textHeight + 5;
         this.var_1157.y = this.var_943.y + this.var_943.height;
         this.var_1157.height = Math.max(130,this.var_1157.textHeight + 5);
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_508:
                  ...
                  if(this.var_517 != null)
                  {
                     ...
                     _loc11_.populateItemGrid(this.var_517,this.var_1436,this.var_1795);
               ...
               case Offer.const_415:
                  ...
                  if(this.var_194 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_72 || _loc9_.productType == ProductTypeEnum.const_65 || _loc9_.productType == ProductTypeEnum.const_196)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_72:
                        if(_loc8_ != null && this.var_516 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_328,AvatarAction.const_592);
                                 _loc18_.appendAction(AvatarAction.const_327,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2278)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_97 != null && true)
         {
            ...
            this.var_97.x = this.var_1720.x;
            this.var_97.y = this.var_1720.y;
            if(param3 != null)
            {
