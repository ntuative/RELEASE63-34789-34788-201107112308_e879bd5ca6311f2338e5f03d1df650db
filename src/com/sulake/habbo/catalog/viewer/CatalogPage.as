package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2058:String = "ctlg_";
      ...
      private var var_569:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1318:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_569 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1319);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1319);
      }
      ...
      {
         var _loc2_:String = const_2058 + param1;
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1802:
               if(this.var_1318 == null)
               {
                  this.var_1318 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_39.push(this.var_1318);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1864:
               ...
               break;
            case CatalogWidgetEnum.const_1983:
            ...
            case CatalogWidgetEnum.const_1751:
               ...
               break;
            case CatalogWidgetEnum.const_1936:
               this.var_39.push(new SpecialInfoWidget(param1));
               break;
            case CatalogWidgetEnum.const_1798:
            ...
            case CatalogWidgetEnum.const_1838:
               ...
               break;
            case CatalogWidgetEnum.const_1899:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_569.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_569 != null)
         {
            return this.var_569.dispatchEvent(param1);
         }
         return false;
      }
