package com.sulake.habbo.catalog.viewer
{
   ...
   public class RoomPreviewer
   {
      ...
      private static const const_489:Number = 0.25;
      
      private static const const_1694:int = 64;
      
      private static const const_1693:int = 32;
      
      private static const const_1695:int = 2500;
      ...
      public function RoomPreviewer(param1:IRoomEngine)
      {
         ...
         if(this._roomEngine != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_937,this.onRoomObjectAdded);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_199,this.onRoomInitialized);
         }
      ...
      public function dispose() : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_937,this.onRoomObjectAdded);
            this._roomEngine.events.removeEventListener(RoomEngineEvent.const_199,this.onRoomInitialized);
         }
      }
      ...
      public function reset() : void
      {
         ...
         this.var_353 = RoomObjectCategoryEnum.const_166;
      }
      ...
      public function addFurnitureIntoRoom(param1:int, param2:IVector3d) : int
      {
         if(this._roomEngine != null)
         {
            if(this.var_353 == RoomObjectCategoryEnum.const_27 && this.var_1380 == param1)
            {
               return const_66;
            }
            this.reset();
            this.var_1380 = param1;
            this.var_353 = RoomObjectCategoryEnum.const_27;
            this.var_1678 = "";
            if(this._roomEngine.addObjectFurniture(const_54,const_53,const_66,param1,new Vector3d(const_729,const_730,0),param2,0,""))
            {
               this.var_1377 = getTimer();
               this.var_1378 = true;
               return const_66;
            }
         }
      ...
      public function addWallItemIntoRoom(param1:int, param2:IVector3d, param3:String) : int
      {
         if(this._roomEngine != null)
         {
            if(this.var_353 == RoomObjectCategoryEnum.const_26 && this.var_1380 == param1 && this.var_1678 == param3)
            {
               return const_66;
            }
            this.reset();
            this.var_1380 = param1;
            this.var_353 = RoomObjectCategoryEnum.const_26;
      ...
      public function addAvatarIntoRoom(param1:String, param2:int) : int
      {
         if(this._roomEngine != null)
         {
            this.reset();
            this.var_1380 = 1;
            this.var_353 = RoomObjectCategoryEnum.const_29;
            this.var_1678 = param1;
            if(this._roomEngine.addObjectUser(const_54,const_53,const_66,new Vector3d(const_729,const_730,0),new Vector3d(90,0,0),135,1,param1))
            {
               this.var_1377 = getTimer();
               this.var_1378 = true;
      ...
      public function changeRoomObjectState() : void
      {
         ...
         {
            this.var_1378 = false;
            if(this.var_353 != RoomObjectCategoryEnum.const_29)
            {
               this._roomEngine.changeObjectState(const_54,const_53,const_66,this.var_353);
            }
         }
      }
      ...
      private function checkAutomaticRoomObjectStateChange() : void
      {
         ...
         {
            _loc1_ = getTimer();
            if(_loc1_ > this.var_1377 + const_1695)
            {
               this.var_1377 = _loc1_;
               if(this._roomEngine != null)
               {
                  this._roomEngine.changeObjectState(const_54,const_53,const_66,this.var_353);
               }
      ...
      public function getRoomCanvas(param1:int, param2:int) : DisplayObject
      {
         ...
         if(this._roomEngine != null)
         {
            ...
            if(_loc4_ != null)
            {
               _loc4_.adjustLocation(new Vector3d(const_729,const_730,0),30);
            }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:Rectangle = this._roomEngine.getRoomObjectBoundingRectangle(const_54,const_53,const_66,this.var_353,const_245);
         if(_loc2_ != null && param1 != null)
         {
            _loc2_.offset(-(this.var_1376 >> 1),-(this.var_1122 >> 1));
            ...
            else
            {
               ...
               if(_loc3_.width - this.var_51.width > this.var_1376 - this.var_51.width >> 1 || _loc3_.height - this.var_51.height > this.var_1122 - this.var_51.height >> 1 || this.var_51.width < 1 || this.var_51.height < 1)
               {
                  this.var_51 = _loc3_;
               }
            }
      ...
      private function validatePreviewSize(param1:Point) : Point
      {
         ...
         if(this.var_51.width > this.var_1376 * (1 + const_489) || this.var_51.height > this.var_1122 * (1 + const_489))
         {
            if(_loc2_.isZoomedIn())
            {
               _loc2_.performZoomOut();
               this.var_1379 = const_1693;
               this.var_2154 = true;
               param1.x >>= 1;
               param1.y >>= 1;
               this.var_51.left >>= 2;
         ...
         else if(this.var_51.width << 1 < this.var_1376 * (1 + const_489) - 5 && this.var_51.height << 1 < this.var_1122 * (1 + const_489) - 5)
         {
            if(!_loc2_.isZoomedIn() && !this.var_2154)
            {
               _loc2_.performZoomIn();
               this.var_1379 = const_1694;
               param1.x <<= 1;
               param1.y <<= 1;
            }
         }
      ...
      private function getCanvasOffset(param1:Point) : Point
      {
         ...
         var _loc4_:* = this.var_1122 - this.var_51.height >> 1;
         if(_loc4_ > 10)
         {
            _loc3_ += Math.min(15,_loc4_ - 10);
         }
         else if(this.var_353 != RoomObjectCategoryEnum.const_29)
         {
      ...
      private function onRoomObjectAdded(param1:RoomEngineObjectEvent) : void
      {
         ...
         if(param1.roomId == const_54 && param1.roomCategory == const_53 && param1.objectId == const_66 && param1.category == this.var_353)
         {
            this.var_51 = null;
            this.var_2154 = false;
            ...
            {
               _loc3_ = _loc2_.getModel().getNumber(RoomObjectVariableEnum.const_655);
               _loc4_ = _loc2_.getModel().getNumber(RoomObjectVariableEnum.const_984);
