package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_1520:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1241 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_333,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_377,this.onMessageInputFocus);
         }
         this.var_1872 = true;
         this.var_1871 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               _loc12_.addEventListener(WindowEvent.const_517,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1870 = _loc1_.stuffTypes;
            this.var_814 = _loc1_.boxTypes;
            this.var_815 = _loc1_.ribbonTypes;
            this.var_1242 = this.var_1870[0];
            this.var_386 = this.var_814[0];
            this.var_387 = this.var_815[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_387 < 0)
         {
            this.var_387 = this.var_815.length - 1;
         }
         if(this.var_387 > this.var_815.length - 1)
         {
            this.var_387 = 0;
         }
         if(this.var_386 < 0)
         {
            this.var_386 = this.var_814.length - 1;
         }
         if(this.var_386 > this.var_814.length - 1)
         {
            this.var_386 = 0;
         }
         var _loc1_:int = this.var_814[this.var_386] * 1000 + this.var_815[this.var_387];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1242,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1524 = _loc2_.id;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1242);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_814[this.var_386]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_815[this.var_387]);
         this._catalog.purchaseProductAsGift(this.var_1523,this.var_1241,this.var_1522,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1523,this.var_1241,this.var_1522);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         if(this.var_2479 == _loc2_.text)
         {
            return;
         }
         var _loc3_:String = _loc2_.text.toLowerCase();
         var _loc4_:* = [];
         for each(_loc5_ in this.var_258)
         {
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_816 == null)
         {
            this.var_816 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_282 == null || this.var_816 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_816.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      {
         this.var_1242 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1242;
               }
            }
            _loc4_++;
         }
