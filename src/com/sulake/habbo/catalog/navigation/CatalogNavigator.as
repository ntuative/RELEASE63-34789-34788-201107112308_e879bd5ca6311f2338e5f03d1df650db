package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_3127:String = "magic.credits";
      
      private var var_3100:String = "magic.pixels";
      
      private var var_3099:String = "catalog.page.club";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         this.var_426 = [];
         this.var_65 = this._container.findChildByName("navigationList") as IItemListWindow;
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_979,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_297,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_867,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_247,this.deActivateScrollbar);
         }
      }
      ...
      public function buildCatalogIndex(param1:NodeData) : void
      {
         ...
         for each(_loc2_ in this._index.children)
         {
            ...
            {
               (_loc2_ as CatalogNodeRenderable).addToList(this.var_65);
            }
         }
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = this.var_426.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in this.var_426)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = this.var_426.indexOf(_loc6_);
            this.var_426.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
         ...
         if(this.var_426.indexOf(param1) == -1)
         {
      ...
      {
         this.openPage(this.var_3100);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_3099,true);
      }
