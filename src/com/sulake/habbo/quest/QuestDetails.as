package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1523:int = 56;
      
      private static const const_487:int = 5;
      
      private static const const_1525:int = 5;
      
      private static const const_1079:Point = new Point(8,8);
      
      private static const const_1524:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER","PET_DRINK","PET_EAT"];
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            _loc8_.x = const_1079.x;
            _loc8_.y = const_1079.y;
         ...
         if(!_loc2_)
         {
            ...
            _loc3_.height = _loc3_.textHeight + const_1525;
         }
         _loc3_.visible = !_loc2_;
         var _loc5_:int = this.getTextHeight(_loc3_) - _loc4_;
         var _loc6_:int = this.setupLink("link_region",_loc3_.y + _loc3_.height + const_487);
         ...
         this._window.height = _loc8_.height + const_1523;
      ...
      private function setupLink(param1:String, param2:int) : int
      {
         ...
         {
            _loc7_ = const_487 + _loc6_.height;
         }
         if(!_loc5_ && _loc6_.visible)
         {
            _loc7_ = -const_487 - _loc6_.height;
      ...
      {
         return this.var_143.waitPeriodSeconds < 1 && const_1524.indexOf(this.var_143.type) > -1;
      }
