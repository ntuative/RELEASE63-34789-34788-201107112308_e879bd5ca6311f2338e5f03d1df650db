package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1626:int = 800;
      
      private static const const_1628:int = 15;
      
      private static const const_1629:int = 300;
      ...
      private var var_1320:QuestController;
      
      private var var_1066:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1320 = new QuestController(this);
         this.var_1066 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1627);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_371.events.removeEventListener(BadgeImageReadyEvent.const_222,this.var_1066.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_371.events.addEventListener(BadgeImageReadyEvent.const_222,this.var_1066.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1320.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_1066.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1320.questTracker.isVisible();
      }
      ...
      {
         this.var_1320.update(param1);
         this.var_1066.update(param1);
      }
