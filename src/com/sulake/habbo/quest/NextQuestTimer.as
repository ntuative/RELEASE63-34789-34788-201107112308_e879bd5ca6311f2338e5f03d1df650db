package com.sulake.habbo.quest
{
   ...
   public class NextQuestTimer implements IDisposable
   {
      ...
      public static const const_744:int = 1000;
      
      private static const const_686:String = "next_quest";
      ...
      private function refresh() : void
      {
         ...
         this._window.findChildByName("quest_header_txt").caption = this.var_49.localization.getKey("quests.nextquesttimer.caption." + (!!this.var_553 ? "expanded" : "contracted"));
      ...
      {
         this._window.findChildByName("quest_timer_expanded").visible = this.var_553;
         this._window.findChildByName("quest_timer_contracted").visible = !this.var_553;
         this._window.findChildByName("more_info_txt").visible = this.var_553 && this.var_49.currentlyInRoom;
         this._window.findChildByName("more_info_region").visible = this.var_553 && this.var_49.currentlyInRoom;
         this._window.findChildByName("quest_pic_bitmap").visible = this.var_553;
         this._window.findChildByName("desc_txt").visible = this.var_553;
         this.refresh();
      }
