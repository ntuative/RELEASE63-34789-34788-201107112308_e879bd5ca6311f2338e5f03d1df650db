package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1436:int = 30;
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1447.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1447[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_65 = IItemListWindow(this._window.findChildByName("quest_list"));
         this.var_607 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_65.spacing = const_1435;
      }
      
      private function refreshEntry(param1:Boolean, param2:int, param3:QuestMessageData, param4:Boolean) : Boolean
      {
         var _loc5_:IWindowContainer = IWindowContainer(this.var_65.getListItemAt(param2));
         ...
         if(_loc5_ == null)
         {
            ...
            this.var_65.addListItem(_loc5_);
            _loc6_ = true;
         }
         if(param1)
         {
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1438;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1437;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1436;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1754 && !this.var_1755)
            {
               this.var_1754 = false;
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1448 = NextQuestTimer.const_744;
         this.refresh(true);
      }
   }
}
