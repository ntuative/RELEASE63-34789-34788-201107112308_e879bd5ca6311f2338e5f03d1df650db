package com.sulake.habbo.communication.encryption
{
   ...
   public class RC4_R27 extends RC4 implements IEncryption
   {
      ...
      private static const const_1662:String = "mWxFRJnGJ5T9Si0OMVvEBBm8laihXkN8GmH6fuv7ldZhLyGRRKCcGzziPYBaJom";
      
      private static const const_1663:int = 52;
      ...
      private static const const_1125:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
       
      
      private var var_2106:IEncryption;
      
      private var var_2926:PseudoRandom;
      
      public function RC4_R27(param1:IEncryption, param2:PseudoRandom)
      {
         super();
         this.var_2106 = param1;
         this.var_2926 = param2;
      }
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:ByteArray = CryptoTools.stringToByteArray(const_1662);
         var _loc4_:int = 0;
      ...
      override public function encipher(param1:ByteArray, param2:Boolean = false) : ByteArray
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:int = 0;
         if(this.var_2106 != null)
         {
            _loc7_ = new ByteArray();
            _loc8_ = new ByteArray();
            _loc6_ = this.var_2926.nextInt() % 5;
            ...
            _loc5_ = this.var_2106.encipher(_loc7_,true);
