package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_575:IKeyExchange;
      
      private var var_1083:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2851:PseudoRandom;
      ...
      private var var_260:HabboHotelView;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_706 = param1;
            this.var_66.initConnection(HabboConnectionType.const_316);
         }
      }
      ...
      {
         if(this.var_66 && this.var_160 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:Boolean = this.var_160.getBoolean("client.hotel_view.show_on_startup",true);
         this.var_260 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         var _loc2_:String = this.var_160.getKey("client.hotel_view.image");
         var _loc3_:String = this.var_160.getKey("image.library.url");
         if(_loc2_ != null && _loc3_ != null)
         {
            this.var_260.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_160.getKey("use.sso.ticket") == "1";
         this.var_706 = this.var_160.getKey("sso.ticket",null);
         this.var_2077 = this.var_160.getKey("flash.client.url","");
         this.var_2852 = this.var_160.getKey("external.variables.txt","");
         if(this.var_260 == null)
         {
            this.var_260 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_66.mode = HabboConnectionType.const_95;
            if(this.var_706)
            {
               this.var_66.initConnection(HabboConnectionType.const_316);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_931,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_2031);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_66.mode = HabboConnectionType.const_1396;
            }
         }
         this.var_66.initConnection(HabboConnectionType.const_316);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_927);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2851 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_66.mode)
         {
            case HabboConnectionType.const_95:
               ...
               this.var_260.loadBannerImage(_loc7_ + "?token=" + this.var_1631,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1396:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1977:
               this.var_1083 = this.generateRandomHexString(30);
               this.var_575 = new DiffieHellman(new BigInteger(this.var_160.getKey("connection.development.prime"),16),new BigInteger(this.var_160.getKey("connection.development.generator"),16));
               this.var_575.init(this.var_1083);
               _loc8_ = this.var_575.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_575.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_575.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2851);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_2077,this.var_2852));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2076,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_706 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_706);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2850)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1631);
         ...
         this.var_575 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_575.init(_loc14_);
            _loc15_ = this.var_575.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_1083 = _loc14_;
            }
