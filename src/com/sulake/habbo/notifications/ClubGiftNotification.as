package com.sulake.habbo.notifications
{
   ...
   public class ClubGiftNotification
   {
      ...
      private static const const_686:String = "club_gift_notification";
      ...
      public function ClubGiftNotification(param1:int, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboCatalog, param5:IHabboToolbar)
      {
         ...
         this._toolbar.extensionView.attachExtension(const_686,this._window);
         this.var_1965 = this._window.findChildByName("cancel_link") as ITextWindow;
      ...
      public function dispose() : void
      {
         if(this._toolbar)
         {
            this._toolbar.extensionView.detachExtension(const_686);
         }
         if(this._window != null)
         {
      ...
      {
         this.var_1965.textColor = const_1518;
      }
      
      private function onMouseOut(param1:WindowMouseEvent) : void
      {
         this.var_1965.textColor = const_1517;
      }
