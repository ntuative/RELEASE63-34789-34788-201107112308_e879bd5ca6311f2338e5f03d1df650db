package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_2035:int = 5;
      
      private static const name_4:int = 0;
      
      private static const const_668:int = 1;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1948 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1948 = 15;
         }
         this.var_1949 = this._window.height;
         this.var_1564 = 4;
         this._blend = 0;
         this._state = name_4;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_668:
               ...
               _loc2_ = Number(this.var_1285) / Number(this.var_1035["time_fade_in"]);
               if(this.var_1285 > int(this.var_1035["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1095:
               ...
               if(this.var_1563 > int(this.var_1035["time_display"]) && !this.var_1950)
               {
                  this.startFadeOut();
               }
               break;
            case const_1094:
               ...
               _loc3_ = 1 - Number(this.var_1284) / Number(this.var_1035["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1284 > int(this.var_1035["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1948;
         if(this._window.height < this.var_1949)
         {
            this._window.height = this.var_1949;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_2035;
         this._window.y = this.var_1564;
      }
