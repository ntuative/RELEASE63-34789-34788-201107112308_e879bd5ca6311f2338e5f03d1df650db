package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1580:String = "pixelbalance";
      
      private static const const_1582:String = "badges";
      
      private static const const_1584:String = "selectbadge";
      
      private static const const_1583:String = "inventory";
      
      private static const const_1579:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1581:String = "friendlist";
      
      private static const const_1585:String = "pet_inventory";
      
      private static const const_1578:String = "go_to_room";
      ...
      private var var_1958:IHabboToolbar;
      ...
      private var var_552:HabboNotificationViewManager;
      
      private var var_257:HabboAlertDialogManager;
      
      private var var_851:ParkBusDialogManager;
      
      private var var_2691:Boolean;
      
      private var var_1047:ClubGiftNotification;
      
      private var var_1046:ClubEndingNotification;
      
      private var var_1045:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1048);
         }
         var _loc6_:Map = this.var_1048["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1048["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      {
         this.var_1958 = param2 as IHabboToolbar;
      }
      ...
      {
         this.var_552 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_1958,this.var_1048["styles"],this.var_1048["view"]);
         ...
         registerUpdateReceiver(this.var_552,1);
         registerUpdateReceiver(this,2);
         this.var_371.events.addEventListener(BadgeImageReadyEvent.const_222,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_371.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1301,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1301,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_2024,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_822,null);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_371.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_65)
               {
                  _loc7_ = this.var_371.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_371.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1943,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1265)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1905,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1045 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_552.isSpaceAvailable() && this.var_1289.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_552.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1585:
               if(this.var_12 != null && this.var_12.hasRoomSession)
               {
                  this.var_12.toggleInventoryPage(InventoryCategory.const_122);
               }
               break;
            case const_1579:
               break;
      ...
      {
         if(param1 != null && this.var_552 != null)
         {
            this.var_552.replaceIcon(param1);
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_344;
            }
            if(param2 == 3002)
            {
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_851 == null)
         {
            this.var_851 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_851 != null)
         {
            this.var_851.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_1119.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_62);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2691)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_822,null);
            this.var_2691 = true;
      ...
      {
         if(param2.type == WindowEvent.const_148 || param2.type == WindowEvent.const_637)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1047 && this.var_1047.visible)
         {
            return;
         }
         this.var_1047 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog,this.var_1958);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_822,_loc6_);
      }
   }
}
