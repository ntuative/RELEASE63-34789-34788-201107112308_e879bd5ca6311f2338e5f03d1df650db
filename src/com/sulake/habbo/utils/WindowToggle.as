package com.sulake.habbo.utils
{
   ...
   public class WindowToggle implements IDisposable
   {
      ...
      public static const const_1992:int = 1;
      ...
      public function show() : void
      {
         ...
         {
            if(this._window.parent != this.var_1003)
            {
               this.var_1003.addChild(this._window);
            }
