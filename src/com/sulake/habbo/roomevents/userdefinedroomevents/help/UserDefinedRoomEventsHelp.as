package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1176:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1750 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1175 = this.var_1750.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1175)
         {
            this.var_1175.procedure = this.onButtonClick;
         }
         this.var_1176 = this.var_1750.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1176)
         {
            this.var_1176.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_271 >= this.var_73.length - 1)
         {
            this.var_1176.disable();
         }
         else
         {
            this.var_1176.enable();
         }
         if(this.var_271 <= 0)
         {
            this.var_1175.disable();
         }
         else
         {
            this.var_1175.enable();
         }
      }
      ...
      {
         ++this.var_271;
         this.var_271 = Math.min(this.var_271,this.var_73.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_271;
         this.var_271 = Math.max(this.var_271,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_73[this.var_271][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_73[this.var_271][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_73[this.var_271][1]).value;
