package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1396,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1133);
         }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1134)
         {
            if(param1.type == WindowMouseEvent.const_55 || param1.type == WindowMouseEvent.const_305)
            {
               this.var_1134 = false;
            }
         }
         if(!this.var_1134 || param1.type != WindowEvent.const_438)
         {
            return;
         }
         if(this.var_744 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_744) * this.var_744;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_744 != 0)
            {
               _loc3_ = this.var_1133 + this.var_744;
      ...
      private function displaySlider() : void
      {
         ...
         {
            _loc2_.bitmap = new BitmapData(this.var_795.width,this.var_795.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_795,this.var_795.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_794 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_794.width,this.var_794.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_794,this.var_794.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1828 = _loc1_.width - _loc2_.width;
            }
         }
