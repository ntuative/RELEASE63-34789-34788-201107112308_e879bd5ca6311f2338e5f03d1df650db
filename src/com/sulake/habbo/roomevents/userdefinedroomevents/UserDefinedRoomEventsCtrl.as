package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1493:int = 2;
      ...
      private var var_1838:TriggerConfs;
      
      private var var_1840:ActionTypes;
      
      private var var_1839:ConditionTypes;
      
      private var var_278:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_798:RoomObjectHightLighter;
      
      private var var_203:UserDefinedRoomEventsHelp;
      
      private var var_1226:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1838 = new TriggerConfs();
         this.var_1840 = new ActionTypes();
         this.var_1839 = new ConditionTypes();
         this.var_278 = new Dictionary();
         super();
         this.var_94 = param1;
         this.var_798 = new RoomObjectHightLighter(param1);
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1226 = new SliderWindowController(this.var_94,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_94.assets,0,20,1);
         this.var_1226.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1226.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_798.hideAll(this.var_278);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_798.showAll(this.var_278);
         if(this.var_37 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_37);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1226.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1226.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1493) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1493 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1838);
         this.refreshConfigureElement(this.var_1840);
         this.refreshConfigureElement(this.var_1839);
