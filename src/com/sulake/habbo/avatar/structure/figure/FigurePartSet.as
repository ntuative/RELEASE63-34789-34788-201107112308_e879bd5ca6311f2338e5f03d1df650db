package com.sulake.habbo.avatar.structure.figure
{
   public class FigurePartSet implements IFigurePartSet
   {
      ...
      public function FigurePartSet(param1:XML, param2:String)
      {
         ...
         this.var_2200 = parseInt(param1.@club);
         this.var_1585 = Boolean(parseInt(param1.@colorable));
         this.var_2478 = Boolean(parseInt(param1.@selectable));
         ...
         {
            this.var_1611.push(String(_loc4_.@parttype));
         }
      }
