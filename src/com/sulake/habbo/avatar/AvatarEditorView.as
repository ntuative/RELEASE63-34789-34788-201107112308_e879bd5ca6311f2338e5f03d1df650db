package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_2236:int = 6710886;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:Array)
      {
         ...
         var _loc5_:* = null;
         this.var_1202 = [];
         this.var_1464 = [AvatarEditorFigureCategory.const_816,AvatarEditorFigureCategory.const_56,AvatarEditorFigureCategory.const_281,AvatarEditorFigureCategory.const_962,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_112];
         super();
         this.var_23 = param1;
         if(var_1410 == null)
         {
      ...
      public function getFrame(param1:Array, param2:String = null) : IFrameWindow
      {
         ...
         this.var_84.position = const_1461;
      ...
      public function embedToContext(param1:IWindowContainer, param2:Array) : Boolean
      {
         ...
         else
         {
            if(this.var_627 == null)
            {
               this.var_627 = this.var_23.manager.windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_71,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_627.addChild(this.var_58);
            }
            _loc3_ = this.var_627.getChildIndex(this.var_58);
            if(_loc3_)
            {
               param1.removeChildAt(_loc3_);
            }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1464);
         }
         if(param1.length != this.var_1202.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1202.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_247 = this.var_58.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc1_:int = this.var_247.numSelectables - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_247.getSelectableAt(_loc1_);
            if(_loc2_ != null && this.var_1202.indexOf(_loc2_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1464;
      ...
      public function update() : void
      {
         ...
         if(this.var_23.manager.sessionData && this.var_23.manager.sessionData.clubLevel >= HabboClubLevelEnum.const_35 && (this.var_1465 == AvatarEditorSideCategory.const_112 || this.var_2383))
         {
            _loc4_ = "null";
         }
         ...
         this.setViewToCategory(this.var_408);
      }
      ...
      {
         if(this.var_1465 == AvatarEditorSideCategory.const_112)
         {
            this.var_2383 = false;
            this.setSideContent(AvatarEditorSideCategory.const_598);
         }
         else
         {
            this.setSideContent(AvatarEditorSideCategory.const_112);
         }
      }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_598:
               break;
            case AvatarEditorSideCategory.const_535:
               _loc3_ = this.var_23.getSideContentWindowContainer(AvatarEditorSideCategory.const_535);
               break;
            case AvatarEditorSideCategory.const_112:
               _loc3_ = this.var_23.getSideContentWindowContainer(AvatarEditorSideCategory.const_112);
         }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_321)
         {
            ...
            this.var_321 = this.var_23.manager.windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_321.procedure = this.stripClubDialogEventProc;
            this.var_321.center();
         }
         else
         {
