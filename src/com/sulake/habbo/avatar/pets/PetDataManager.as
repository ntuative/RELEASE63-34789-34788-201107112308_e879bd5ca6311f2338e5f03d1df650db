package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager, IDisposable
   {
      ...
      {
         if(param1 == null || this.var_593 == null)
         {
            return;
         }
         var _loc2_:int = this.var_593.indexOf(param1);
         if(_loc2_ != -1)
         {
      ...
      private function notifyListeners() : void
      {
         ...
         {
            _loc1_ = this.var_593.pop() as IPetDataListener;
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(this.var_1681.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_737.getValue(_loc6_) == null)
               {
                  ...
                  this.var_737.add(_loc6_,_loc8_);
                  if(param3 != null && this.var_593.indexOf(param3) == -1)
                  {
                     this.var_593.push(param3);
                  }
               }
            }
         }
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_737.getKeys())
         {
            _loc5_ = this.var_737.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
