   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_40)
         {
            ...
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_90,_windowManager,_assetLibrary);
         }
         else
         {
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_78.controller.gender)
         {
            case FigureData.const_88:
               activateTab(this.const_719);
               inactivateTab(this.const_718);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_718);
               inactivateTab(this.const_719);
         }
      }
