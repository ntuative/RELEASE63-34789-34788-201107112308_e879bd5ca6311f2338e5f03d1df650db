package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2349:String = "hd-99999-99999";
      ...
      private var var_784:PaletteManager;
      ...
      private var var_1801:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_647 = RenderMode.const_1744;
         ...
         this.var_119.add(AvatarType.const_132,_loc4_);
         ...
         this.var_119.add(AvatarType.const_57,_loc4_);
         ...
         this.var_784 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_249)
         {
            this.var_249.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_323.init();
         this.var_784.init();
         _loc2_ = this.var_119.getValue(AvatarType.const_132) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_119.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_119.getValue(AvatarType.const_132) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_126.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_249 == null)
               {
                  ...
                  _loc6_ = this.var_126.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_126.getKey("flash.dynamic.avatar.download.url","");
                  this.var_249 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_249.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1111)
         {
            if(this.var_2396 && this.var_2395 && this.var_2397)
            {
               this.var_1111 = true;
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_249.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_249.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_119.getValue(AvatarType.const_132) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_249.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1801)
         {
            this.var_1801 = new AvatarFigureContainer(this.const_2349);
         }
         this.var_249.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1801,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1764)
         {
            _loc6_ = !this.var_323.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_323.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_119.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_119.getValue(AvatarType.const_57);
      ...
      {
         var _loc3_:AvatarStructure = this.var_119.getValue(AvatarType.const_132) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_57:
               _loc3_ = this.var_119.getValue(AvatarType.const_57) as AvatarStructure;
               break;
            default:
