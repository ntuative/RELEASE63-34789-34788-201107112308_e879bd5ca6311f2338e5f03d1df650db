package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      private var var_1847:Dictionary;
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_1847 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_3018 = parseInt(param1.@precedence);
         this.var_3017 = String(param1.@activepartset);
         this.var_3015 = String(param1.@assetpartdefinition);
         this.var_3013 = String(param1.@lay);
         this.var_845 = String(param1.@geometrytype);
         this.var_2458 = Boolean(parseInt(param1.@main));
         this.var_3019 = Boolean(parseInt(param1.@method_1));
         this.var_3014 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_3016 = _loc6_;
            }
            else
            {
               this.var_1847[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_919.getValue(param1) == null)
         {
            this.var_919.add(param1,new Map());
         }
         var _loc4_:Map = this.var_919.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_919.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1847[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_3016;
         }
         return _loc2_;
      }
