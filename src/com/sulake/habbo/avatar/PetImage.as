   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_56)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1537);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_739);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_739);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_739);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_739);
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_594 = this.var_594 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_435:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1872:
                  case AvatarAction.const_2019:
                  case AvatarAction.const_1184:
                  case AvatarAction.const_1254:
                  case AvatarAction.const_1792:
                  case AvatarAction.const_1918:
      ...
      private function sortActions() : void
      {
         ...
         this.var_1538 = this._structure.sortActions(this.var_363);
         ...
         {
            this.var_919 = this._structure.getCanvasOffsets(this.var_1538,this._scale,this.var_102);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1538)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_449)
               {
                  this.var_1015 = true;
               }
               ...
               if(_loc1_.actionType == AvatarAction.const_335)
               {
                  this.var_1015 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1344 = _loc4_.id;
                     this.var_1889 = _loc4_.breed;
                     break;
                  }
               }
            }
