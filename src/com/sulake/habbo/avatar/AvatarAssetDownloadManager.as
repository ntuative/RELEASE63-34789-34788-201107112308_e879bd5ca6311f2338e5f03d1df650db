package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_1174:Dictionary;
      ...
      private var var_951:int = 3;
      
      private var var_436:AssetLoaderStruct;
      
      private var var_950:Timer;
      ...
      private const const_2344:int = 100;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         this.var_950 = new Timer(this.const_2344,1);
         this.var_950.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_436)
         {
            this.var_436.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,this.onConfigurationComplete);
            this.var_436.addEventListener(AssetLoaderEvent.const_43,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_436)
         {
            this.var_436.removeEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,this.onConfigurationComplete);
            this.var_436.removeEventListener(AssetLoaderEvent.const_43,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         if(this.var_951 <= 0)
         {
            HabboWebTools.logEventLog("Figuremap download error " + this.var_1172);
            Logger.log("AVATAR ASSET ERROR: Could not download figuremap.xml.");
         }
         else
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_951);
            if(this.var_1172.indexOf("?") > 0)
            {
               _loc2_ = this.var_1172 + "&retry=" + this.var_951;
            }
            else
            {
               _loc2_ = this.var_1172 + "?retry=" + this.var_951;
      ...
      private function loadFigureMapData(param1:XML) : void
      {
         ...
         this.var_1749 = true;
         for each(_loc2_ in this.var_1173)
         {
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2322,this._assets);
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1749)
         {
            this.var_1173.push([param1,param2]);
            return;
         }
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_593[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_593[_loc3_] = _loc6_;
            }
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_949)
         {
            _loc7_ = true;
            _loc4_ = this.var_949[_loc3_];
            ...
            if(_loc7_)
            {
               ...
               delete this.var_593[_loc3_];
            }
         }
         for each(_loc3_ in _loc2_)
         {
            delete this.var_949[_loc3_];
         }
         while(_loc6_ < this.var_767.length)
         {
            _loc5_ = this.var_767[_loc6_];
            if(_loc5_.libraryName == (param1.target as AvatarAssetDownloadLibrary).libraryName)
            {
               this.var_767.splice(_loc6_,1);
            }
            _loc6_++;
         }
         this.var_950.start();
      ...
      {
         var _loc1_:* = null;
         while(this.var_766.length > 0 && this.var_767.length < this.const_1762)
         {
            _loc1_ = this.var_766[0];
            _loc1_.startDownloading();
            this.var_767.push(this.var_766.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_766.indexOf(param1) == -1 && this.var_767.indexOf(param1) == -1)
         {
