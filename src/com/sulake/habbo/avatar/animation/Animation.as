package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1781:AvatarDataContainer;
      
      private var var_1461:Array;
      
      private var var_1783:DirectionDataContainer;
      
      private var var_1784:ShadowDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1782 = String(param2.@desc);
         }
         else
         {
            this.var_1782 = this._id;
         }
         if(param2.hasOwnProperty("sprite"))
         {
            for each(_loc3_ in param2.sprite)
            {
               this.var_1459.push(new SpriteDataContainer(this as IAnimation,_loc3_));
            }
         }
         if(param2.hasOwnProperty("avatar"))
         {
            this.var_1781 = new AvatarDataContainer(param2.avatar[0]);
         }
         if(param2.hasOwnProperty("canvas"))
         {
            for each(_loc4_ in param2.canvas)
            {
               this.var_1461.push(new CanvasDataContainer(_loc4_));
            }
         }
         if(param2.hasOwnProperty("direction"))
         {
            this.var_1783 = new DirectionDataContainer(param2.direction[0]);
         }
         if(param2.hasOwnProperty("shadow"))
         {
            this.var_1784 = new ShadowDataContainer(param2.shadow[0]);
         }
         if(param2.hasOwnProperty("remove"))
         {
            for each(_loc5_ in param2.remove)
            {
               this.var_1460.push(String(_loc5_.@id));
            }
         }
         if(param2.hasOwnProperty("add"))
         {
            ...
            {
               this.var_778.push(new AddDataContainer(_loc6_));
            }
         }
         if(param2.hasOwnProperty("HabboNavigatorCom_rico_bg22_png"))
         {
            this._overrideFrames = new Map();
            this.var_625 = new Map();
            for each(_loc7_ in param2.HabboNavigatorCom_rico_bg22_png)
            {
               _loc8_ = _loc7_.@name;
               _loc9_ = _loc7_.@HabboNavigatorCom_rico_bg22_png;
               this.var_625.add(_loc9_,_loc8_);
               _loc10_ = new Array();
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc9_ in _loc7_.fx)
            {
               ...
               _loc11_ = new AnimationLayerData(param3,_loc9_,AnimationLayerData.const_671,_loc6_,_loc5_);
               _loc4_.push(_loc11_);
               if(_loc5_ != null)
               {
               }
      ...
      public function overridingAction(param1:String) : String
      {
         ...
         return this.var_625.getValue(param1);
      }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         for each(_loc4_ in this.getFrame(param1,param2))
         {
            ...
            else if(_loc4_.type == AnimationLayerData.const_671)
            {
      ...
      public function getLayerData(param1:int, param2:String, param3:String = null) : AnimationLayerData
      {
         ...
         for each(_loc4_ in this.getFrame(param1,param3))
         {
            ...
            if(_loc4_.type == AnimationLayerData.const_671)
            {
               for each(_loc5_ in this.var_778)
               {
      ...
      {
         return this.var_1459 != null;
      }
      
      public function hasAvatarData() : Boolean
      {
         return this.var_1781 != null;
      }
      
      public function hasCanvasData() : Boolean
      {
         return this.var_1461 != null;
      }
      ...
      {
         return this.var_1460 != null;
      }
      
      public function hasAddData() : Boolean
      {
         return this.var_778 != null;
      }
