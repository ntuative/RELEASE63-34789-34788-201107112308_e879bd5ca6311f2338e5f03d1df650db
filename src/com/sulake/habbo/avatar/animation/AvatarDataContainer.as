package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1865:Number = 1.0;
      
      private var var_1866:Number = 1.0;
      ...
      {
         super();
         this.var_1988 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2728 = parseInt(_loc2_,16);
         this.var_2729 = parseInt(_loc3_,16);
         ...
         this.var_866 = new ColorTransform(this.var_1869,this.var_1865,this.var_1866,this._alphaMultiplier);
         this.var_1303 = this.generatePaletteMapForGrayscale(this.var_2729,this.var_2728);
      }
