package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_730.width,this.var_730.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_730,this.var_730.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1118.width,this.var_1118.height,true,0);
            _loc5_ = this.var_1118.clone();
            ...
            if(this.var_1009)
            {
               switch(this.var_1009.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_35:
                     _loc4_.style = HabboIconType.const_980;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_42:
                     _loc4_.style = HabboIconType.const_1005;
                     _loc4_.visible = true;
               }
            }
            else
