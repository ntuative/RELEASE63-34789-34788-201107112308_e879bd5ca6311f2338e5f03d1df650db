package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit, IAvatarImageListener
   {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IAvatarImage = this.var_26.manager.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_109,this.var_991,this);
         if(_loc1_)
         {
            _loc1_.setDirection(AvatarSetType.const_41,int(FigureData.const_1013));
