package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1526:String = "Default";
      
      private static const const_1528:int = 2;
      
      private static const const_1527:String = AvatarSetType.const_41;
      ...
      private var var_3005:String = null;
      
      private var var_3007:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1527,const_1528);
         this.var_363 = new Array();
         this.var_1014 = new ActiveActionData(AvatarAction.const_452);
         this.var_1014.definition = this._structure.getActionDefinition(const_1526);
         this.resetActions();
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_56 || param1 == AvatarSetType.const_41)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_739,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_309.length == 1 && this.var_102 == this.var_2102)
         {
            return this.var_102 + this.var_594 + this.var_739 % 4;
         }
         if(this.var_309.length == 2)
         {
            for each(_loc1_ in this.var_309)
            {
               ...
               {
                  return this.var_102 + this.var_594 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_739 % 11;
                  return this.var_102 + "_" + this.var_2102 + this.var_594 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_3006 || param2 != this.var_3005 || param1 != this.var_3007)
         {
            this.var_3006 = param3;
            this.var_3005 = param2;
            this.var_3007 = param1;
            this.var_2162 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1428 || this.var_48 == null || (this.var_48.width != _loc5_.width || this.var_48.height != _loc5_.height))
         {
            if(this.var_48 != null && !this.var_1428)
            {
               this.var_48.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_317.definition.geometryType,this.var_102);
         this.var_48.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_739);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_317.definition.geometryType,this.var_102);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_739);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_363.push(new ActiveActionData(param1,param2,this.var_739));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_317 = this.var_1014;
         this.var_317.definition = this.var_1014.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_594 = "";
         this.var_309 = this._structure.sortActions(this.var_363);
         if(this.var_309 == null)
         {
            this.var_919 = new Array(0,0,0);
            if(this.var_1385 != "")
            {
               _loc1_ = true;
               this.var_1385 = "";
         ...
         {
            this.var_919 = this._structure.getCanvasOffsets(this.var_309,this._scale,this.var_102);
            for each(_loc4_ in this.var_309)
            {
               this.var_594 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_327)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1684 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1684 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1385 != this.var_594)
            {
               _loc1_ = true;
               this.var_1385 = this.var_594;
            }
         }
         this.var_1536 = true;
         return _loc1_;
            ...
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1888 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_335 || _loc1_.actionType == AvatarAction.const_283 || _loc1_.actionType == AvatarAction.const_449)
               {
                  this.var_1015 = true;
               }
            }
