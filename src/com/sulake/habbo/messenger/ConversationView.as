package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1093:int = 100;
      
      private static const const_1563:int = 20;
       
      
      private var var_156:HabboMessenger;
      
      private var var_2640:IScrollbarWindow;
      
      private var var_1942:IContainerButtonWindow;
      
      private var var_65:IItemListWindow;
      
      private var var_548:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_156 = param1;
         this.var_1942 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_65 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2640 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1093 + const_1563)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1562;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_548 == null || _loc1_.id != this.var_548.id)
         {
            this.var_548 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_548.followingAllowed)
         {
            this.var_1942.enable();
         }
         else
         {
            this.var_1942.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_65.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_548.messages.length - const_1093);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_548.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_548.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_866 || param3.type == Message.const_944 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_548.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_156.send(new FollowFriendMessageComposer(this.var_548.id));
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_944)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1255)
         {
            return 4294927974;
         }
         if(param1 == Message.const_1019)
         {
            return 4293454056;
         }
