package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1695:CutToWidth = new CutToWidth();
      
      private static var var_3023:CutToHeight = new CutToHeight();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1695.beforeSearch(param2,param1,param3);
         binarySearch(var_1695,param2.length - 1);
      }
