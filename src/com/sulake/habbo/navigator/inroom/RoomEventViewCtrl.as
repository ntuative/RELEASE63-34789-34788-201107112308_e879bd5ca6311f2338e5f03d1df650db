package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_856:TextFieldManager;
      ...
      private var var_1978:IWindowContainer;
      
      private var var_2714:ITextWindow;
      ...
      private var var_1050:IDropMenuWindow;
      ...
      {
         var _loc1_:int = this.var_1050.selection;
         return _loc1_ + 1;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent) : void
      {
         ...
         var _loc4_:String = this.var_856.getText();
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_856.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1978 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2714 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1979 = ITextWindow(this.find("create_caption"));
            this.var_1977 = ITextWindow(this.find("edit_caption"));
            this.var_1579 = IButtonWindow(this.find("create_button"));
            this.var_1578 = IButtonWindow(this.find("edit_button"));
            this.var_2715 = IButtonWindow(this.find("cancel_button"));
            this.var_1580 = IButtonWindow(this.find("end_button"));
            this.var_1050 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            this.addMouseClickListener(this.var_1579,this.onCreateButtonClick);
            this.addMouseClickListener(this.var_1578,this.onEditButtonClick);
            this.addMouseClickListener(this.var_1580,this.onEndButtonClick);
            this.addMouseClickListener(this.var_2715,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_856 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
