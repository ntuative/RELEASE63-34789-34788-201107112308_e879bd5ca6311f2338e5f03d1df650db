package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_345:MainViewCtrl;
      
      private var var_697:RoomInfoViewCtrl;
      
      private var var_1322:RoomCreateViewCtrl;
      ...
      private var var_326:GuestRoomDoorbell;
      
      private var var_1323:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2811 = new Array();
         ...
         this.var_345 = new MainViewCtrl(this);
         this.var_697 = new RoomInfoViewCtrl(this);
         this.var_1322 = new RoomCreateViewCtrl(this);
         this.var_2812 = new RoomThumbnailRenderer(this);
         this.var_954 = new GuestRoomPasswordInput(this);
         this.var_326 = new GuestRoomDoorbell(this);
         this.var_435 = new Tabs(this);
         this.var_1323 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_381,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_345.onNavigatorToolBarIconClick();
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_126.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_345.startSearch(Tabs.const_304,Tabs.const_549,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_345.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_345.startSearch(Tabs.const_268,Tabs.const_264);
         this.var_435.getTab(Tabs.const_268).tabPageDecorator.tabSelected();
      }
