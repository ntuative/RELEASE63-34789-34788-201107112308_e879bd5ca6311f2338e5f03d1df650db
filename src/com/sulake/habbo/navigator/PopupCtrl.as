package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_468.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_468)
         {
            this.var_468.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_468.reset();
            this.var_468 = null;
         }
         if(this.var_404)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_59 == null)
         {
            this.var_59 = IWindowContainer(this._navigator.getXmlWindow(this.var_1152));
         ...
         this.var_59.x = _loc2_.x + this.var_2755 + param1.width;
