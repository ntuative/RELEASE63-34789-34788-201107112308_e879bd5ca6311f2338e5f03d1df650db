package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_526:int = 10;
      
      private static const const_1066:int = 32;
      
      private static const const_1466:int = 8;
      
      private static const const_1467:int = -16;
      ...
      private var var_2394:Dictionary;
      ...
      private function initScreenLocsByPositions() : void
      {
         ...
         this.var_2394 = _loc1_;
      }
      
      private function getLoc(param1:int, param2:int) : Point
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_1066 / 2);
         return new Point(param1 * const_1066 + _loc3_,param2 * const_1466);
      }
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_381,HabboWindowStyle.const_47,0 | (!!param3 ? HabboWindowParam.const_44 : HabboWindowParam.const_47),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_974.getImage(ThumbnailEditorModel.const_36,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_974.getImage(ThumbnailEditorModel.const_36,1);
         }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         ...
         {
            this.var_1471 = this._navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(this.var_1471,this.var_1471.rect,new Point(0,0),null,null,true);
      }
      ...
      private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData) : void
      {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1467,_loc4_.y + const_1468 - _loc5_.height),null,null,true);
      }
      
      public function getScreenLocForPos(param1:int) : Point
      {
         return Point(this.var_2394[param1]);
      }
   }
}
