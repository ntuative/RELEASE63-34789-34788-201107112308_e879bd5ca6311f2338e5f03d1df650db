package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_1161:UserCountRenderer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_1161 = new UserCountRenderer(this._navigator);
      }
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_607 = IScrollbarWindow(this.var_198.findChildByName("scroller"));
      }
      ...
      private function getVisibleEntryCount() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_65.numListItems)
         {
            if(this.var_65.getListItemAt(_loc2_).visible)
            {
               _loc1_++;
            }
            _loc2_++;
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_201,this.onMouseMove);
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(this.var_65.getListItemAt(param2));
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_219,null,0);
         ...
         this.var_1161.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_519.visible && this.var_2296)
         {
            return;
         }
         ...
         if(_loc4_.ownerName != this._navigator.sessionData.userName)
         {
            ...
            switch(_loc4_.doorMode)
            {
               case RoomSettingsFlatInfo.const_128:
                  ...
                  return;
               case RoomSettingsFlatInfo.const_219:
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1439.tags[0];
            this.var_1439.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2297 - _loc2_.stageX);
         this.var_2297 = _loc2_.stageX;
         this.var_2296 = _loc3_ > 2;
      }
   }
}
