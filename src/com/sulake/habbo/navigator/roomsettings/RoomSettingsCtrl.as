package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1188:TextFieldManager;
      ...
      private var var_771:ICheckBoxWindow;
      ...
      {
         if(param1 != this.var_372 || this.var_1185 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1185 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1900)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1859)
         {
            this.var_1188.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1880)
         {
            ...
            this.setTagError(this.var_955,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1810)
         {
            ...
            this.setTagError(this.var_955,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1851)
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_536,this.onDoorModePasswordUnselect);
         ...
         this.var_1188 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_957 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_955 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_954 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1182 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1189 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1186 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1183 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_771 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1758 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_956 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_953 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2334 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1181 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1184 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1759 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1450 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_243 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1187 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1449 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1449.mouseThreshold = 0;
         this.var_1449.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1187.visible = false;
         if(!this.var_1451)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1759.visible = this.var_1451;
         this.populateForm();
         if(this.var_770)
         {
            this.var_1184.visible = true;
            this.var_1450.visible = true;
            this.refreshFlatControllers();
            this.var_1184.height = Util.getLowestPoint(this.var_1184) + 4;
         }
         else
         {
            this.var_1181.visible = true;
            this.var_1450.visible = true;
            this.var_2334.visible = this.var_1451;
            this.var_1181.height = Util.getLowestPoint(this.var_1181) + 4;
         }
         this.var_1449.text = !!this.var_770 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1181.name,this.var_1184.name,this.var_1450.name,this.var_1759.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_1188.setText(_loc1_.description);
         this.var_954.setText("");
         this.var_1182.setText("");
         ...
         {
            case RoomSettingsData.const_219:
         ...
         this.setTag(this.var_957,_loc1_.tags[0]);
         this.setTag(this.var_955,_loc1_.tags[1]);
         if(this.var_1189)
         {
            if(_loc1_.allowPets)
            {
         ...
         {
            this.disableWindow(this.var_771);
            this.disableWindow(this.var_956);
            this.disableWindow(this.var_953);
            this.disableWindow(this.var_1758);
         }
         else
         {
            this.enableWindow(this.var_771);
            this.enableWindow(this.var_956);
            this.enableWindow(this.var_953);
            this.enableWindow(this.var_1758);
         }
         if(this.var_771)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_771.unselect();
            }
         }
         if(this.var_956)
         {
            this.var_956.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_953)
         {
            this.var_953.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_128)
         {
            ...
            _loc9_ = this.var_1182.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_954.clearErrors();
               this.var_1182.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1189.isSelected;
         _loc2_.allowFoodConsume = this.var_1186.isSelected;
         _loc2_.allowWalkThrough = this.var_1183.isSelected;
         _loc2_.hideWalls = this.var_771.isSelected;
         _loc2_.wallThickness = this.var_956.selection - 2;
         _loc2_.floorThickness = this.var_953.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_957,_loc2_.tags);
         this.addTag(this.var_955,_loc2_.tags);
         this.clearErrors();
         this.var_1185 = _loc2_.roomId;
