package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1256:TextFieldManager;
      
      private var var_45:Array;
      
      private var var_1257:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_659 = new Timer(100);
         this.var_659.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         ...
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_42,540,"t"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_42,512,"w"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_42,396,"x"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_42,440,"y"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_42,456,"z"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_42,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_659)
         {
            this.var_659.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_659.reset();
            this.var_659 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1257.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1903 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1903 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_65 = IItemListWindow(this.var_198.findChildByName("item_list"));
         ...
         this.var_1256 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_198.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1256.goBackToInitialState();
         this.var_1256.input.textBackgroundColor = 4294967295;
         this.var_1257 = this.var_45[0];
         this.refreshRoomThumbnails();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         while(this.var_65.numListItems > 0)
         {
            _loc6_ = this.var_65.removeListItemAt(0);
            _loc6_.destroy();
         }
         for each(_loc1_ in this.var_45)
         {
         ...
         while(_loc4_ < this.var_45.length)
         {
            ...
            if(this.isAllowed(_loc7_))
            {
               ...
               {
                  _loc3_ = this.getRow();
                  this.var_65.addListItem(_loc3_);
               }
         ...
         {
            if(this._navigator.sessionData.hasUserRight("fuse_use_vip_room_layouts",HabboClubLevelEnum.const_42))
            {
               _loc5_ = null;
            }
            else
         ...
         if(_loc5_)
         {
            ...
            if(_loc8_)
            {
               ...
               this.var_65.addListItem(_loc8_);
            }
         }
      }
      ...
      private function isAllowed(param1:RoomLayout) : Boolean
      {
         switch(param1.requiredClubLevel)
         {
            ...
            case HabboClubLevelEnum.const_42:
               return this._navigator.sessionData.hasUserRight("fuse_use_vip_room_layouts",HabboClubLevelEnum.const_42);
            default:
               return false;
         }
      }
      ...
      {
         return Boolean(this.var_1256.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1256.getText();
         var _loc3_:String = "model_" + this.var_1257.name;
