package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_491:uint = 3;
      
      private static const const_1714:uint = 1;
      ...
      private var var_1693:IEventDispatcher;
      
      private var var_1387:Boolean = false;
      
      private var var_2175:ProfilerOutput;
      
      private var var_1692:ProfilerAgentTask;
      
      private var var_1694:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_236 = new Array(const_491);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_491)
         {
            this.var_236[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_627 = this.var_236[const_1714];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_2175)
            {
               this.var_2175 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_2175.profiler = _loc3_;
            this.var_1692 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1692);
            this.var_1694 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1694);
            this.var_1387 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_236)
            {
               ...
               {
                  IDisposable(this.var_236.pop()).dispose();
               }
            }
            this.var_236 = null;
            if(this.var_311)
      ...
      {
         return this.var_627.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_627.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_236[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_236[param2].getDesktopWindow();
      ...
      {
         return this.var_236[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_236[param1].getDesktopWindow().getChildAt(this.var_627.getDesktopWindow().numChildren - 1);
      }
      
      public function getWindowContext(param1:uint) : IWindowContext
      {
         return this.var_236[param1];
      }
      
      public function getDesktop(param1:uint) : IDesktopWindow
      {
         var _loc2_:IWindowContext = this.var_236[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1693.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_491 - 1;
            while(_loc2_ >= 0)
            {
               this.var_236[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1387)
         ...
         this.var_1693.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_491)
         {
            this.var_236[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1387)
         {
         ...
         this.var_1693.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1823,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1746,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1750,param2.name + ": " + param2.toString());
            }
         }
      }
